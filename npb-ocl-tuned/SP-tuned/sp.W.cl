		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*cv)[36][36] = (__global double (*)[36][36])g_cv;
	__global double (*us)[37][37] = (__global double (*)[37][37])g_us;
	__global double (*rhon)[36][36] = (__global double (*)[36][36])g_rhon;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*rhoq)[36][36] = (__global double (*)[36][36])g_rhoq;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*rhos)[36][36] = (__global double (*)[36][36])g_rhos;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
