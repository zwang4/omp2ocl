...
static void z_solve()
{
	...
	lhsz();
	n = 0;
	oclSwapDimensions (__ocl_buffer_lhs, 15 * (64 / 2 * 2 + 1), 64 / 2 * 2 + 1, 1,
...
static void init_ocl_runtime()
{
	...
	__ocl_program = oclBuildProgram("sp.A.cl");
...
static void create_ocl_buffers()
{
	...
	__ocl_buffer_cv = oclCreateBuffer(cv, (64 * 64 * 64) * sizeof(double));
	...
	__ocl_buffer_rhon =
	    oclCreateBuffer(rhon, (64 * 64 * 64) * sizeof(double));
	...
	__ocl_buffer_rhoq =
	    oclCreateBuffer(rhoq, (64 * 64 * 64) * sizeof(double));
	...
	__ocl_buffer_rhos =
	    oclCreateBuffer(rhos, (64 * 64 * 64) * sizeof(double));
