//-------------------------------------------------------------------------------
//Host code 
//Generated at : Mon Aug 13 10:13:36 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
{
	{
		...
		c_print_results("MG", Class, nx[lt], ny[lt], nz[lt], nit,
				...
				verified, "2.3", "13 Aug 2012", "gcc", "gcc",
				"(none)", "-I../common",
...
#ifndef psinv_0_MULT_ITER_0
#define psinv_0_MULT_ITER_0 2
#endif
#ifndef psinv_0_MULT_ITER_1
#define psinv_0_MULT_ITER_1 2
#endif

			OCL_NEAREST_MULTD(_ocl_gws[0], psinv_0_MULT_ITER_0);
			OCL_NEAREST_MULTD(_ocl_gws[1], psinv_0_MULT_ITER_1);
			...
			CREATE_THREAD_PRIVATE_BUF(__ocl_th_r1_psinv_0,
						  __ocl_buffer_r1_psinv_0,
						  double,
						  (1037 * _ocl_thread_num),
						  DEFAULT_ALIGN_SIZE);
			oclSetKernelArgBuffer(__ocl_psinv_0, 2,
					      __ocl_buffer_r1_psinv_0);
			oclSetKernelArgBuffer(__ocl_psinv_0, 3,
					      __ocl_buffer_r_data);
			oclSetKernelArgBuffer(__ocl_psinv_0, 4,
					      __ocl_buffer_r_idx);
			oclSetKernelArg(__ocl_psinv_0, 5, sizeof(unsigned),
					&r_offset);
			CREATE_THREAD_PRIVATE_BUF(__ocl_th_r2_psinv_0,
						  __ocl_buffer_r2_psinv_0,
						  double,
						  (1037 * _ocl_thread_num),
						  DEFAULT_ALIGN_SIZE);
			oclSetKernelArgBuffer(__ocl_psinv_0, 6,
					      __ocl_buffer_r2_psinv_0);
			oclSetKernelArgBuffer(__ocl_psinv_0, 7,
					      __ocl_buffer_u_data);
			oclSetKernelArgBuffer(__ocl_psinv_0, 8,
					      __ocl_buffer_u_idx);
			oclSetKernelArg(__ocl_psinv_0, 9, sizeof(unsigned),
					&u_offset);
			oclSetKernelArgBuffer(__ocl_psinv_0, 10,
					      __ocl_buffer_c);
			int __ocl_i3_bound = n3 - 1;
			oclSetKernelArg(__ocl_psinv_0, 11, sizeof(int),
					&__ocl_i3_bound);
			int __ocl_i2_bound = n2 - 1;
			oclSetKernelArg(__ocl_psinv_0, 12, sizeof(int),
					&__ocl_i2_bound);
			//------------------------------------------
			...
			oclSync();
			if (__ocl_th_r1_psinv_0_length) {
				oclReleaseBuffer(__ocl_buffer_r1_psinv_0);
				free(__ocl_th_r1_psinv_0);
				__ocl_th_r1_psinv_0 = NULL;
				__ocl_buffer_r1_psinv_0 = NULL;
				__ocl_th_r1_psinv_0_length = 0;
			}
			if (__ocl_th_r2_psinv_0_length) {
				oclReleaseBuffer(__ocl_buffer_r2_psinv_0);
				free(__ocl_th_r2_psinv_0);
				__ocl_th_r2_psinv_0 = NULL;
				__ocl_buffer_r2_psinv_0 = NULL;
				__ocl_th_r2_psinv_0_length = 0;
			}
#endif
		}
...
#ifndef resid_0_MULT_ITER_0
#define resid_0_MULT_ITER_0 2
#endif
#ifndef resid_0_MULT_ITER_1
#define resid_0_MULT_ITER_1 2
#endif

			OCL_NEAREST_MULTD(_ocl_gws[0], resid_0_MULT_ITER_0);
			OCL_NEAREST_MULTD(_ocl_gws[1], resid_0_MULT_ITER_1);

			oclGetWorkSize(2, _ocl_gws, NULL);
			size_t _ocl_thread_num = (_ocl_gws[0] * _ocl_gws[1]);
			oclSetKernelArg(__ocl_resid_0, 0, sizeof(int), &i1);
			oclSetKernelArg(__ocl_resid_0, 1, sizeof(int), &n1);
			CREATE_THREAD_PRIVATE_BUF(__ocl_th_u1_resid_0,
						  __ocl_buffer_u1_resid_0,
						  double,
						  (1037 * _ocl_thread_num),
						  DEFAULT_ALIGN_SIZE);
			...
			oclSetKernelArgBuffer(__ocl_resid_0, 3,
					      __ocl_buffer_u_data);
			oclSetKernelArgBuffer(__ocl_resid_0, 4,
					      __ocl_buffer_u_idx);
			oclSetKernelArg(__ocl_resid_0, 5, sizeof(unsigned),
					&u_offset);
			CREATE_THREAD_PRIVATE_BUF(__ocl_th_u2_resid_0,
						  __ocl_buffer_u2_resid_0,
						  double,
						  (1037 * _ocl_thread_num),
						  DEFAULT_ALIGN_SIZE);
			oclSetKernelArgBuffer(__ocl_resid_0, 6,
					      __ocl_buffer_u2_resid_0);
			oclSetKernelArgBuffer(__ocl_resid_0, 7,
					      __ocl_buffer_r_data);
			oclSetKernelArgBuffer(__ocl_resid_0, 8,
					      __ocl_buffer_r_idx);
			oclSetKernelArg(__ocl_resid_0, 9, sizeof(unsigned),
					&r_offset);
			oclSetKernelArgBuffer(__ocl_resid_0, 10,
					      __ocl_buffer_v_data);
			oclSetKernelArgBuffer(__ocl_resid_0, 11,
					      __ocl_buffer_v_idx);
			oclSetKernelArg(__ocl_resid_0, 12, sizeof(unsigned),
					&v_offset);
			oclSetKernelArgBuffer(__ocl_resid_0, 13,
					      __ocl_buffer_a);
			int __ocl_i3_bound = n3 - 1;
			oclSetKernelArg(__ocl_resid_0, 14, sizeof(int),
					&__ocl_i3_bound);
			int __ocl_i2_bound = n2 - 1;
			oclSetKernelArg(__ocl_resid_0, 15, sizeof(int),
					&__ocl_i2_bound);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
...
#ifdef OCL_RELEASE_GTP_BUFFERS_IMMEDIATE
			oclSync();
			if (__ocl_th_u1_resid_0_length) {
				oclReleaseBuffer(__ocl_buffer_u1_resid_0);
				free(__ocl_th_u1_resid_0);
				__ocl_th_u1_resid_0 = NULL;
				__ocl_buffer_u1_resid_0 = NULL;
				__ocl_th_u1_resid_0_length = 0;
			}
			if (__ocl_th_u2_resid_0_length) {
				oclReleaseBuffer(__ocl_buffer_u2_resid_0);
				free(__ocl_th_u2_resid_0);
				__ocl_th_u2_resid_0 = NULL;
				__ocl_buffer_u2_resid_0 = NULL;
				__ocl_th_u2_resid_0_length = 0;
			}
#endif
		}
...
//CREATE_FUNC_LEVEL_BUFFER(__ocl_buffer_s_idx_rprj3,__ocl_p_s_idx_rprj3, s_idx, (), unsigned);
	{
		...
		//--------------------------------------------------------------
		{
			...
			size_t _ocl_thread_num = (_ocl_gws[0]);
			...
			CREATE_THREAD_PRIVATE_BUF(__ocl_th_xx1_rprj3_0,
						  __ocl_buffer_xx1_rprj3_0,
						  double,
						  (1037 * _ocl_thread_num),
						  DEFAULT_ALIGN_SIZE);
			...
			oclSetKernelArgBuffer(__ocl_rprj3_0, 8,
					      __ocl_buffer_r_data);
			oclSetKernelArgBuffer(__ocl_rprj3_0, 9,
					      __ocl_buffer_r_idx);
			oclSetKernelArg(__ocl_rprj3_0, 10, sizeof(unsigned),
					&r_offset);
			CREATE_THREAD_PRIVATE_BUF(__ocl_th_yy1_rprj3_0,
						  __ocl_buffer_yy1_rprj3_0,
						  double,
						  (1037 * _ocl_thread_num),
						  DEFAULT_ALIGN_SIZE);
			oclSetKernelArgBuffer(__ocl_rprj3_0, 11,
					      __ocl_buffer_yy1_rprj3_0);
			oclSetKernelArgBuffer(__ocl_rprj3_0, 12,
					      __ocl_buffer_s_data);
			oclSetKernelArgBuffer(__ocl_rprj3_0, 13,
					      __ocl_buffer_s_idx);
			oclSetKernelArg(__ocl_rprj3_0, 14, sizeof(unsigned),
					&s_offset);
			int __ocl_j3_bound = m3j - 1;
			oclSetKernelArg(__ocl_rprj3_0, 15, sizeof(int),
					&__ocl_j3_bound);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
...
#ifdef OCL_RELEASE_GTP_BUFFERS_IMMEDIATE
			oclSync();
			if (__ocl_th_xx1_rprj3_0_length) {
				oclReleaseBuffer(__ocl_buffer_xx1_rprj3_0);
				free(__ocl_th_xx1_rprj3_0);
				__ocl_th_xx1_rprj3_0 = NULL;
				__ocl_buffer_xx1_rprj3_0 = NULL;
				__ocl_th_xx1_rprj3_0_length = 0;
			}
			if (__ocl_th_yy1_rprj3_0_length) {
				oclReleaseBuffer(__ocl_buffer_yy1_rprj3_0);
				free(__ocl_th_yy1_rprj3_0);
				__ocl_th_yy1_rprj3_0 = NULL;
				__ocl_buffer_yy1_rprj3_0 = NULL;
				__ocl_th_yy1_rprj3_0_length = 0;
			}
#endif
		}
...
#ifndef interp_0_MULT_ITER_0
#define interp_0_MULT_ITER_0 2
#endif
#ifndef interp_0_MULT_ITER_1
#define interp_0_MULT_ITER_1 2
#endif

				OCL_NEAREST_MULTD(_ocl_gws[0],
						  interp_0_MULT_ITER_0);
				OCL_NEAREST_MULTD(_ocl_gws[1],
						  interp_0_MULT_ITER_1);
				...
				oclSetKernelArg(__ocl_interp_0, 1, sizeof(int),
						&mm1);
				CREATE_THREAD_PRIVATE_BUF(__ocl_th_z1_interp_0,
							  __ocl_buffer_z1_interp_0,
							  double,
							  (1037 *
							   _ocl_thread_num),
							  DEFAULT_ALIGN_SIZE);
				...
				oclSetKernelArgBuffer(__ocl_interp_0, 3,
						      __ocl_buffer_z_data);
				oclSetKernelArgBuffer(__ocl_interp_0, 4,
						      __ocl_buffer_z_idx);
				oclSetKernelArg(__ocl_interp_0, 5,
						sizeof(unsigned), &z_offset);
				CREATE_THREAD_PRIVATE_BUF(__ocl_th_z2_interp_0,
							  __ocl_buffer_z2_interp_0,
							  double,
							  (1037 *
							   _ocl_thread_num),
							  DEFAULT_ALIGN_SIZE);
				oclSetKernelArgBuffer(__ocl_interp_0, 6,
						      __ocl_buffer_z2_interp_0);
				CREATE_THREAD_PRIVATE_BUF(__ocl_th_z3_interp_0,
							  __ocl_buffer_z3_interp_0,
							  double,
							  (1037 *
							   _ocl_thread_num),
							  DEFAULT_ALIGN_SIZE);
				oclSetKernelArgBuffer(__ocl_interp_0, 7,
						      __ocl_buffer_z3_interp_0);
				oclSetKernelArgBuffer(__ocl_interp_0, 8,
						      __ocl_buffer_u_data);
				oclSetKernelArgBuffer(__ocl_interp_0, 9,
						      __ocl_buffer_u_idx);
				oclSetKernelArg(__ocl_interp_0, 10,
						sizeof(unsigned), &u_offset);
				int __ocl_i3_bound = mm3 - 1;
				oclSetKernelArg(__ocl_interp_0, 11, sizeof(int),
						&__ocl_i3_bound);
				int __ocl_i2_bound = mm2 - 1;
				oclSetKernelArg(__ocl_interp_0, 12, sizeof(int),
						&__ocl_i2_bound);
				//------------------------------------------
				//OpenCL kernel arguments (END) 
				//------------------------------------------
...
#ifdef OCL_RELEASE_GTP_BUFFERS_IMMEDIATE
				oclSync();
				if (__ocl_th_z1_interp_0_length) {
					oclReleaseBuffer
					    (__ocl_buffer_z1_interp_0);
					free(__ocl_th_z1_interp_0);
					__ocl_th_z1_interp_0 = NULL;
					__ocl_buffer_z1_interp_0 = NULL;
					__ocl_th_z1_interp_0_length = 0;
				}
				if (__ocl_th_z2_interp_0_length) {
					oclReleaseBuffer
					    (__ocl_buffer_z2_interp_0);
					free(__ocl_th_z2_interp_0);
					__ocl_th_z2_interp_0 = NULL;
					__ocl_buffer_z2_interp_0 = NULL;
					__ocl_th_z2_interp_0_length = 0;
				}
				if (__ocl_th_z3_interp_0_length) {
					oclReleaseBuffer
					    (__ocl_buffer_z3_interp_0);
					free(__ocl_th_z3_interp_0);
					__ocl_th_z3_interp_0 = NULL;
					__ocl_buffer_z3_interp_0 = NULL;
					__ocl_th_z3_interp_0_length = 0;
				}
#endif
			}
...
static void init_ocl_runtime()
{
	...
	__ocl_program = oclBuildProgram("mg.W.cl");
...
{
	__ocl_buffer_r1 = oclCreateBuffer(r1, (1037) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_r1, -1);
	__ocl_buffer_r2 = oclCreateBuffer(r2, (1037) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_r2, -1);
	__ocl_buffer_u1 = oclCreateBuffer(u1, (1037) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_u1, -1);
	__ocl_buffer_u2 = oclCreateBuffer(u2, (1037) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_u2, -1);
	__ocl_buffer_xx1 = oclCreateBuffer(xx1, (1037) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_xx1, -1);
	__ocl_buffer_yy1 = oclCreateBuffer(yy1, (1037) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_yy1, -1);
...
{
	oclHostWrites(__ocl_buffer_r1);
	oclHostWrites(__ocl_buffer_r2);
	oclHostWrites(__ocl_buffer_u1);
	oclHostWrites(__ocl_buffer_u2);
	oclHostWrites(__ocl_buffer_xx1);
	oclHostWrites(__ocl_buffer_yy1);
...
{
	oclReleaseBuffer(__ocl_buffer_r1);
	oclReleaseBuffer(__ocl_buffer_r2);
	oclReleaseBuffer(__ocl_buffer_u1);
	oclReleaseBuffer(__ocl_buffer_u2);
	oclReleaseBuffer(__ocl_buffer_xx1);
	oclReleaseBuffer(__ocl_buffer_yy1);
	...
	if (__ocl_th_r1_psinv_0) {
		oclReleaseBuffer(__ocl_buffer_r1_psinv_0);
		free(__ocl_th_r1_psinv_0);
		__ocl_th_r1_psinv_0_length = 0;
	}
	if (__ocl_th_r2_psinv_0) {
		oclReleaseBuffer(__ocl_buffer_r2_psinv_0);
		free(__ocl_th_r2_psinv_0);
		__ocl_th_r2_psinv_0_length = 0;
	}
	if (__ocl_th_u1_resid_0) {
		oclReleaseBuffer(__ocl_buffer_u1_resid_0);
		free(__ocl_th_u1_resid_0);
		__ocl_th_u1_resid_0_length = 0;
	}
	if (__ocl_th_u2_resid_0) {
		oclReleaseBuffer(__ocl_buffer_u2_resid_0);
		free(__ocl_th_u2_resid_0);
		__ocl_th_u2_resid_0_length = 0;
	}
	if (__ocl_th_xx1_rprj3_0) {
		oclReleaseBuffer(__ocl_buffer_xx1_rprj3_0);
		free(__ocl_th_xx1_rprj3_0);
		__ocl_th_xx1_rprj3_0_length = 0;
	}
	if (__ocl_th_yy1_rprj3_0) {
		oclReleaseBuffer(__ocl_buffer_yy1_rprj3_0);
		free(__ocl_th_yy1_rprj3_0);
		__ocl_th_yy1_rprj3_0_length = 0;
	}
	if (__ocl_th_z1_interp_0) {
		oclReleaseBuffer(__ocl_buffer_z1_interp_0);
		free(__ocl_th_z1_interp_0);
		__ocl_th_z1_interp_0_length = 0;
	}
	if (__ocl_th_z2_interp_0) {
		oclReleaseBuffer(__ocl_buffer_z2_interp_0);
		free(__ocl_th_z2_interp_0);
		__ocl_th_z2_interp_0_length = 0;
	}
	if (__ocl_th_z3_interp_0) {
		oclReleaseBuffer(__ocl_buffer_z3_interp_0);
		free(__ocl_th_z3_interp_0);
		__ocl_th_z3_interp_0_length = 0;
	}
