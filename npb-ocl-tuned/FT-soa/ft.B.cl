		       ...
		       int __ocl_i_bound, int __ocl_j_bound, int __ocl_k_bound)
{
	...
	//-------------------------------------------
	{
		u1_real[CALC_3D_IDX(256, 256, 512, (k), (j), (i))] =
		    u0_real[CALC_3D_IDX(256, 256, 512, (k), (j), (i))] *
		    ex[(t *
			indexmap[CALC_3D_IDX(256, 256, 512, (k), (j), (i))])];
		u1_imag[CALC_3D_IDX(256, 256, 512, (k), (j), (i))] =
		    u0_imag[CALC_3D_IDX(256, 256, 512, (k), (j), (i))] *
		    ex[(t *
			indexmap[CALC_3D_IDX(256, 256, 512, (k), (j), (i))])];
	}
	//-------------------------------------------
					 ...
					 __global double *__ocl_part_chk_imag)
{
	...
	//-------------------------------------------
	//__global double (*u1_real)[256][512] =
	//    (__global double (*)[256][512])g_u1_real;
	//__global double (*u1_imag)[256][512] =
	//    (__global double (*)[256][512])g_u1_imag;
	//-------------------------------------------
