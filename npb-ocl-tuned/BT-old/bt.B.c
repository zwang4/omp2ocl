...
/*Setting arugments for a loop that is defined at: bt.c : 722*/
  {
    size_t __ocl_global_work_size[3];
    __ocl_global_work_size[0] = (102) - (0);
    __ocl_global_work_size[1] = (102) - (0);
    __ocl_global_work_size[2] = (102) - (0);
...
static void
matvec_sub (double ablock[3][5][5][103][103][103],
	    ...
	    int avec_2, double bvec[5][103][103][103],
...
static void
binvcrhs (double lhs[3][5][5][103][103][103], ocl_buffer * __ocl_buffer_lhs,
	  int lhs_0, int lhs_1, int lhs_2, int lhs_3,
	  double c[3][5][5][103][103][103], ocl_buffer * __ocl_buffer_c,
	  int c_0, int c_1, int c_2, int c_3, double r[5][103][103][103],
	  ocl_buffer * __ocl_buffer_r, int r_0, int r_1, int r_2)
{
  double pivot, coeff;
...
static void
binvrhs (double lhs[3][5][5][103][103][103], ocl_buffer * __ocl_buffer_lhs,
	 int lhs_0, int lhs_1, int lhs_2, int lhs_3,
	 double r[5][103][103][103], ocl_buffer * __ocl_buffer_r, int r_0,
	 int r_1, int r_2)
{
  double pivot, coeff;
  pivot = 1.00 / lhs[lhs_3][0][0][lhs_0][lhs_1][lhs_2];
...
init_ocl_runtime ()
{
  ...
  __ocl_program = oclBuildProgram ("bt.B.cl");
...
create_ocl_buffers ()
{
  ...
  __ocl_buffer_forcing =
    oclCreateBuffer (forcing, (6 * 103 * 103 * 103) * sizeof (double));
  ...
  __ocl_buffer_ue = oclCreateBuffer (ue, (5 * 102) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_ue, -1);
  __ocl_buffer_buf = oclCreateBuffer (buf, (5 * 102) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_buf, -1);
  __ocl_buffer_cuf = oclCreateBuffer (cuf, (102) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_cuf, -1);
  __ocl_buffer_q = oclCreateBuffer (q, (102) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_q, -1);
  __ocl_buffer_ce = oclCreateBuffer (ce, (5 * 13) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_ce, -1);
  __ocl_buffer_lhs =
    oclCreateBuffer (lhs, (3 * 5 * 5 * 103 * 103 * 103) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_lhs, -1);
  __ocl_buffer_fjac =
    oclCreateBuffer (fjac, (5 * 5 * 103 * 103 * 102) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_fjac, -1);
  __ocl_buffer_njac =
    oclCreateBuffer (njac, (5 * 5 * 103 * 103 * 102) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_njac, -1);
  __ocl_buffer_rho_i =
    oclCreateBuffer (rho_i, (103 * 103 * 103) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_rho_i, -1);
  __ocl_buffer_us = oclCreateBuffer (us, (103 * 103 * 103) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_us, -1);
  __ocl_buffer_vs = oclCreateBuffer (vs, (103 * 103 * 103) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_vs, -1);
  __ocl_buffer_ws = oclCreateBuffer (ws, (103 * 103 * 103) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_ws, -1);
  __ocl_buffer_square =
    oclCreateBuffer (square, (103 * 103 * 103) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_square, -1);
  __ocl_buffer_qs = oclCreateBuffer (qs, (103 * 103 * 103) * sizeof (double));
