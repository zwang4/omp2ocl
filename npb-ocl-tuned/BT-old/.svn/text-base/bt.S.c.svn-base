...
static void binvcrhs (double lhs[3][5][5][13][13][13],
		      ...
		      int c_3, double r[5][13][13][13],
		      ocl_buffer * __ocl_buffer_r, int r_0, int r_1, int r_2);
static void binvrhs (double lhs[3][5][5][13][13][13],
		     ocl_buffer * __ocl_buffer_lhs, int lhs_0, int lhs_1,
		     int lhs_2, int lhs_3, double r[5][13][13][13],
		     ocl_buffer * __ocl_buffer_r, int r_0, int r_1, int r_2);
static void y_solve ();
...
/*Setting arugments for a loop that is defined at: bt.c : 722*/
  {
    size_t __ocl_global_work_size[3];
    __ocl_global_work_size[0] = (12) - (0);
    __ocl_global_work_size[1] = (12) - (0);
    __ocl_global_work_size[2] = (12) - (0);
...
static void
matvec_sub (double ablock[3][5][5][13][13][13],
	    ...
	    int avec_2, double bvec[5][13][13][13],
...
static void
binvcrhs (double lhs[3][5][5][13][13][13], ocl_buffer * __ocl_buffer_lhs,
	  int lhs_0, int lhs_1, int lhs_2, int lhs_3,
	  double c[3][5][5][13][13][13], ocl_buffer * __ocl_buffer_c, int c_0,
	  int c_1, int c_2, int c_3, double r[5][13][13][13],
	  ocl_buffer * __ocl_buffer_r, int r_0, int r_1, int r_2)
{
  double pivot, coeff;
...
static void
binvrhs (double lhs[3][5][5][13][13][13], ocl_buffer * __ocl_buffer_lhs,
	 int lhs_0, int lhs_1, int lhs_2, int lhs_3, double r[5][13][13][13],
	 ocl_buffer * __ocl_buffer_r, int r_0, int r_1, int r_2)
{
  double pivot, coeff;
  pivot = 1.00 / lhs[lhs_3][0][0][lhs_0][lhs_1][lhs_2];
...
/*Setting arugments for a loop that is defined at: bt.c : 3453*/
	...
	size_t __ocl_global_work_size[3];
	__ocl_global_work_size[1] = (grid_points[2] - 1) - (1);
	__ocl_global_work_size[0] = (grid_points[0] - 1) - (1);
	__ocl_global_work_size[2] = (5) - (0);
...
init_ocl_runtime ()
{
  ...
  __ocl_program = oclBuildProgram ("bt.S.cl");
...
create_ocl_buffers ()
{
  __ocl_buffer_u = oclCreateBuffer (u, (5 * 13 * 13 * 13) * sizeof (double));
  ...
  __ocl_buffer_forcing =
    oclCreateBuffer (forcing, (6 * 13 * 13 * 13) * sizeof (double));
  ...
  __ocl_buffer_ue = oclCreateBuffer (ue, (5 * 12) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_ue, -1);
  __ocl_buffer_buf = oclCreateBuffer (buf, (5 * 12) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_buf, -1);
  __ocl_buffer_cuf = oclCreateBuffer (cuf, (12) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_cuf, -1);
  __ocl_buffer_q = oclCreateBuffer (q, (12) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_q, -1);
  __ocl_buffer_ce = oclCreateBuffer (ce, (5 * 13) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_ce, -1);
  __ocl_buffer_lhs =
    oclCreateBuffer (lhs, (3 * 5 * 5 * 13 * 13 * 13) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_lhs, -1);
  __ocl_buffer_fjac =
    oclCreateBuffer (fjac, (5 * 5 * 13 * 13 * 12) * sizeof (double));
  DYN_BUFFER_CHECK (__ocl_buffer_fjac, -1);
  __ocl_buffer_njac =
    oclCreateBuffer (njac, (5 * 5 * 13 * 13 * 12) * sizeof (double));
