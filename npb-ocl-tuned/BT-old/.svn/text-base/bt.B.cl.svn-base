...
static void binvrhs_g0_g5 (__global double *lhs, int lhs_0, int lhs_1,
			   ...
			   int r_1, int r_2);
static void binvcrhs (double lhs[3][5][5][103][103][103], int lhs_0,
		      int lhs_1, int lhs_2, int lhs_3,
		      double c[3][5][5][103][103][103], int c_0, int c_1,
		      int c_2, int c_3, double r[5][103][103][103], int r_0,
		      int r_1, int r_2);
static void matvec_sub (double ablock[3][5][5][103][103][103], int ablock_0,
			int ablock_1, int ablock_2, int ablock_3,
			double avec[5][103][103][103], int avec_0, int avec_1,
			int avec_2, double bvec[5][103][103][103], int bvec_0,
			int bvec_1, int bvec_2);
static void matmul_sub (double ablock[3][5][5][103][103][103], int ablock_0,
			int ablock_1, int ablock_2, int ablock_3,
			double bblock[3][5][5][103][103][103], int bblock_0,
			int bblock_1, int bblock_2, int bblock_3,
			double cblock[3][5][5][103][103][103], int cblock_0,
			int cblock_1, int cblock_2, int cblock_3);
static void binvrhs (double lhs[3][5][5][103][103][103], int lhs_0, int lhs_1,
		     int lhs_2, int lhs_3, double r[5][103][103][103],
		     int r_0, int r_1, int r_2);

static void
binvcrhs (double lhs[3][5][5][103][103][103], int lhs_0, int lhs_1, int lhs_2,
	  int lhs_3, double c[3][5][5][103][103][103], int c_0, int c_1,
	  int c_2, int c_3, double r[5][103][103][103], int r_0, int r_1,
	  int r_2)
{
  double pivot, coeff;
...
static void
matvec_sub (double ablock[3][5][5][103][103][103], int ablock_0, int ablock_1,
	    int ablock_2, int ablock_3, double avec[5][103][103][103],
	    int avec_0, int avec_1, int avec_2, double bvec[5][103][103][103],
...
static void
matmul_sub (double ablock[3][5][5][103][103][103], int ablock_0, int ablock_1,
	    int ablock_2, int ablock_3, double bblock[3][5][5][103][103][103],
	    int bblock_0, int bblock_1, int bblock_2, int bblock_3,
	    double cblock[3][5][5][103][103][103], int cblock_0, int cblock_1,
...
static void
binvrhs (double lhs[3][5][5][103][103][103], int lhs_0, int lhs_1, int lhs_2,
	 int lhs_3, double r[5][103][103][103], int r_0, int r_1, int r_2)
{
  double pivot, coeff;
  pivot = 1.00 / lhs[lhs_3][0][0][lhs_0][lhs_1][lhs_2];
  lhs[lhs_3][0][1][lhs_0][lhs_1][lhs_2] =
		    ...
		    int c_3, __global double *r, int r_0, int r_1, int r_2)
{
  ...
  pivot =
	...
	(3, 5, 5, 103, 103, 103, (lhs_3), (0), (0), (lhs_0), (lhs_1),
	 (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (0), (1), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (0), (1), (lhs_0), (lhs_1),
	 (lhs_2))] * pivot;
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (0), (2), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (0), (2), (lhs_0), (lhs_1),
	 (lhs_2))] * pivot;
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (0), (3), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (0), (3), (lhs_0), (lhs_1),
	 (lhs_2))] * pivot;
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (0), (4), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (0), (4), (lhs_0), (lhs_1),
	 (lhs_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (0), (0), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (0), (0), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (0), (1), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (0), (1), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (0), (2), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (0), (2), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (0), (3), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (0), (3), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (0), (4), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (0), (4), (c_0), (c_1), (c_2))] * pivot;
  r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (r_0), (r_1), (r_2))] =
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (r_0), (r_1), (r_2))] *
    pivot;
  coeff =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (1), (0), (lhs_0), (lhs_1),
	 (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (1), (1), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (1), (1), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      (lhs_3), (0), (1),
						      (lhs_0), (lhs_1),
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (1), (2), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (1), (2), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (1), (3), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (1), (3), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (1), (4), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (1), (4), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (1), (0), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (1), (0), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (0), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (1), (1), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (1), (1), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (1), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (1), (2), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (1), (2), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (2), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (1), (3), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (1), (3), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (3), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (1), (4), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (1), (4), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (4), (c_0), (c_1),
						(c_2))];
  r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (r_0), (r_1), (r_2))] =
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (r_0), (r_1), (r_2))] -
    coeff *
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (r_0), (r_1), (r_2))];
  coeff =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (2), (0), (lhs_0), (lhs_1),
	 (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (2), (1), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (2), (1), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (2), (2), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (2), (2), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (2), (3), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (2), (3), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (2), (4), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (2), (4), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (2), (0), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (2), (0), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (0), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (2), (1), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (2), (1), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (1), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (2), (2), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (2), (2), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (2), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (2), (3), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (2), (3), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (3), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (2), (4), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (2), (4), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (4), (c_0), (c_1),
						(c_2))];
  r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (r_0), (r_1), (r_2))] =
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (r_0), (r_1), (r_2))] -
    coeff *
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (r_0), (r_1), (r_2))];
  coeff =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (3), (0), (lhs_0), (lhs_1),
	 (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (3), (1), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (3), (1), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (3), (2), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (3), (2), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (3), (3), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (3), (3), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (3), (4), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (3), (4), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (3), (0), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (3), (0), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (0), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (3), (1), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (3), (1), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (1), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (3), (2), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (3), (2), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (2), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (3), (3), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (3), (3), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (3), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (3), (4), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (3), (4), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (4), (c_0), (c_1),
						(c_2))];
  r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (r_0), (r_1), (r_2))] =
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (r_0), (r_1), (r_2))] -
    coeff *
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (r_0), (r_1), (r_2))];
  coeff =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (4), (0), (lhs_0), (lhs_1),
	 (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (4), (1), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (4), (1), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (4), (2), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (4), (2), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (4), (3), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (4), (3), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  lhs[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (lhs_3), (4), (4), (lhs_0), (lhs_1),
       (lhs_2))] =
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (lhs_3), (4), (4), (lhs_0), (lhs_1),
	 (lhs_2))] - coeff * lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						      ...
						      (lhs_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (4), (0), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (4), (0), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (0), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (4), (1), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (4), (1), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (1), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (4), (2), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (4), (2), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (2), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (4), (3), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (4), (3), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (3), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (4), (4), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (4), (4), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(0), (4), (c_0), (c_1),
						(c_2))];
  r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (r_0), (r_1), (r_2))] =
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (r_0), (r_1), (r_2))] -
    coeff *
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (r_0), (r_1), (r_2))];
  pivot =
  ...
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (1), (0), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (1), (0), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (1), (1), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (1), (1), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (1), (2), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (1), (2), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (1), (3), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (1), (3), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (1), (4), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (1), (4), (c_0), (c_1), (c_2))] * pivot;
  r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (r_0), (r_1), (r_2))] =
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (r_0), (r_1), (r_2))] *
    pivot;
  coeff =
  ...
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (0), (0), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (0), (0), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(1), (0), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (0), (1), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (0), (1), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(1), (1), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (0), (2), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (0), (2), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(1), (2), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (0), (3), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (0), (3), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(1), (3), (c_0), (c_1),
						(c_2))];
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (0), (4), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (0), (4), (c_0), (c_1),
       (c_2))] - coeff * c[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103, (c_3),
						(1), (4), (c_0), (c_1),
						(c_2))];
  r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (r_0), (r_1), (r_2))] =
  ...
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (2), (0), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (2), (0), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (2), (1), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (2), (1), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (2), (2), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (2), (2), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (2), (3), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (2), (3), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (2), (4), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (2), (4), (c_0), (c_1), (c_2))] * pivot;
  r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (r_0), (r_1), (r_2))] =
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (r_0), (r_1), (r_2))] *
    pivot;
  coeff =
  ...
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (3), (0), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (3), (0), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (3), (1), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (3), (1), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (3), (2), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (3), (2), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (3), (3), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (3), (3), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (3), (4), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (3), (4), (c_0), (c_1), (c_2))] * pivot;
  r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (r_0), (r_1), (r_2))] =
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (r_0), (r_1), (r_2))] *
    pivot;
  coeff =
  ...
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (4), (0), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (4), (0), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (4), (1), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (4), (1), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (4), (2), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (4), (2), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (4), (3), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (4), (3), (c_0), (c_1), (c_2))] * pivot;
  c[CALC_6D_ARRAY_INDEX
    (3, 5, 5, 103, 103, 103, (c_3), (4), (4), (c_0), (c_1), (c_2))] =
    c[CALC_6D_ARRAY_INDEX
      (3, 5, 5, 103, 103, 103, (c_3), (4), (4), (c_0), (c_1), (c_2))] * pivot;
  r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (r_0), (r_1), (r_2))] =
    r[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (r_0), (r_1), (r_2))] *
    pivot;
  coeff =
  ...
  for (i = 0; i < 5; i++)
    {
      bvec[CALC_4D_ARRAY_INDEX
	   (5, 103, 103, 103, (i), (bvec_0), (bvec_1), (bvec_2))] =
	bvec[CALC_4D_ARRAY_INDEX
	     (5, 103, 103, 103, (i), (bvec_0), (bvec_1),
	      (bvec_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						       (ablock_3), (i), (0),
						       (ablock_0), (ablock_1),
						       (ablock_2))] *
	avec[CALC_4D_ARRAY_INDEX
	     (5, 103, 103, 103, (0), (avec_0), (avec_1),
	      (avec_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						       (ablock_3), (i), (1),
						       (ablock_0), (ablock_1),
						       (ablock_2))] *
	avec[CALC_4D_ARRAY_INDEX
	     (5, 103, 103, 103, (1), (avec_0), (avec_1),
	      (avec_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						       (ablock_3), (i), (2),
						       (ablock_0), (ablock_1),
						       (ablock_2))] *
	avec[CALC_4D_ARRAY_INDEX
	     (5, 103, 103, 103, (2), (avec_0), (avec_1),
	      (avec_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						       (ablock_3), (i), (3),
						       (ablock_0), (ablock_1),
						       (ablock_2))] *
	avec[CALC_4D_ARRAY_INDEX
	     (5, 103, 103, 103, (3), (avec_0), (avec_1),
	      (avec_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103, 103,
						       (ablock_3), (i), (4),
						       (ablock_0), (ablock_1),
						       (ablock_2))] *
	avec[CALC_4D_ARRAY_INDEX
	     (5, 103, 103, 103, (4), (avec_0), (avec_1), (avec_2))];
    }
}
  ...
  for (j = 0; j < 5; j++)
    {
      cblock[CALC_6D_ARRAY_INDEX
	     (3, 5, 5, 103, 103, 103, (cblock_3), (0), (j), (cblock_0),
	      (cblock_1), (cblock_2))] =
	cblock[CALC_6D_ARRAY_INDEX
	       (3, 5, 5, 103, 103, 103, (cblock_3), (0), (j), (cblock_0),
	...
	*
	bblock[CALC_6D_ARRAY_INDEX
	       (3, 5, 5, 103, 103, 103, (bblock_3), (0), (j), (bblock_0),
	...
	*
	bblock[CALC_6D_ARRAY_INDEX
	       (3, 5, 5, 103, 103, 103, (bblock_3), (1), (j), (bblock_0),
		(bblock_1), (bblock_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5,
								       5, 103,
								       103,
								       103,
	...
	*
	bblock[CALC_6D_ARRAY_INDEX
	       (3, 5, 5, 103, 103, 103, (bblock_3), (2), (j), (bblock_0),
		(bblock_1), (bblock_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5,
								       5, 103,
								       103,
								       103,
	...
	*
	bblock[CALC_6D_ARRAY_INDEX
	       (3, 5, 5, 103, 103, 103, (bblock_3), (3), (j), (bblock_0),
		(bblock_1), (bblock_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5,
								       5, 103,
								       103,
								       103,
	...
	*
	bblock[CALC_6D_ARRAY_INDEX
	       (3, 5, 5, 103, 103, 103, (bblock_3), (4), (j), (bblock_0),
		(bblock_1), (bblock_2))];
      cblock[CALC_6D_ARRAY_INDEX
	     (3, 5, 5, 103, 103, 103, (cblock_3), (1), (j), (cblock_0),
	      (cblock_1), (cblock_2))] =
	cblock[CALC_6D_ARRAY_INDEX
	       (3, 5, 5, 103, 103, 103, (cblock_3), (1), (j), (cblock_0),
		(cblock_1), (cblock_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5,
	...
	*
	bblock[CALC_6D_ARRAY_INDEX
		...
		(bblock_1), (bblock_2))];
      cblock[CALC_6D_ARRAY_INDEX
	     (3, 5, 5, 103, 103, 103, (cblock_3), (2), (j), (cblock_0),
	      (cblock_1), (cblock_2))] =
	cblock[CALC_6D_ARRAY_INDEX
	       (3, 5, 5, 103, 103, 103, (cblock_3), (2), (j), (cblock_0),
		(cblock_1), (cblock_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5,
	...
	*
	bblock[CALC_6D_ARRAY_INDEX
		...
		(bblock_1), (bblock_2))];
      cblock[CALC_6D_ARRAY_INDEX
	     (3, 5, 5, 103, 103, 103, (cblock_3), (3), (j), (cblock_0),
	      (cblock_1), (cblock_2))] =
	cblock[CALC_6D_ARRAY_INDEX
	       (3, 5, 5, 103, 103, 103, (cblock_3), (3), (j), (cblock_0),
		(cblock_1), (cblock_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5,
	...
	*
	bblock[CALC_6D_ARRAY_INDEX
		...
		(bblock_1), (bblock_2))];
      cblock[CALC_6D_ARRAY_INDEX
	     (3, 5, 5, 103, 103, 103, (cblock_3), (4), (j), (cblock_0),
	      (cblock_1), (cblock_2))] =
	cblock[CALC_6D_ARRAY_INDEX
	       (3, 5, 5, 103, 103, 103, (cblock_3), (4), (j), (cblock_0),
		(cblock_1), (cblock_2))] - ablock[CALC_6D_ARRAY_INDEX (3, 5,
...
//COPYIN (END)
  ...
  for (m = 0; m < 5; m++)
    {
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] +
	rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))];
    }
  //OPENCL KERNEL END 
}
...
//COPYIN (END)
  ...
  for (m = 0; m < 5; m++)
    {
      forcing[CALC_4D_ARRAY_INDEX (6, 103, 103, 103, (m), (i), (j), (k))] =
	0.0;
    }
  //OPENCL KERNEL END 
}
	     ...
	     int __ocl_j_bound)
{
  ...
  int m;			/* DEFINED AT bt.c : 335 */
  double ue[5][102];		/* THREADPRIVATE: DEFINED AT ./header.h : 74 */
  double dtpp;			/* DEFINED AT bt.c : 334 */
  double buf[5][102];		/* THREADPRIVATE: DEFINED AT ./header.h : 75 */
  double cuf[102];		/* THREADPRIVATE: DEFINED AT ./header.h : 72 */
  double q[102];		/* THREADPRIVATE: DEFINED AT ./header.h : 73 */
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
	...
	im1 = i - 1;
	ip1 = i + 1;
	forcing[CALC_4D_ARRAY_INDEX (6, 103, 103, 103, (0), (i), (j), (k))] =
	  forcing[CALC_4D_ARRAY_INDEX (6, 103, 103, 103, (0), (i), (j), (k))]
	  - tx2 * (ue[1][ip1] - ue[1][im1]) + dx1tx1 * (ue[0][ip1] -
							2.0 * ue[0][i] +
							ue[0][im1]);
	forcing[CALC_4D_ARRAY_INDEX (6, 103, 103, 103, (1), (i), (j), (k))] =
	  forcing[CALC_4D_ARRAY_INDEX (6, 103, 103, 103, (1), (i), (j), (k))]
...
//COPYIN (END)
  ...
  for (m = 0; m < 5; m++)
    {
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] = 1.0;
    }
  //OPENCL KERNEL END 
}
...
//COPYIN (END)
  ...
  for (n = 0; n < 5; n++)
    for (m = 0; m < 5; m++)
      {
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (m), (n), (i), (j), (k))] = 0.0;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (m), (n), (i), (j), (k))] = 0.0;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (2), (m), (n), (i), (j), (k))] = 0.0;
      }
  //OPENCL KERNEL END 
}
...
//COPYIN (END)
  ...
  for (m = 0; m < 5; m++)
    for (m = 0; m < 5; m++)
      {
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (m), (m), (i), (j), (k))] = 1.0;
      }
  //OPENCL KERNEL END 
}
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
    for (i = 0; i < grid_points[(0)]; i++)
      {
	tmp1 =
	  1.0 / u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))];
	tmp2 = tmp1 * tmp1;
	tmp3 = tmp1 * tmp2;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (0), (0), (i), (j), (k))] = 0.0;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (0), (1), (i), (j), (k))] = 1.0;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (0), (2), (i), (j), (k))] = 0.0;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (0), (3), (i), (j), (k))] = 0.0;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (0), (4), (i), (j), (k))] = 0.0;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (1), (0), (i), (j), (k))] =
	  -(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	    tmp2 *
	    u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))]) +
	  c2 * 0.50 *
	  (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
	   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] +
	   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] *
	   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) *
	  tmp2;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (1), (1), (i), (j), (k))] =
	  (2.0 -
	   c2) *
	  (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] /
	   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))]);
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (1), (2), (i), (j), (k))] =
	  -c2 *
	  (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	   tmp1);
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (1), (3), (i), (j), (k))] =
	  -c2 *
	  (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] *
	   tmp1);
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (1), (4), (i), (j), (k))] = c2;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (2), (0), (i), (j), (k))] =
	  -(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	    u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))]) *
	  tmp2;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (2), (1), (i), (j), (k))] =
	  u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	  tmp1;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (2), (2), (i), (j), (k))] =
	  u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	  tmp1;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (2), (3), (i), (j), (k))] = 0.0;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (2), (4), (i), (j), (k))] = 0.0;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (3), (0), (i), (j), (k))] =
	  -(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	    u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) *
	  tmp2;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (3), (1), (i), (j), (k))] =
	  u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] *
	  tmp1;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (3), (2), (i), (j), (k))] = 0.0;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (3), (3), (i), (j), (k))] =
	  u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	  tmp1;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (3), (4), (i), (j), (k))] = 0.0;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (4), (0), (i), (j), (k))] =
	  (c2 *
	   (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	    u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
	    u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	   ...
	   tmp2 -
	   c1 *
	   (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] *
	    tmp1)) * (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j),
					     (k))] * tmp1);
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (4), (1), (i), (j), (k))] =
	  c1 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] *
	  tmp1 -
	  0.50 * c2 * (3.0 *
		       u[CALC_4D_ARRAY_INDEX
			 (5, 103, 103, 103, (1), (i), (j),
			  (k))] * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103,
							 (1), (i), (j),
							 (k))] +
		       u[CALC_4D_ARRAY_INDEX
			 (5, 103, 103, 103, (2), (i), (j),
			 ...
			 (5, 103, 103, 103, (3), (i), (j),
			  (k))] * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103,
							 ...
							 (k))]) * tmp2;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (4), (2), (i), (j), (k))] =
	  -c2 *
	  (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))]) *
	  tmp2;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (4), (3), (i), (j), (k))] =
	  -c2 *
	  (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] *
	   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))]) *
	  tmp2;
	fjac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (4), (4), (i), (j), (k))] =
	  c1 *
	  (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	   tmp1);
	...
	njac[CALC_5D_ARRAY_INDEX
	  ...
	  con43 * c3c4 * tmp1;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (1), (2), (i), (j), (k))] = 0.0;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (1), (3), (i), (j), (k))] = 0.0;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (1), (4), (i), (j), (k))] = 0.0;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (2), (0), (i), (j), (k))] =
	  -c3c4 * tmp2 *
	  u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))];
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (2), (1), (i), (j), (k))] = 0.0;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (2), (2), (i), (j), (k))] = c3c4 * tmp1;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (2), (3), (i), (j), (k))] = 0.0;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (2), (4), (i), (j), (k))] = 0.0;
	njac[CALC_5D_ARRAY_INDEX
	  ...
	  u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))];
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (3), (1), (i), (j), (k))] = 0.0;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (3), (2), (i), (j), (k))] = 0.0;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (3), (3), (i), (j), (k))] = c3c4 * tmp1;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (3), (4), (i), (j), (k))] = 0.0;
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (4), (0), (i), (j), (k))] =
	...
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (4), (1), (i), (j), (k))] =
	  (con43 * c3c4 -
	   c1345) * tmp2 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i),
						  (j), (k))];
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (4), (2), (i), (j), (k))] =
	  (c3c4 -
	   c1345) * tmp2 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i),
						  (j), (k))];
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (4), (3), (i), (j), (k))] =
	  (c3c4 -
	   c1345) * tmp2 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i),
						  (j), (k))];
	njac[CALC_5D_ARRAY_INDEX
	     (5, 5, 103, 103, 102, (4), (4), (i), (j), (k))] = (c1345) * tmp1;
      }
    for (i = 1; i < grid_points[(0)] - 1; i++)
      {
	tmp1 = dt * tx1;
	tmp2 = dt * tx2;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (0), (0), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (0), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (0), (0), (i - 1),
							 (j),
							 (k))] - tmp1 * dx1;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (0), (1), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (1), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (0), (1), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (0), (2), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (2), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (0), (2), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (0), (3), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (3), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (0), (3), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (0), (4), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (4), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (0), (4), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (1), (0), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (1), (0), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (1), (0), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (1), (1), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (1), (1), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (1), (1), (i - 1),
							 (j),
							 (k))] - tmp1 * dx2;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (1), (2), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (1), (2), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (1), (2), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (1), (3), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (1), (3), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (1), (3), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (1), (4), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (1), (4), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (1), (4), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (2), (0), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (2), (0), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (2), (0), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (2), (1), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (2), (1), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (2), (1), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (2), (2), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (2), (2), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (2), (2), (i - 1),
							 (j),
							 (k))] - tmp1 * dx3;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (2), (3), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (2), (3), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (2), (3), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (2), (4), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (2), (4), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (2), (4), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (3), (0), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (3), (0), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (3), (0), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (3), (1), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (3), (1), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (3), (1), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (3), (2), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (3), (2), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (3), (2), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (3), (3), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (3), (3), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (3), (3), (i - 1),
							 (j),
							 (k))] - tmp1 * dx4;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (3), (4), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (3), (4), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (3), (4), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (4), (0), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (4), (0), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (4), (0), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (4), (1), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (4), (1), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (4), (1), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (4), (2), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (4), (2), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (4), (2), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (4), (3), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (4), (3), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (4), (3), (i - 1),
							 (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (0), (4), (4), (i), (j), (k))] =
	  -tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (4), (4), (i - 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (4), (4), (i - 1),
							 (j),
							 (k))] - tmp1 * dx5;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (0), (0), (i), (j), (k))] =
	  1.0 +
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (0), (i), (j),
		(k))] + tmp1 * 2.0 * dx1;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (0), (1), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (1), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (0), (2), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (2), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (0), (3), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (3), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (0), (4), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (4), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (1), (0), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (1), (0), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (1), (1), (i), (j), (k))] =
	  1.0 +
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (1), (1), (i), (j),
		(k))] + tmp1 * 2.0 * dx2;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (1), (2), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (1), (2), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (1), (3), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (1), (3), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (1), (4), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (1), (4), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (2), (0), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (2), (0), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (2), (1), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (2), (1), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (2), (2), (i), (j), (k))] =
	  1.0 +
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (2), (2), (i), (j),
		(k))] + tmp1 * 2.0 * dx3;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (2), (3), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (2), (3), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (2), (4), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (2), (4), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (3), (0), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (3), (0), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (3), (1), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (3), (1), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (3), (2), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (3), (2), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (3), (3), (i), (j), (k))] =
	  1.0 +
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (3), (3), (i), (j),
		(k))] + tmp1 * 2.0 * dx4;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (3), (4), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (3), (4), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (4), (0), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (4), (0), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (4), (1), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (4), (1), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (4), (2), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (4), (2), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (4), (3), (i), (j), (k))] =
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (4), (3), (i), (j), (k))];
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (1), (4), (4), (i), (j), (k))] =
	  1.0 +
	  tmp1 * 2.0 *
	  njac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (4), (4), (i), (j),
		(k))] + tmp1 * 2.0 * dx5;
	lhs[CALC_6D_ARRAY_INDEX
	    (3, 5, 5, 103, 103, 103, (2), (0), (0), (i), (j), (k))] =
	  tmp2 *
	  fjac[CALC_5D_ARRAY_INDEX
	       (5, 5, 103, 103, 102, (0), (0), (i + 1), (j),
		(k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
    ...
    tmp2 = tmp1 * tmp1;
    tmp3 = tmp1 * tmp2;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (0), (i), (j), (k))] =
      0.0;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (1), (i), (j), (k))] =
      0.0;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (2), (i), (j), (k))] =
      1.0;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (3), (i), (j), (k))] =
      0.0;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (4), (i), (j), (k))] =
      0.0;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1), (0), (i), (j), (k))] =
      -(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))]) * tmp2;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1), (1), (i), (j), (k))] =
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] * tmp1;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1), (2), (i), (j), (k))] =
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] * tmp1;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1), (3), (i), (j), (k))] =
      0.0;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1), (4), (i), (j), (k))] =
      0.0;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2), (0), (i), (j), (k))] =
      -(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	tmp2) +
      0.50 * c2 *
	...
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) *
       tmp2);
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2), (1), (i), (j), (k))] =
      -c2 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
      tmp1;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2), (2), (i), (j), (k))] =
      (2.0 -
       c2) * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j),
				    (k))] * tmp1;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2), (3), (i), (j), (k))] =
      -c2 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] *
      tmp1;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2), (4), (i), (j), (k))] =
      c2;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (0), (i), (j), (k))] =
      -(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) * tmp2;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (1), (i), (j), (k))] =
      0.0;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (2), (i), (j), (k))] =
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] * tmp1;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (3), (i), (j), (k))] =
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] * tmp1;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (4), (i), (j), (k))] =
      0.0;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (0), (i), (j), (k))] =
      (c2 *
       (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	...
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) *
       tmp2 -
       c1 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] *
       tmp1) * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j),
				      (k))] * tmp1;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (1), (i), (j), (k))] =
      -c2 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] * tmp2;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (2), (i), (j), (k))] =
      c1 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] *
      tmp1 -
      0.50 * c2 *
      ((u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
	3.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] +
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) *
       tmp2);
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (3), (i), (j), (k))] =
      -c2 * (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	     u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) *
      tmp2;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (4), (i), (j), (k))] =
      c1 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
      tmp1;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (0), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (1), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (2), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (3), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (4), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1), (0), (i), (j), (k))] =
      -c3c4 * tmp2 *
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))];
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1), (1), (i), (j), (k))] =
      c3c4 * tmp1;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1), (2), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1), (3), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1), (4), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2), (0), (i), (j), (k))] =
      -con43 * c3c4 * tmp2 *
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))];
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2), (1), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2), (2), (i), (j), (k))] =
      con43 * c3c4 * tmp1;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2), (3), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2), (4), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (0), (i), (j), (k))] =
      -c3c4 * tmp2 *
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))];
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (1), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (2), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (3), (i), (j), (k))] =
      c3c4 * tmp1;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (4), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (0), (i), (j), (k))] =
      -(c3c4 -
	c1345) * tmp3 *
      (((u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))]) *
	(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))]))) -
	...
	(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]))) -
      c1345 * tmp2 *
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))];
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (1), (i), (j), (k))] =
      (c3c4 -
       c1345) * tmp2 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j),
					      (k))];
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (2), (i), (j), (k))] =
      (con43 * c3c4 -
       c1345) * tmp2 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j),
					      (k))];
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (3), (i), (j), (k))] =
      (c3c4 -
       c1345) * tmp2 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j),
					      (k))];
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (4), (i), (j), (k))] =
      (c1345) * tmp1;
  }
  //OPENCL KERNEL END 
}
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
	...
	(3, 5, 5, 103, 103, 103, (0), (0), (0), (i), (j), (k))] =
      -tmp2 *
      fjac[CALC_5D_ARRAY_INDEX
	   (5, 5, 103, 103, 102, (0), (0), (i), (j - 1),
	    (k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0),
						     (0), (i), (j - 1),
						     (k))] - tmp1 * dy1;
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (0), (0), (1), (i), (j), (k))] =
	...
	(3, 5, 5, 103, 103, 103, (0), (1), (0), (i), (j), (k))] =
      -tmp2 *
      fjac[CALC_5D_ARRAY_INDEX
	   (5, 5, 103, 103, 102, (1), (0), (i), (j - 1),
	    (k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1),
						     (0), (i), (j - 1), (k))];
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (0), (1), (1), (i), (j), (k))] =
      -tmp2 *
      fjac[CALC_5D_ARRAY_INDEX
	   (5, 5, 103, 103, 102, (1), (1), (i), (j - 1),
	    (k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (1),
						     (1), (i), (j - 1),
						     (k))] - tmp1 * dy2;
    lhs[CALC_6D_ARRAY_INDEX
	...
	(3, 5, 5, 103, 103, 103, (0), (2), (0), (i), (j), (k))] =
      -tmp2 *
      fjac[CALC_5D_ARRAY_INDEX
	   (5, 5, 103, 103, 102, (2), (0), (i), (j - 1),
	    (k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2),
						     (0), (i), (j - 1), (k))];
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (0), (2), (1), (i), (j), (k))] =
      -tmp2 *
      fjac[CALC_5D_ARRAY_INDEX
	   (5, 5, 103, 103, 102, (2), (1), (i), (j - 1),
	    (k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (2),
						     (1), (i), (j - 1), (k))];
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (0), (2), (2), (i), (j), (k))] =
	...
	(3, 5, 5, 103, 103, 103, (0), (3), (0), (i), (j), (k))] =
      -tmp2 *
      fjac[CALC_5D_ARRAY_INDEX
	   (5, 5, 103, 103, 102, (3), (0), (i), (j - 1),
	    (k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3),
						     (0), (i), (j - 1), (k))];
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (0), (3), (1), (i), (j), (k))] =
      -tmp2 *
      fjac[CALC_5D_ARRAY_INDEX
	   (5, 5, 103, 103, 102, (3), (1), (i), (j - 1),
	    (k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3),
						     (1), (i), (j - 1), (k))];
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (0), (3), (2), (i), (j), (k))] =
	...
	(3, 5, 5, 103, 103, 103, (0), (4), (0), (i), (j), (k))] =
      -tmp2 *
      fjac[CALC_5D_ARRAY_INDEX
	   (5, 5, 103, 103, 102, (4), (0), (i), (j - 1),
	    (k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4),
						     (0), (i), (j - 1), (k))];
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (0), (4), (1), (i), (j), (k))] =
      -tmp2 *
      fjac[CALC_5D_ARRAY_INDEX
	   (5, 5, 103, 103, 102, (4), (1), (i), (j - 1),
	    (k))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4),
						     (1), (i), (j - 1), (k))];
    lhs[CALC_6D_ARRAY_INDEX
	(3, 5, 5, 103, 103, 103, (0), (4), (2), (i), (j), (k))] =
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
    ...
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (3), (i), (j), (k))] =
      (2.0 -
       c2) * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j),
				    (k))] * tmp1;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (3), (4), (i), (j), (k))] =
      c2;
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (0), (i), (j), (k))] =
	...
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) *
       tmp2 -
       c1 * (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] *
	     tmp1)) * (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j),
					      (k))] * tmp1);
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (1), (i), (j), (k))] =
      -c2 * (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	     u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) *
	...
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] +
	3.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) *
       tmp2);
    fjac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (4), (4), (i), (j), (k))] =
      c1 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] *
      tmp1;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (0), (i), (j), (k))] =
      0.0;
    njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102, (0), (1), (i), (j), (k))] =
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
	...
	(3, 5, 5, 103, 103, 103, (0), (0), (0), (i), (j), (k))] =
      ...
      fjac[CALC_5D_ARRAY_INDEX
	   (5, 5, 103, 103, 102, (0), (0), (i), (j),
	    (k - 1))] - tmp1 * njac[CALC_5D_ARRAY_INDEX (5, 5, 103, 103, 102,
							 (0), (0), (i), (j),
							 (k - 1))] -
      tmp1 * dz1;
    lhs[CALC_6D_ARRAY_INDEX
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
    rho_inv =
      1.0 / u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))];
    rho_i[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] = rho_inv;
    us[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] =
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] * rho_inv;
    vs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] =
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] * rho_inv;
    ws[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] =
      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] * rho_inv;
    square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] =
      0.5 * (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] *
	     u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
	     u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] *
	     u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] +
	     u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] *
	     u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))]) *
      rho_inv;
    qs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] =
      square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] * rho_inv;
  }
  //OPENCL KERNEL END 
}
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
    uijk = us[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))];
    up1 = us[CALC_3D_ARRAY_INDEX (103, 103, 103, (i + 1), (j), (k))];
    um1 = us[CALC_3D_ARRAY_INDEX (103, 103, 103, (i - 1), (j), (k))];
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))] +
      dx1tx1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i + 1), (j), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i - 1), (j), (k))]) -
      tx2 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i + 1), (j), (k))] -
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i - 1), (j), (k))]);
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
      dx2tx1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i + 1), (j), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i - 1), (j), (k))]) +
      ...
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i + 1), (j), (k))] *
       ...
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i - 1), (j), (k))] *
       um1 +
       (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i + 1), (j), (k))] -
	square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i + 1), (j), (k))] -
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i - 1), (j), (k))] +
	square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i - 1), (j), (k))]) * c2);
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] +
      dx3tx1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i + 1), (j), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i - 1), (j), (k))]) +
      xxcon2 * (vs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i + 1), (j), (k))] -
		2.0 * vs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
		vs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i - 1), (j), (k))]) -
      tx2 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i + 1), (j), (k))] *
       up1 -
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i - 1), (j), (k))] *
       um1);
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] +
      dx4tx1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i + 1), (j), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i - 1), (j), (k))]) +
      xxcon2 * (ws[CALC_3D_ARRAY_INDEX (103, 103, 103, (i + 1), (j), (k))] -
		2.0 * ws[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
		ws[CALC_3D_ARRAY_INDEX (103, 103, 103, (i - 1), (j), (k))]) -
      tx2 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i + 1), (j), (k))] *
       up1 -
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i - 1), (j), (k))] *
       um1);
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] +
      dx5tx1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i + 1), (j), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i - 1), (j), (k))]) +
      xxcon3 * (qs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i + 1), (j), (k))] -
		2.0 * qs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
		qs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i - 1), (j), (k))]) +
      xxcon4 * (up1 * up1 - 2.0 * uijk * uijk + um1 * um1) +
      xxcon5 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i + 1), (j), (k))] *
       rho_i[CALC_3D_ARRAY_INDEX (103, 103, 103, (i + 1), (j), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] *
       rho_i[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i - 1), (j), (k))] *
       rho_i[CALC_3D_ARRAY_INDEX (103, 103, 103, (i - 1), (j), (k))]) -
      tx2 *
      ((c1 *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i + 1), (j), (k))] -
	c2 * square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i + 1), (j), (k))]) *
       up1 -
       (c1 *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i - 1), (j), (k))] -
	c2 * square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i - 1), (j), (k))]) *
  ...
  //OPENCL KERNEL START 
  {
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
      ...
      dssp * (5.0 *
	      ...
	      4.0 *
	      u[CALC_4D_ARRAY_INDEX
		(5, 103, 103, 103, (m), (i + 1), (j),
		 (k))] + u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m),
						(i + 2), (j), (k))]);
  }
  //OPENCL KERNEL END 
}
  ...
  //OPENCL KERNEL START 
  {
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
      ...
      dssp * (-4.0 *
	      u[CALC_4D_ARRAY_INDEX
		(5, 103, 103, 103, (m), (i - 1), (j),
		 (k))] + 6.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m),
						      (i), (j),
						      (k))] -
	      4.0 *
	      u[CALC_4D_ARRAY_INDEX
...
//COPYIN (END)
  ...
  for (m = 0; m < 5; m++)
	...
	rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] -
	dssp *
	(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i - 2), (j), (k))] -
	 4.0 *
	 u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i - 1), (j), (k))] +
	 6.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] -
	 4.0 *
	 u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i + 1), (j), (k))] +
	 u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i + 2), (j), (k))]);
    }
  ...
  //OPENCL KERNEL START 
  {
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
      ...
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i - 2), (j), (k))] -
       4. *
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i - 1), (j), (k))] +
       5.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))]);
  }
  //OPENCL KERNEL END 
}
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
    vijk = vs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))];
    vp1 = vs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j + 1), (k))];
    vm1 = vs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j - 1), (k))];
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))] +
      dy1ty1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j + 1), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j - 1), (k))]) -
      ty2 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j + 1), (k))] -
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j - 1), (k))]);
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
      dy2ty1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j + 1), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j - 1), (k))]) +
      yycon2 * (us[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j + 1), (k))] -
		2.0 * us[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
		us[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j - 1), (k))]) -
      ty2 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j + 1), (k))] *
       vp1 -
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j - 1), (k))] *
    ...
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] =
      ...
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j + 1), (k))] *
       ...
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j - 1), (k))] *
       vm1 +
       (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j + 1), (k))] -
	square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j + 1), (k))] -
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j - 1), (k))] +
	square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j - 1), (k))]) * c2);
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] +
      dy4ty1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j + 1), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j - 1), (k))]) +
      yycon2 * (ws[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j + 1), (k))] -
		2.0 * ws[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
		ws[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j - 1), (k))]) -
      ty2 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j + 1), (k))] *
       vp1 -
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j - 1), (k))] *
    ...
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] =
      ...
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j + 1), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j - 1), (k))]) +
      yycon3 * (qs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j + 1), (k))] -
		2.0 * qs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
		qs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j - 1), (k))]) +
      yycon4 * (vp1 * vp1 - 2.0 * vijk * vijk + vm1 * vm1) +
      yycon5 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j + 1), (k))] *
       rho_i[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j + 1), (k))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] *
       rho_i[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j - 1), (k))] *
       rho_i[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j - 1), (k))]) -
      ...
      ((c1 *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j + 1), (k))] -
	c2 * square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j + 1), (k))]) *
       vp1 -
       (c1 *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j - 1), (k))] -
	c2 * square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j - 1), (k))]) *
  ...
  //OPENCL KERNEL START 
  {
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
      ...
      dssp * (5.0 *
	      ...
	      4.0 *
	      u[CALC_4D_ARRAY_INDEX
		(5, 103, 103, 103, (m), (i), (j + 1),
		 (k))] + u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i),
						(j + 2), (k))]);
  }
  //OPENCL KERNEL END 
}
...
//COPYIN (END)
  ...
  for (m = 0; m < 5; m++)
	...
	rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] -
	dssp *
	(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j - 2), (k))] -
	 4.0 *
	 u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j - 1), (k))] +
	 6.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] -
	 4.0 *
	 u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j + 1), (k))] +
	 u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j + 2), (k))]);
  ...
  //OPENCL KERNEL START 
  {
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
      ...
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j - 2), (k))] -
       4. *
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j - 1), (k))] +
       5. * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))]);
  }
  //OPENCL KERNEL END 
}
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
    wijk = ws[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))];
    wp1 = ws[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k + 1))];
    wm1 = ws[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k - 1))];
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))] +
      dz1tz1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k + 1))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (0), (i), (j), (k - 1))]) -
      tz2 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k + 1))] -
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k - 1))]);
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
      dz2tz1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k + 1))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k - 1))]) +
      zzcon2 * (us[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k + 1))] -
		2.0 * us[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
		us[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k - 1))]) -
      tz2 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k + 1))] *
       wp1 -
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (1), (i), (j), (k - 1))] *
    ...
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] +
      dz3tz1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k + 1))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k - 1))]) +
      zzcon2 * (vs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k + 1))] -
		2.0 * vs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
		vs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k - 1))]) -
      tz2 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k + 1))] *
       wp1 -
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (2), (i), (j), (k - 1))] *
    ...
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k))] =
      ...
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k + 1))] *
       ...
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (3), (i), (j), (k - 1))] *
       wm1 +
       (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k + 1))] -
	square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k + 1))] -
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k - 1))] +
	square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k - 1))]) * c2);
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] =
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] +
      dz5tz1 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k + 1))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k - 1))]) +
      zzcon3 * (qs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k + 1))] -
		2.0 * qs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
		qs[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k - 1))]) +
      zzcon4 * (wp1 * wp1 - 2.0 * wijk * wijk + wm1 * wm1) +
      zzcon5 *
      (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k + 1))] *
       rho_i[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k + 1))] -
       2.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k))] *
       rho_i[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k))] +
       u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k - 1))] *
       rho_i[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k - 1))]) -
      ...
      ((c1 *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k + 1))] -
	c2 * square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k + 1))]) *
       wp1 -
       (c1 *
	u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (4), (i), (j), (k - 1))] -
	c2 * square[CALC_3D_ARRAY_INDEX (103, 103, 103, (i), (j), (k - 1))]) *
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
////    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k), (j))] =
////      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k), (j))] -
////      dssp * (5.0 *
////	      u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k), (j))] -
////	      4.0 *
////	      u[CALC_4D_ARRAY_INDEX
////		(5, 103, 103, 103, (m), (i),
////		 (k + 1), (j))] + u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m),
////						    (i), (k + 2), (j))]);
    ...
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
      ...
      dssp * (5.0 *
	      ...
	      u[CALC_4D_ARRAY_INDEX
		(5, 103, 103, 103, (m), (i), (j),
		 (k + 1))] + u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m),
						    (i), (j), (k + 2))]);
  }
  //OPENCL KERNEL END 
}
...
////	      u[CALC_4D_ARRAY_INDEX
////		(5, 103, 103, 103, (m), (i),
////		 (k - 1), (j))] + 6.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103,
////							  (m), (i), (k),
////							  (j))] -
////	      4.0 *
////	      u[CALC_4D_ARRAY_INDEX
...
////						    (i), (k + 2), (j))]);
    ...
    rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
      ...
      dssp * (-4.0 *
	      u[CALC_4D_ARRAY_INDEX
		(5, 103, 103, 103, (m), (i), (j),
		 (k - 1))] + 6.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103,
							  (m), (i), (j),
							  (k))] -
	      4.0 *
	      u[CALC_4D_ARRAY_INDEX
  ...
  for (m = 0; m < 5; m++)
    {
      ...
      ////  rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k), (j))] -
      ////  dssp *
      ////  (u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k - 2), (j))] -
      ////   4.0 *
      ////   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k - 1), (j))] +
      ////   6.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k), (j))] -
      ////   4.0 *
      ////   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k + 1), (j))] +
      ////   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k + 2), (j))]);
	...
	rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] -
	dssp *
	(u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k - 2))] -
	 4.0 *
	 u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k - 1))] +
	 6.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] -
	 4.0 *
	 u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k + 1))] +
	 u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k + 2))]);
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
    ...
    ////   4.0 *
    ////   u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k - 1), (j))] +
    ////   5.0 * u[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (k), (j))]);
...
//COPYIN (END)
  ...
  for (m = 0; m < 5; m++)
    {
      rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
	rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] * dt;
    }
  //OPENCL KERNEL END 
}
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
	...
	rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
	  rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] -
	  lhs[CALC_6D_ARRAY_INDEX
	      (3, 5, 5, 103, 103, 103, (2), (m), (n), (i), (j),
	       (k))] * rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (n),
						(i + 1), (j), (k))];
      }
  }
  //OPENCL KERNEL END 
...
//COPYIN (END)
  ...
  //OPENCL KERNEL START 
  {
	...
	rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (m), (i), (j), (k))] =
	  ...
	  lhs[CALC_6D_ARRAY_INDEX
	      (3, 5, 5, 103, 103, 103, (2), (m), (n), (i), (j),
	       (k))] * rhs[CALC_4D_ARRAY_INDEX (5, 103, 103, 103, (n), (i),
						(j + 1), (k))];
      }
  }
  //OPENCL KERNEL END 
	...
	for (m = 0; m < 5; m++)
	  {
		...
		rhs[CALC_4D_ARRAY_INDEX
		    (5, 103, 103, 103, (m), (i), (k), (j))] =
		  rhs[CALC_4D_ARRAY_INDEX
		      (5, 103, 103, 103, (m), (i), (k),
		       (j))] - lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103,
							103, (2), (m), (n),
							(i), (k),
							(j))] *
		  rhs[CALC_4D_ARRAY_INDEX
		      (5, 103, 103, 103, (n), (i), (k + 1), (j))];

		////rhs[CALC_4D_ARRAY_INDEX
		////    (5, 103, 103, 103, (m), (i), (j), (k))] =
		////  rhs[CALC_4D_ARRAY_INDEX
		////      (5, 103, 103, 103, (m), (i), (j),
		////       (k))] - lhs[CALC_6D_ARRAY_INDEX (3, 5, 5, 103, 103,
		////					103, (2), (m), (n),
		////					(i), (j),
		////					(k))] *
		////  rhs[CALC_4D_ARRAY_INDEX
		////      (5, 103, 103, 103, (n), (i), (j), (k + 1))];
	      }
	  }
      }
  }
