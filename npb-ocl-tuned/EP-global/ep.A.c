//-------------------------------------------------------------------------------
//Host code 
//Generated at : Mon Aug 13 10:49:03 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
#define main_0_reduction_step1_MULT_ITER_0 2
#endif
...
//Do the final reduction part on the CPU
		...
		printf
		    ("EP Benchmark Results: \nCPU Time = %10.4f\nN = 2^%5d\nNo. Gaussian Pairs = %15.0f\nSums = %25.15e %25.15e\nCounts:\n",
		     tm, 28, gc, sx, sy);
		c_print_results("EP", 'A', 28 + 1, 0, 0, nit, nthreads, tm,
...
static void init_ocl_runtime()
{
	...
	__ocl_program = oclBuildProgram("ep.A.cl");
