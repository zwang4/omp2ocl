//-------------------------------------------------------------------------------
//Host code 
//Generated at : Thu Aug  9 15:29:55 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
{
	{
		...
		} else if (150000 == 7000 && 15 == 8 && 75 == 15
			   && 110.0 == 12.0) {
			class = 'W';
			zeta_verify_value = 10.362595087124;
		} else if (150000 == 14000 && 15 == 11 && 75 == 15
			   && 110.0 == 20.0) {
			class = 'A';
			zeta_verify_value = 17.130235054029;
		} else if (150000 == 75000 && 15 == 13 && 75 == 75
			   && 110.0 == 60.0) {
			class = 'B';
		...
		makea(naa, nzz, a, __ocl_buffer_a, colidx, __ocl_buffer_colidx,
		      rowstr, __ocl_buffer_rowstr, 15, firstrow, lastrow,
		      firstcol, lastcol, 1.0e-1, arow, NULL, acol, NULL, aelt,
		      NULL, v, NULL, iv, NULL, 110.0);
		init_ocl_runtime();
		{
			//--------------------------------------------------------------
...
static void init_ocl_runtime()
{
	...
	__ocl_program = oclBuildProgram("cg.C.cl");
...
{
	__ocl_buffer_colidx = oclCreateBuffer(colidx, (40950001) * sizeof(int));
	DYN_BUFFER_CHECK(__ocl_buffer_colidx, -1);
	__ocl_buffer_rowstr = oclCreateBuffer(rowstr, (150002) * sizeof(int));
	DYN_BUFFER_CHECK(__ocl_buffer_rowstr, -1);
	__ocl_buffer_x = oclCreateBuffer(x, (150003) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_x, -1);
	__ocl_buffer_z = oclCreateBuffer(z, (150003) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_z, -1);
	__ocl_buffer_q = oclCreateBuffer(q, (150003) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_q, -1);
	__ocl_buffer_r = oclCreateBuffer(r, (150003) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_r, -1);
	__ocl_buffer_p = oclCreateBuffer(p, (150003) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_p, -1);
	__ocl_buffer_w = oclCreateBuffer(w, (150003) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_w, -1);
	__ocl_buffer_a = oclCreateBuffer(a, (40950001) * sizeof(double));
