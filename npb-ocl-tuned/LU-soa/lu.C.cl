		     ...
		     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	__global double (*v)[162][163][163] =
	    (__global double (*)[162][163][163])g_v;
	__global double (*ldz)[5][162][162] =
	    (__global double (*)[5][162][162])g_ldz;
	//-------------------------------------------
		     ...
		     int jst, int ist, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*tv)[162][162] = (__global double (*)[162][162])g_tv;
	__global double (*udz)[5][162][162] =
	    (__global double (*)[5][162][162])g_udz;
	__global double (*v)[162][163][163] =
	    (__global double (*)[162][163][163])g_v;
	//-------------------------------------------
	//Convert global memory objects (END)
		     ...
		     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*frct)[162][163][163] =
	    (__global double (*)[162][163][163])g_frct;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*rsd)[162][163][163] =
	    (__global double (*)[162][163][163])g_rsd;
		     ...
		     int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*flux)[162][163][163] =
	    (__global double (*)[162][163][163])g_flux;
	__global double (*rsd)[162][163][163] =
	    (__global double (*)[162][163][163])g_rsd;
	//-------------------------------------------
	//Convert global memory objects (END)
		      ...
		      int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*u)[162][163][163] =
	    (__global double (*)[162][163][163])g_u;
	__global double (*d)[5][162][162] =
	    (__global double (*)[5][162][162])g_d;
	__global double (*a)[5][162][162] =
	    (__global double (*)[5][162][162])g_a;
	__global double (*b)[5][162][162] =
	    (__global double (*)[5][162][162])g_b;
	__global double (*c)[5][162][162] =
	    (__global double (*)[5][162][162])g_c;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
