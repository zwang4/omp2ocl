...
/* common /cvar/ */
static double u[5][ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1];
static double rsd[5][ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1];
static double frct[5][ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1];
static double flux[5][ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1];
...
/* common /cjac/ */
static double a[5][5][ISIZ1][ISIZ2];
static double b[5][5][ISIZ1][ISIZ2];
static double c[5][5][ISIZ1][ISIZ2];
static double d[5][5][ISIZ1][ISIZ2];
