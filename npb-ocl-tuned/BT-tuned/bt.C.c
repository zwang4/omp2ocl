//-------------------------------------------------------------------------------
//Host code 
//Generated at : Thu Aug  9 09:58:05 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
{
	{
		...
		if (grid_points[0] > 162 || grid_points[1] > 162
		    || grid_points[2] > 162) {
			printf(" %dx%dx%d\n", grid_points[0], grid_points[1],
			       grid_points[2]);
			printf
...
{
	lhsz();
	oclSwapDimensions (__ocl_buffer_lhs, 3 * 5 * 5 * (162 / 2 * 2 + 1), 162 / 2 * 2 + 1,
			  1, 162 / 2 * 2 + 1, sizeof(double));
	oclSwapDimensions (__ocl_buffer_rhs, 5 * (162 / 2 * 2 + 1), 162 / 2 * 2 + 1, 1,
			  162 / 2 * 2 + 1, sizeof(double));
	z_solve_cell();
	z_backsubstitute();
	oclSwapDimensions (__ocl_buffer_lhs, 3 * 5 * 5 * (162 / 2 * 2 + 1), 162 / 2 * 2 + 1,
			  1, 162 / 2 * 2 + 1, sizeof(double));
...
static void create_ocl_buffers()
{
	...
	__ocl_buffer_lhs =
	    oclCreateBuffer(lhs,
			    (3 * 5 * 5 * 163 * 163 * 163) * sizeof(double));
