...
static void compute_rhs()
{
	...
	oclSwapDimensions (__ocl_buffer_rhs, 5 * (12 / 2 * 2 + 1), 12 / 2 * 2 + 1, 1,
			  12 / 2 * 2 + 1, sizeof(double));
	oclSwapDimensions (__ocl_buffer_u, 5 * (12 / 2 * 2 + 1), 12 / 2 * 2 + 1, 1,
			  12 / 2 * 2 + 1, sizeof(double));
	k = 1;
	//--------------------------------------------------------------
...
{
	lhsz();
	oclSwapDimensions (__ocl_buffer_lhs, 3 * 5 * 5 * (12 / 2 * 2 + 1), 12 / 2 * 2 + 1, 1,
			  12 / 2 * 2 + 1, sizeof(double));
	oclSwapDimensions (__ocl_buffer_rhs, 5 * (12 / 2 * 2 + 1), 12 / 2 * 2 + 1, 1,
			  12 / 2 * 2 + 1, sizeof(double));
	z_solve_cell();
