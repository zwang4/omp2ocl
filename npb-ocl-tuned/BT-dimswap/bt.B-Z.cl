//-------------------------------------------------------------------------------
//OpenCL Kernels 
//Generated at : Thu Aug  9 10:01:02 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
void binvcrhs_g0_g5_g10(__global double (*lhs)[5][5][103][103][103], int lhs_0,
			int lhs_1, int lhs_2, int lhs_3,
			__global double (*c)[5][5][103][103][103], int c_0,
			int c_1, int c_2, int c_3,
			__global double (*r)[103][103][103], int r_0, int r_1,
			int r_2);
void matvec_sub_g0_g5_g9(__global double (*ablock)[5][5][103][103][103],
			 int ablock_0, int ablock_1, int ablock_2, int ablock_3,
			 __global double (*avec)[103][103][103], int avec_0,
			 int avec_1, int avec_2,
			 __global double (*bvec)[103][103][103], int bvec_0,
			 int bvec_1, int bvec_2);
void matmul_sub_g0_g5_g10(__global double (*ablock)[5][5][103][103][103],
			  int ablock_0, int ablock_1, int ablock_2,
			  int ablock_3,
			  __global double (*bblock)[5][5][103][103][103],
			  int bblock_0, int bblock_1, int bblock_2,
			  int bblock_3,
			  __global double (*cblock)[5][5][103][103][103],
			  int cblock_0, int cblock_1, int cblock_2,
			  int cblock_3);
void binvrhs_g0_g5(__global double (*lhs)[5][5][103][103][103], int lhs_0,
		   int lhs_1, int lhs_2, int lhs_3,
		   __global double (*r)[103][103][103], int r_0, int r_1,
		   int r_2);
void binvcrhs(double lhs[3][5][5][103][103][103], int lhs_0, int lhs_1,
	      int lhs_2, int lhs_3, double c[3][5][5][103][103][103], int c_0,
	      int c_1, int c_2, int c_3, double r[5][103][103][103], int r_0,
	      int r_1, int r_2);
void matvec_sub(double ablock[3][5][5][103][103][103], int ablock_0,
		...
		int bvec_1, int bvec_2);
void matmul_sub(double ablock[3][5][5][103][103][103], int ablock_0,
		int ablock_1, int ablock_2, int ablock_3,
...
void binvrhs(double lhs[3][5][5][103][103][103], int lhs_0, int lhs_1,
	     int lhs_2, int lhs_3, double r[5][103][103][103], int r_0, int r_1,
	     int r_2);
		    ...
		    int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	__global double (*u)[103][103][103] =
	    (__global double (*)[103][103][103])g_u;
	__global double (*rhs)[103][103][103] =
	    (__global double (*)[103][103][103])g_rhs;
	//-------------------------------------------
			  ...
			  int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*forcing)[103][103][103] =
	    (__global double (*)[103][103][103])g_forcing;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
			...
			int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*lhs)[5][5][103][103][103] =
	    (__global double (*)[5][5][103][103][103])g_lhs;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_j_bound)
{
	...
	__global double (*u)[103][103][103] =
	    (__global double (*)[103][103][103])g_u;
	__global double (*fjac)[5][103][103][102] =
	    (__global double (*)[5][103][103][102])g_fjac;
	__global double (*njac)[5][103][103][102] =
	    (__global double (*)[5][103][103][102])g_njac;
	__global double (*lhs)[5][5][103][103][103] =
	    (__global double (*)[5][5][103][103][103])g_lhs;
	//-------------------------------------------
	//Convert global memory objects (END)
			    ...
			    int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*u)[103][103][103] =
	    (__global double (*)[103][103][103])g_u;
	__global double (*rho_i)[103][103] =
	    (__global double (*)[103][103])g_rho_i;
	__global double (*us)[103][103] = (__global double (*)[103][103])g_us;
	__global double (*vs)[103][103] = (__global double (*)[103][103])g_vs;
	__global double (*ws)[103][103] = (__global double (*)[103][103])g_ws;
	__global double (*square)[103][103] =
	    (__global double (*)[103][103])g_square;
	__global double (*qs)[103][103] = (__global double (*)[103][103])g_qs;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
