//-------------------------------------------------------------------------------
//OpenCL Kernels 
//Generated at : Tue Aug  7 13:28:39 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*cv)[64][64] = (__global double (*)[64][64])g_cv;
	__global double (*us)[65][65] = (__global double (*)[65][65])g_us;
	__global double (*rhon)[64][64] = (__global double (*)[64][64])g_rhon;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*rhoq)[64][64] = (__global double (*)[64][64])g_rhoq;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*rhos)[64][64] = (__global double (*)[64][64])g_rhos;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
