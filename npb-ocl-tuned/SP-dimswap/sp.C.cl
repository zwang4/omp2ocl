//-------------------------------------------------------------------------------
//OpenCL Kernels 
//Generated at : Tue Aug  7 13:28:47 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
			...
			int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*lhs)[163][163][163] =
	    (__global double (*)[163][163][163])g_lhs;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*cv)[162][162] = (__global double (*)[162][162])g_cv;
	__global double (*us)[163][163] = (__global double (*)[163][163])g_us;
	__global double (*rhon)[162][162] =
	    (__global double (*)[162][162])g_rhon;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*lhs)[163][163][163] =
	    (__global double (*)[163][163][163])g_lhs;
	__global double (*speed)[163][163] =
	    (__global double (*)[163][163])g_speed;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*rhoq)[162][162] =
	    (__global double (*)[162][162])g_rhoq;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	__global double (*rhos)[162][162] =
	    (__global double (*)[162][162])g_rhos;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
			    ...
			    int __ocl_i_bound)
{
	...
	__global double (*speed)[163][163] =
	    (__global double (*)[163][163])g_speed;
	__global double (*ainv)[163][163] =
	    (__global double (*)[163][163])g_ainv;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
