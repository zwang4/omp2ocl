//-------------------------------------------------------------------------------
//Host code 
//Generated at : Tue Aug  7 13:28:45 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
static void init_ocl_runtime()
{
	...
	__ocl_program = oclBuildProgram("sp.C.cl");
...
static void create_ocl_buffers()
{
	...
	__ocl_buffer_ainv =
	    oclCreateBuffer(ainv, (163 * 163 * 163) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_ainv, -1);
	__ocl_buffer_forcing =
	    oclCreateBuffer(forcing, (5 * 163 * 163 * 163) * sizeof(double));
