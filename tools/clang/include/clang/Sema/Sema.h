...
public:
  //Zheng: Omp2Ocl
  StmtResult ActOclSync(SourceLocation ContinueLoc);
  StmtResult ActOclInit(SourceLocation ContinueLoc);
  StmtResult ActOclTerm(SourceLocation ContinueLoc);
  StmtResult ActOclFlush(SourceLocation ContinueLoc);
  StmtResult ActOclStartProfile(SourceLocation ContinueLoc);
  StmtResult ActOclStopProfile(SourceLocation ContinueLoc);
  StmtResult ActOclDumpProfile(SourceLocation ContinueLoc);
  StmtResult ActOclHostFlush(SourceLocation ContinueLoc, vector<string> vars);
  StmtResult ActOclHostRead(SourceLocation ContinueLoc, vector<string> vars);
  StmtResult ActOclDevRead(SourceLocation ContinueLoc, vector<string> vars);
  StmtResult ActOclDevWrite(SourceLocation ContinueLoc, vector<string> vars);
  StmtResult ActOclResetMLF(SourceLocation ContinueLoc);
  StmtResult ActOclEnableMLFRecord(SourceLocation ContinueLoc);
  StmtResult ActOclDisableMLFRecord(SourceLocation ContinueLoc);
  StmtResult ActOclDumpMLF(SourceLocation ContinueLoc);
