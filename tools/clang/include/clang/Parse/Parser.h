...
public:
  ...
  //Omp2Ocl
  StmtResult ParseOmp2OclObj(Omp2OclObj* p);

private:
  //Omp2Ocl: Parsing omp2ocl pragmas
  void ParseOmp2OclObj(StmtVector& Stmts);
  //===--------------------------------------------------------------------===//
...
private:
  ...
  StmtResult ParseForStatement(ParsedAttributes &Attr, OMPFor &o);
  StmtResult ParseForStatement(ParsedAttributes &Attr, OMPFor *pompfor = NULL);
