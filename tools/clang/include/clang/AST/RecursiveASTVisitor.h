...
//OMP2OCL
DEF_TRAVERSE_STMT(OclFlush, { })
DEF_TRAVERSE_STMT(OclHostFlush, { })
DEF_TRAVERSE_STMT(OclHostRead, { })
DEF_TRAVERSE_STMT(OclDevRead, { })
DEF_TRAVERSE_STMT(OclDevWrite, { })
DEF_TRAVERSE_STMT(OclStartProfile, { })
DEF_TRAVERSE_STMT(OclStopProfile, { })
DEF_TRAVERSE_STMT(OclDumpProfile, { })
DEF_TRAVERSE_STMT(OclInit, { })
DEF_TRAVERSE_STMT(OclTerm, { })
DEF_TRAVERSE_STMT(OclSync, { })
DEF_TRAVERSE_STMT(OclResetMLStmt, { })
DEF_TRAVERSE_STMT(OclDisableMLRecordStmt, { })
DEF_TRAVERSE_STMT(OclEnableMLRecordStmt, { })
DEF_TRAVERSE_STMT(OclDumpMLFStmt, { })
