...
class SourceManager : public llvm::RefCountedBase<SourceManager> {
  ...
  //std::fstream OpenCLOutput;
  llvm::raw_fd_ostream* OpenCLOutput;
...
public:
  ...
  std::string getEntryFileName() { return sourceFileName; }
  ...
  FileID createMainFileID(const FileEntry *SourceFile) {
    ...
    MainFileID = createMainFileID(SourceFile, SourceLocation(), SrcMgr::C_User);
    return MainFileID;
  }
