...
//OMP2OCL
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclSync(OclSync *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclHostFlush(OclHostFlush *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclDevRead(OclDevRead *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclDevWrite(OclDevWrite *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclInit(OclInit *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclFlush(OclFlush *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclHostRead(OclHostRead *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclStartProfile(OclStartProfile *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclStopProfile(OclStopProfile *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclDumpProfile(OclDumpProfile *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclTerm(OclTerm *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclResetMLStmt(OclResetMLStmt *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclEnableMLRecordStmt(OclEnableMLRecordStmt *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclDisableMLRecordStmt(OclDisableMLRecordStmt *S) { return StmtError(); }
template<typename Derived> StmtResult TreeTransform<Derived>::TransformOclDumpMLFStmt(OclDumpMLFStmt *S) { return StmtError(); }
} // end namespace clang
