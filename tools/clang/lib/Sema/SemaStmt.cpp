...
Sema::ActOnForStmt(SourceLocation ForLoc, SourceLocation LParenLoc,
                   ...
                   FullExprArg third,
                   SourceLocation RParenLoc, Stmt *Body, OMPFor* omp_for) {
...
StmtResult Sema::ActOclSync(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclSync(ContinueLoc));
}

StmtResult Sema::ActOclInit(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclInit(ContinueLoc));
}

StmtResult Sema::ActOclResetMLF(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclResetMLStmt(ContinueLoc));
}

StmtResult Sema::ActOclTerm(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclTerm(ContinueLoc));
}

StmtResult Sema::ActOclFlush(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclFlush(ContinueLoc));
}

StmtResult Sema::ActOclStartProfile(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclStartProfile(ContinueLoc));
}

StmtResult Sema::ActOclStopProfile(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclStopProfile(ContinueLoc));
}

StmtResult Sema::ActOclDumpProfile(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclDumpProfile(ContinueLoc));
}

StmtResult Sema::ActOclHostFlush(SourceLocation ContinueLoc, vector<string> vars) {
  return Owned(new (Context) OclHostFlush(ContinueLoc, vars));
}

StmtResult Sema::ActOclHostRead(SourceLocation ContinueLoc, vector<string> vars) {
  return Owned(new (Context) OclHostRead(ContinueLoc, vars));
}

StmtResult Sema::ActOclDevRead(SourceLocation ContinueLoc, vector<string> vars) {
  return Owned(new (Context) OclDevRead(ContinueLoc, vars));
}

StmtResult Sema::ActOclDevWrite(SourceLocation ContinueLoc, vector<string> vars) {
  return Owned(new (Context) OclDevWrite(ContinueLoc, vars));
}

StmtResult Sema::ActOclDisableMLFRecord(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclDisableMLRecordStmt(ContinueLoc));
}

StmtResult Sema::ActOclEnableMLFRecord(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclEnableMLRecordStmt(ContinueLoc));
}

StmtResult Sema::ActOclDumpMLF(SourceLocation ContinueLoc) {
  return Owned(new (Context) OclDumpMLFStmt(ContinueLoc));
}
