...
void Preprocessor::EnterSourceFile(FileID FID, const DirectoryLookup *CurDir,
                                   SourceLocation Loc, bool isMainFile) {
  ...
  //FIXME: This assumes we only concern a single file 
  if (isMainFile)
	 {
	 	SourceLocation FileStart = SourceMgr.getLocForStartOfFile(FID);
		string filename = SourceMgr.getPresumedLoc(FileStart).getFilename();
		concernFile = filename;
	 }
