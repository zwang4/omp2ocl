...
void Preprocessor::AddHeadFile(string file)
{
...
void Preprocessor::HandleIncludeDirective(SourceLocation HashLoc, 
	...
	string filename = SourceMgr.getPresumedLoc(HashLoc).getFilename();
	if (filename == concernFile)
	{
		AddHeadFile(Filename.str());
	}
