...
namespace {
	class ASTPrinter : public ASTConsumer 
		...
		{
			std::cout << "I am visiting a for statement" << std::endl;
			
			if (f->isParallelForLoop())
			{
				std::cout << "This is a parallel for loop" << std::endl;
			}

			Stmt* S = f->getBody();
			if (dyn_cast<ForStmt>(S))
			{
				std::cout << "The next is a for statement" << std::endl;
			}
