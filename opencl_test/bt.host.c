...
static void matvec_sub(double ablock[5][5], ocl_buffer * __ocl_buffer_ablock,
		       double avec[5], ocl_buffer * __ocl_buffer_avec,
		       double bvec[5], ocl_buffer * __ocl_buffer_bvec);
static void matmul_sub(double ablock[5][5], ocl_buffer * __ocl_buffer_ablock,
		       double bblock[5][5], ocl_buffer * __ocl_buffer_bblock,
		       double cblock[5][5], ocl_buffer * __ocl_buffer_cblock);
static void binvcrhs(double lhs[5][5], ocl_buffer * __ocl_buffer_lhs,
		     double c[5][5], ocl_buffer * __ocl_buffer_c, double r[5],
		     ocl_buffer * __ocl_buffer_r);
static void binvrhs(double lhs[5][5], ocl_buffer * __ocl_buffer_lhs,
		    double r[5], ocl_buffer * __ocl_buffer_r);
static void y_solve();
...
int main(int argc, char **argv, ocl_buffer * __ocl_buffer_argv)
{
	...
	c_print_results("BT", class, grid_points[0], grid_points[1],
			...
			"25 Apr 2012", "gcc", "gcc",
			"-lm /afs/inf.ed.ac.uk/user/s07/s0786582/wor...",
			"-I../common -I../. -I/afs/inf.ed.ac.uk/user...",
			"-O3 -fopenmp", "-fopenmp", "(none)");
}
...
static void add()
{
	...
	//--------------------------------------------------------------
	{
		...
		size_t __ocl_gws[3];
		__ocl_gws[0] = (5) - (0);
		__ocl_gws[1] = (grid_points[2] - 1) - (1);
		__ocl_gws[2] = (grid_points[1] - 1) - (1);

		oclGetWorkSize(3, __ocl_gws, NULL);
		oclSetKernelArgBuffer(__ocl_add_0, 0, __ocl_buffer_u);
		oclSetKernelArgBuffer(__ocl_add_0, 1, __ocl_buffer_rhs);
		oclSetKernelArgBuffer(__ocl_add_0, 2, __ocl_buffer_grid_points);
		int __ocl_k_bound = grid_points[2] - 1;
		oclSetKernelArg(__ocl_add_0, 3, sizeof(int), &__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 1;
		oclSetKernelArg(__ocl_add_0, 4, sizeof(int), &__ocl_j_bound);
		//------------------------------------------
		...
		oclDevWrites(__ocl_buffer_grid_points);
		//------------------------------------------
		//Write set (END) 
		//------------------------------------------
		//------------------------------------------
		...
		oclRunKernel(__ocl_add_0, 3, __ocl_gws);
	}
...
static void exact_rhs()
{
	...
	//--------------------------------------------------------------
	{
		...
		size_t __ocl_gws[3];
		__ocl_gws[0] = (5) - (0);
		__ocl_gws[1] = (grid_points[2]) - (0);
		__ocl_gws[2] = (grid_points[1]) - (0);

		oclGetWorkSize(3, __ocl_gws, NULL);
		oclSetKernelArgBuffer(__ocl_exact_rhs_0, 0,
				      __ocl_buffer_forcing);
		oclSetKernelArgBuffer(__ocl_exact_rhs_0, 1,
		...
		oclRunKernel(__ocl_exact_rhs_0, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t __ocl_gws[1];
		__ocl_gws[0] = (grid_points[1] - 1) - (1);

		oclGetWorkSize(1, __ocl_gws, NULL);
		oclSetKernelArg(__ocl_exact_rhs_1, 0, sizeof(double), &dnym1);
		oclSetKernelArgBuffer(__ocl_exact_rhs_1, 1,
				      __ocl_buffer_grid_points);
		oclSetKernelArg(__ocl_exact_rhs_1, 2, sizeof(double), &dnzm1);
		...
		oclRunKernel(__ocl_exact_rhs_1, 1, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t __ocl_gws[1];
		__ocl_gws[0] = (grid_points[0] - 1) - (1);

		oclGetWorkSize(1, __ocl_gws, NULL);
		oclSetKernelArg(__ocl_exact_rhs_2, 0, sizeof(double), &dnxm1);
		oclSetKernelArgBuffer(__ocl_exact_rhs_2, 1,
				      __ocl_buffer_grid_points);
		oclSetKernelArg(__ocl_exact_rhs_2, 2, sizeof(double), &dnzm1);
		...
		oclRunKernel(__ocl_exact_rhs_2, 1, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_exact_rhs_3, 1,
				      __ocl_buffer_grid_points);
		oclSetKernelArg(__ocl_exact_rhs_3, 2, sizeof(double), &dnym1);
		...
		oclRunKernel(__ocl_exact_rhs_3, 1, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_exact_rhs_4, 0,
				      __ocl_buffer_forcing);
		oclSetKernelArgBuffer(__ocl_exact_rhs_4, 1,
				      __ocl_buffer_grid_points);
		int __ocl_k_bound = grid_points[2] - 1;
		...
		oclRunKernel(__ocl_exact_rhs_4, 3, __ocl_gws);
	}
...
static void initialize()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_initialize_0, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t __ocl_gws[1];
		__ocl_gws[0] = (grid_points[0]) - (0);

		oclGetWorkSize(1, __ocl_gws, NULL);
		oclSetKernelArg(__ocl_initialize_1, 0, sizeof(double), &dnxm1);
		oclSetKernelArgBuffer(__ocl_initialize_1, 1,
				      __ocl_buffer_grid_points);
		oclSetKernelArg(__ocl_initialize_1, 2, sizeof(double), &dnym1);
		oclSetKernelArg(__ocl_initialize_1, 3, sizeof(double), &dnzm1);
		oclSetKernelArgBuffer(__ocl_initialize_1, 4, __ocl_buffer_u);
		oclSetKernelArgBuffer(__ocl_initialize_1, 5, __ocl_buffer_ce);
		...
		oclRunKernel(__ocl_initialize_1, 1, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t __ocl_gws[1];
		__ocl_gws[0] = (grid_points[1]) - (0);

		oclGetWorkSize(1, __ocl_gws, NULL);
		oclSetKernelArg(__ocl_initialize_2, 0, sizeof(double), &dnym1);
		oclSetKernelArgBuffer(__ocl_initialize_2, 1,
				      __ocl_buffer_grid_points);
		oclSetKernelArg(__ocl_initialize_2, 2, sizeof(double), &dnzm1);
		oclSetKernelArg(__ocl_initialize_2, 3, sizeof(double), &xi);
		oclSetKernelArgBuffer(__ocl_initialize_2, 4, __ocl_buffer_u);
		oclSetKernelArg(__ocl_initialize_2, 5, sizeof(int), &i);
		oclSetKernelArgBuffer(__ocl_initialize_2, 6, __ocl_buffer_ce);
		int __ocl_j_bound = grid_points[1];
		...
		oclRunKernel(__ocl_initialize_2, 1, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t __ocl_gws[2];
		__ocl_gws[0] = (grid_points[2]) - (0);
		__ocl_gws[1] = (grid_points[1]) - (0);

		oclGetWorkSize(2, __ocl_gws, NULL);
		...
		oclRunKernel(__ocl_initialize_3, 2, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_initialize_4, 1,
				      __ocl_buffer_grid_points);
		oclSetKernelArg(__ocl_initialize_4, 2, sizeof(double), &dnzm1);
		oclSetKernelArg(__ocl_initialize_4, 3, sizeof(double), &eta);
		oclSetKernelArgBuffer(__ocl_initialize_4, 4, __ocl_buffer_u);
		oclSetKernelArg(__ocl_initialize_4, 5, sizeof(int), &j);
		oclSetKernelArgBuffer(__ocl_initialize_4, 6, __ocl_buffer_ce);
		int __ocl_i_bound = grid_points[0];
		...
		oclRunKernel(__ocl_initialize_4, 1, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_initialize_5, 1,
				      __ocl_buffer_grid_points);
		oclSetKernelArg(__ocl_initialize_5, 2, sizeof(double), &dnzm1);
		oclSetKernelArg(__ocl_initialize_5, 3, sizeof(double), &eta);
		oclSetKernelArgBuffer(__ocl_initialize_5, 4, __ocl_buffer_u);
		oclSetKernelArg(__ocl_initialize_5, 5, sizeof(int), &j);
		oclSetKernelArgBuffer(__ocl_initialize_5, 6, __ocl_buffer_ce);
		int __ocl_i_bound = grid_points[0];
		...
		oclRunKernel(__ocl_initialize_5, 1, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_initialize_6, 1,
				      __ocl_buffer_grid_points);
		oclSetKernelArg(__ocl_initialize_6, 2, sizeof(double), &dnym1);
		oclSetKernelArg(__ocl_initialize_6, 3, sizeof(double), &zeta);
		oclSetKernelArgBuffer(__ocl_initialize_6, 4, __ocl_buffer_u);
		oclSetKernelArg(__ocl_initialize_6, 5, sizeof(int), &k);
		oclSetKernelArgBuffer(__ocl_initialize_6, 6, __ocl_buffer_ce);
		int __ocl_i_bound = grid_points[0];
		...
		oclRunKernel(__ocl_initialize_6, 1, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_initialize_7, 1,
				      __ocl_buffer_grid_points);
		oclSetKernelArg(__ocl_initialize_7, 2, sizeof(double), &dnym1);
		oclSetKernelArg(__ocl_initialize_7, 3, sizeof(double), &zeta);
		oclSetKernelArgBuffer(__ocl_initialize_7, 4, __ocl_buffer_u);
		oclSetKernelArg(__ocl_initialize_7, 5, sizeof(int), &k);
		oclSetKernelArgBuffer(__ocl_initialize_7, 6, __ocl_buffer_ce);
		int __ocl_i_bound = grid_points[0];
		...
		oclRunKernel(__ocl_initialize_7, 1, __ocl_gws);
	}
...
static void lhsinit()
{
	...
	//--------------------------------------------------------------
	{
		...
		__ocl_gws[0] = (5) - (0);
		__ocl_gws[1] = (5) - (0);
		__ocl_gws[2] = (grid_points[2]) - (0);

		oclGetWorkSize(3, __ocl_gws, NULL);
		oclSetKernelArgBuffer(__ocl_lhsinit_0, 0, __ocl_buffer_lhs);
		oclSetKernelArgBuffer(__ocl_lhsinit_0, 1,
				      __ocl_buffer_grid_points);
		int __ocl_k_bound = grid_points[2];
		...
		oclRunKernel(__ocl_lhsinit_0, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsinit_1, 1,
				      __ocl_buffer_grid_points);
		int __ocl_k_bound = grid_points[2];
		...
		oclRunKernel(__ocl_lhsinit_1, 2, __ocl_gws);
	}
...
static void lhsx()
{
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t __ocl_gws[2];
		__ocl_gws[0] = (grid_points[2] - 1) - (1);
		__ocl_gws[1] = (grid_points[1] - 1) - (1);
		...
		oclRunKernel(__ocl_lhsx_0, 2, __ocl_gws);
	}
...
static void lhsy()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_lhsy_0, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_lhsy_1, 3, __ocl_gws);
	}
...
static void lhsz()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_lhsz_0, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_lhsz_1, 3, __ocl_gws);
	}
...
static void compute_rhs()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_0, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_1, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_2, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_3, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_4, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_compute_rhs_5, 3,
				      __ocl_buffer_grid_points);
		int __ocl_k_bound = grid_points[2] - 1;
		...
		oclRunKernel(__ocl_compute_rhs_5, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_6, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_7, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_8, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_9, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_10, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_compute_rhs_11, 3,
				      __ocl_buffer_grid_points);
		int __ocl_k_bound = grid_points[2] - 1;
		...
		oclRunKernel(__ocl_compute_rhs_11, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_12, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_13, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_14, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_15, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_16, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_compute_rhs_17, 3,
				      __ocl_buffer_grid_points);
		...
		oclRunKernel(__ocl_compute_rhs_17, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_18, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_compute_rhs_19, 3, __ocl_gws);
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_compute_rhs_20, 2,
				      __ocl_buffer_grid_points);
		int __ocl_k_bound = grid_points[2] - 1;
		...
		oclRunKernel(__ocl_compute_rhs_20, 3, __ocl_gws);
	}
...
static void verify(int no_time_steps, char *class,
		   ...
		   ocl_buffer * __ocl_buffer_verified)
{
	double xcrref[5], xceref[5], xcrdif[5], xcedif[5], epsilon, xce[5],
	    xcr[5], dtref;
	...
	for (i = grid_points[0] - 2; i >= 0; i--) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArgBuffer(__ocl_x_backsubstitute_0, 2,
					      __ocl_buffer_lhs);
			oclSetKernelArgBuffer(__ocl_x_backsubstitute_0, 3,
					      __ocl_buffer_grid_points);
			int __ocl_k_bound = grid_points[2] - 1;
			...
			oclRunKernel(__ocl_x_backsubstitute_0, 3, __ocl_gws);
		}
...
static void x_solve_cell()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_x_solve_cell_0, 2, __ocl_gws);
	}
	...
	for (i = 1; i < isize; i++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclRunKernel(__ocl_x_solve_cell_1, 2, __ocl_gws);
		}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_x_solve_cell_2, 2, __ocl_gws);
	}
	...
	for (j = grid_points[1] - 2; j >= 0; j--) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArgBuffer(__ocl_y_backsubstitute_0, 2,
					      __ocl_buffer_lhs);
			oclSetKernelArgBuffer(__ocl_y_backsubstitute_0, 3,
					      __ocl_buffer_grid_points);
			int __ocl_k_bound = grid_points[2] - 1;
			...
			oclRunKernel(__ocl_y_backsubstitute_0, 3, __ocl_gws);
		}
...
static void y_solve_cell()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_y_solve_cell_0, 2, __ocl_gws);
	}
	...
	for (j = 1; j < jsize; j++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclRunKernel(__ocl_y_solve_cell_1, 2, __ocl_gws);
		}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_y_solve_cell_2, 2, __ocl_gws);
	}
...
static void z_backsubstitute()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_z_backsubstitute_0, 1, __ocl_gws);
	}
...
static void z_solve_cell()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_z_solve_cell_0, 2, __ocl_gws);
	}
	...
	for (k = 1; k < ksize; k++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclRunKernel(__ocl_z_solve_cell_1, 2, __ocl_gws);
		}
	...
	//--------------------------------------------------------------
	{
		...
		oclRunKernel(__ocl_z_solve_cell_2, 2, __ocl_gws);
	}
...
static void init_ocl_runtime()
{
	...
	__ocl_program = oclBuildProgram("bt.cl");
	...
	__ocl_tls_2D_checking =
	    oclCreateKernel(__ocl_program, "TLS_Checking_2D");
	DYN_PROGRAM_CHECK(__ocl_tls_2D_checking);
	__ocl_tls_3D_checking =
	    oclCreateKernel(__ocl_program, "TLS_Checking_3D");
	DYN_PROGRAM_CHECK(__ocl_tls_3D_checking);
	__ocl_tls_4D_checking =
	    oclCreateKernel(__ocl_program, "TLS_Checking_4D");
	DYN_PROGRAM_CHECK(__ocl_tls_4D_checking);
	__ocl_tls_5D_checking =
	    oclCreateKernel(__ocl_program, "TLS_Checking_5D");
	DYN_PROGRAM_CHECK(__ocl_tls_5D_checking);
	__ocl_tls_6D_checking =
	    oclCreateKernel(__ocl_program, "TLS_Checking_6D");
	DYN_PROGRAM_CHECK(__ocl_tls_6D_checking);
	__ocl_tls_7D_checking =
	    oclCreateKernel(__ocl_program, "TLS_Checking_7D");
	DYN_PROGRAM_CHECK(__ocl_tls_7D_checking);
	create_ocl_buffers();
}
...
{
	__ocl_buffer_u =
	    oclCreateBuffer(u, (25 * 25 * 25 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_u, -1);
	__ocl_buffer_rhs =
	    oclCreateBuffer(rhs, (25 * 25 * 25 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_rhs, -1);
	__ocl_buffer_grid_points =
	    oclCreateBuffer(grid_points, (3) * sizeof(int));
	DYN_BUFFER_CHECK(__ocl_buffer_grid_points, -1);
	__ocl_buffer_forcing =
	    oclCreateBuffer(forcing, (25 * 25 * 25 * 6) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_forcing, -1);
	__ocl_buffer_ue = oclCreateBuffer(ue, (24 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_ue, -1);
	__ocl_buffer_buf = oclCreateBuffer(buf, (24 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_buf, -1);
	__ocl_buffer_cuf = oclCreateBuffer(cuf, (24) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_cuf, -1);
	__ocl_buffer_q = oclCreateBuffer(q, (24) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_q, -1);
	__ocl_buffer_ce = oclCreateBuffer(ce, (5 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_ce, -1);
	__ocl_buffer_lhs =
	    oclCreateBuffer(lhs, (25 * 25 * 25 * 3 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_lhs, -1);
	__ocl_buffer_fjac =
	    oclCreateBuffer(fjac, (24 * 24 * 23 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_fjac, -1);
	__ocl_buffer_njac =
	    oclCreateBuffer(njac, (24 * 24 * 23 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_njac, -1);
	__ocl_buffer_rho_i =
	    oclCreateBuffer(rho_i, (25 * 25 * 25) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_rho_i, -1);
	__ocl_buffer_us = oclCreateBuffer(us, (25 * 25 * 25) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_us, -1);
	__ocl_buffer_vs = oclCreateBuffer(vs, (25 * 25 * 25) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_vs, -1);
	__ocl_buffer_ws = oclCreateBuffer(ws, (25 * 25 * 25) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_ws, -1);
	__ocl_buffer_square =
	    oclCreateBuffer(square, (25 * 25 * 25) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_square, -1);
	__ocl_buffer_qs = oclCreateBuffer(qs, (25 * 25 * 25) * sizeof(double));
