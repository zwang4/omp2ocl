...
#pragma omp2ocl local(grid_points)
...
static double forcing[5+1][IMAX/2*2+1][JMAX/2*2+1][KMAX/2*2+1];
static double u[5][(IMAX+1)/2*2+1][(JMAX+1)/2*2+1][(KMAX+1)/2*2+1];
static double rhs[5][IMAX/2*2+1][JMAX/2*2+1][KMAX/2*2+1];
static double lhs[3][5][5][IMAX/2*2+1][JMAX/2*2+1][KMAX/2*2+1];
...
static double fjac[5][5][IMAX/2*2+1][JMAX/2*2+1][KMAX-1+1];
/* fjac(5, 5, 0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX-1) */
static double njac[5][5][IMAX/2*2+1][JMAX/2*2+1][KMAX-1+1];
