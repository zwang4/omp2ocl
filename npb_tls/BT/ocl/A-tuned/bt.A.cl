//-------------------------------------------------------------------------------
//OpenCL Kernels 
//Generated at : Sun Aug 19 18:53:36 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
void matvec_sub_g0_g5_g9_spec(__global double (*ablock)[5][5][65][65][65],
...
void binvcrhs_g0_g5_g10_spec(__global double (*lhs)[5][5][65][65][65], int lhs_0,
...
void binvrhs_g0_g5_spec(__global double (*lhs)[5][5][65][65][65], int lhs_0,
		   int lhs_1, int lhs_2, int lhs_3,
		   __global double (*r)[65][65][65], int r_0, int r_1, int r_2,
...
void matmul_sub_g0_g5_g10_spec(__global double (*ablock)[5][5][65][65][65],
			  int ablock_0, int ablock_1, int ablock_2,
			  int ablock_3,
			  __global double (*bblock)[5][5][65][65][65],
			  int bblock_0, int bblock_1, int bblock_2,
...
//-------------------------------------------------------------------------------
//Loop defined at line 228 of bt.c
		    ...
		    int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	int m;			/* (User-defined privated variables) : Defined at bt.c : 224 */
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 351 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			  ...
			  int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	int m;			/* (User-defined privated variables) : Defined at bt.c : 344 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 367 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			  ...
			  int __ocl_j_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	double eta;		/* (User-defined privated variables) : Defined at bt.c : 343 */
	double zeta;		/* (User-defined privated variables) : Defined at bt.c : 343 */
	int i;			/* (User-defined privated variables) : Defined at bt.c : 344 */
	double xi;		/* (User-defined privated variables) : Defined at bt.c : 343 */
	double dtemp[5];	/* (User-defined privated variables) : Defined at bt.c : 343 */
	int m;			/* (User-defined privated variables) : Defined at bt.c : 344 */
	double ue[5][64];	/* threadprivate: defined at ./header.h : 74 */
	double dtpp;		/* (User-defined privated variables) : Defined at bt.c : 343 */
	...
	int im1;		/* (User-defined privated variables) : Defined at bt.c : 344 */
	int ip1;		/* (User-defined privated variables) : Defined at bt.c : 344 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 467 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			  ...
			  int __ocl_i_bound)
{
	...
	double xi;		/* (User-defined privated variables) : Defined at bt.c : 343 */
	double zeta;		/* (User-defined privated variables) : Defined at bt.c : 343 */
	int j;			/* (User-defined privated variables) : Defined at bt.c : 344 */
	double eta;		/* (User-defined privated variables) : Defined at bt.c : 343 */
	double dtemp[5];	/* (User-defined privated variables) : Defined at bt.c : 343 */
	int m;			/* (User-defined privated variables) : Defined at bt.c : 344 */
	double ue[5][64];	/* threadprivate: defined at ./header.h : 74 */
	...
	double cuf[64];		/* threadprivate: defined at ./header.h : 72 */
	double q[64];		/* threadprivate: defined at ./header.h : 73 */
	int jm1;		/* (User-defined privated variables) : Defined at bt.c : 344 */
	int jp1;		/* (User-defined privated variables) : Defined at bt.c : 344 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 569 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			  ...
			  int __ocl_i_bound)
{
	...
	double xi;		/* (User-defined privated variables) : Defined at bt.c : 343 */
	double eta;		/* (User-defined privated variables) : Defined at bt.c : 343 */
	int k;			/* (User-defined privated variables) : Defined at bt.c : 344 */
	double zeta;		/* (User-defined privated variables) : Defined at bt.c : 343 */
	double dtemp[5];	/* (User-defined privated variables) : Defined at bt.c : 343 */
	int m;			/* (User-defined privated variables) : Defined at bt.c : 344 */
	double ue[5][64];	/* threadprivate: defined at ./header.h : 74 */
	...
	double cuf[64];		/* threadprivate: defined at ./header.h : 72 */
	double q[64];		/* threadprivate: defined at ./header.h : 73 */
	int km1;		/* (User-defined privated variables) : Defined at bt.c : 344 */
	int kp1;		/* (User-defined privated variables) : Defined at bt.c : 344 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 669 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 731 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
__kernel void initialize_0(__global double *g_u)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	int m;			/* (User-defined privated variables) : Defined at bt.c : 720 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 748 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			   ...
			   int __ocl_i_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	double eta;		/* (User-defined privated variables) : Defined at bt.c : 721 */
	double xi;		/* (User-defined privated variables) : Defined at bt.c : 721 */
	double zeta;		/* (User-defined privated variables) : Defined at bt.c : 721 */
	int ix;			/* (User-defined privated variables) : Defined at bt.c : 720 */
	double Pface[2][3][5];	/* (User-defined privated variables) : Defined at bt.c : 721 */
	int iy;			/* (User-defined privated variables) : Defined at bt.c : 720 */
	int iz;			/* (User-defined privated variables) : Defined at bt.c : 720 */
	int m;			/* (User-defined privated variables) : Defined at bt.c : 720 */
	double Pxi;		/* (User-defined privated variables) : Defined at bt.c : 721 */
	double Peta;		/* (User-defined privated variables) : Defined at bt.c : 721 */
	double Pzeta;		/* (User-defined privated variables) : Defined at bt.c : 721 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 798 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			   ...
			   int __ocl_k_bound, int __ocl_j_bound)
{
	...
	double eta;		/* (User-defined privated variables) : Defined at bt.c : 721 */
	double zeta;		/* (User-defined privated variables) : Defined at bt.c : 721 */
	double temp[5];		/* (User-defined privated variables) : Defined at bt.c : 721 */
	int m;			/* (User-defined privated variables) : Defined at bt.c : 720 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 818 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 837 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 856 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 875 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 894 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 922 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			...
			int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	int m;			/* (User-defined privated variables) : Defined at bt.c : 912 */
	int n;			/* (User-defined privated variables) : Defined at bt.c : 912 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 942 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 973 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
		     ...
		     int __ocl_j_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	int i;			/* (User-defined privated variables) : Defined at bt.c : 966 */
	...
	//-------------------------------------------
	{
		for (i = 0; i < grid_points[0]; i++) {
			//-------------------------------------------
			//Declare prefetching Buffers (BEGIN) : 975
			//-------------------------------------------
			double u_0[4];
			//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 1259 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
		     ...
		     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	{
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 1261
		//-------------------------------------------
		double u_1[3];
		//-------------------------------------------
		//Declare prefetching buffers (END)
...
//-------------------------------------------------------------------------------
//Loop defined at line 1363 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 1557 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	{
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 1559
		//-------------------------------------------
		double u_2[3];
		//-------------------------------------------
		//Declare prefetching buffers (END)
...
//-------------------------------------------------------------------------------
//Loop defined at line 1661 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
		     ...
		     int __ocl_k_bound, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	{
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 1663
		//-------------------------------------------
		double2 njac_0[2];
		//-------------------------------------------
		//Declare prefetching buffers (END)
...
//-------------------------------------------------------------------------------
//Loop defined at line 1848 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			    ...
			    int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	double rho_inv;		/* (User-defined privated variables) : Defined at bt.c : 1840 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
	...
	{
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 1850
		//-------------------------------------------
		double u_3[2];
		//-------------------------------------------
		//Declare prefetching buffers (END)
...
//-------------------------------------------------------------------------------
//Loop defined at line 1873 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			    ...
			    int __ocl_i_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	int m;			/* (User-defined privated variables) : Defined at bt.c : 1839 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 1889 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			    ...
			    int __ocl_i_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	double uijk;		/* (User-defined privated variables) : Defined at bt.c : 1840 */
	double up1;		/* (User-defined privated variables) : Defined at bt.c : 1840 */
	double um1;		/* (User-defined privated variables) : Defined at bt.c : 1840 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
	...
	{
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 1891
		//-------------------------------------------
		double u_4[8];
		double square_0;
		//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 1952 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 1966 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 1979 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 1996 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2010 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2026 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			    ...
			    int __ocl_i_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	double vijk;		/* (User-defined privated variables) : Defined at bt.c : 1840 */
	double vp1;		/* (User-defined privated variables) : Defined at bt.c : 1840 */
	double vm1;		/* (User-defined privated variables) : Defined at bt.c : 1840 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2084 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2098 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2111 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2128 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2142 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2158 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     int __ocl_i_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	double wijk;		/* (User-defined privated variables) : Defined at bt.c : 1840 */
	double wp1;		/* (User-defined privated variables) : Defined at bt.c : 1840 */
	double wm1;		/* (User-defined privated variables) : Defined at bt.c : 1840 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
	...
	{
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 2160
		//-------------------------------------------
		double2 ws_0;
		double2 u_6[4];
		double u_7[3];
...
//-------------------------------------------------------------------------------
//Loop defined at line 2223 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     int __ocl_i_bound)
{
	...
	{
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 2225
		//-------------------------------------------
		double2 u_8;
		//-------------------------------------------
		//Declare prefetching buffers (END)
		//-------------------------------------------
		//-------------------------------------------
		//Prefetching (BEGIN) : 2225
		//Candidates:
		//      u[m][i][j][k]
		//      u[m][i][j][k + 1]
		//-------------------------------------------
		__global double *p_u_8_0 = (__global double *)&u[m][i][j][k];
		if ((unsigned long)p_u_8_0 % 64 == 0) {
			u_8 = vload2(0, p_u_8_0);
		} else {
			u_8.x = p_u_8_0[0];
			p_u_8_0++;
			u_8.y = p_u_8_0[0];
		...
		rhs[m][i][j][k] =
		    rhs[m][i][j][k] - dssp * (5.0 * u_8.x /*u[m][i][j][k] */  -
					      4.0 *
					      u_8.y /*u[m][i][j][k + 1] */  +
					      u[m][i][j][k + 2]);
	}
...
//-------------------------------------------------------------------------------
//Loop defined at line 2243 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     int __ocl_i_bound)
{
	...
	{
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 2245
		//-------------------------------------------
		double4 u_9;
		//-------------------------------------------
		//Declare prefetching buffers (END)
		...
		rhs[m][i][j][k] =
		    rhs[m][i][j][k] -
		    dssp * (-4.0 * u_9.x /*u[m][i][j][k - 1] */  +
			    6.0 * u_9.y /*u[m][i][j][k] */  -
			    4.0 * u_9.z /*u[m][i][j][k + 1] */  +
			    u_9.w /*u[m][i][j][k + 2] */ );
	}
	//-------------------------------------------
	//OpenCL kernel (END)
...
//-------------------------------------------------------------------------------
//Loop defined at line 2262 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	for (m = 0; m < 5; m++) {
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 2265
		//-------------------------------------------
		double4 u_10;
		//-------------------------------------------
		//Declare prefetching buffers (END)
		...
		rhs[m][i][j][k] =
		    rhs[m][i][j][k] - dssp * (u_10.x /*u[m][i][j][k - 2] */  -
					      4.0 *
					      u_10.y /*u[m][i][j][k - 1] */  +
					      6.0 * u_10.z /*u[m][i][j][k] */  -
					      4.0 *
					      u_10.w /*u[m][i][j][k + 1] */  +
					      u[m][i][j][k + 2]);
	}
...
//-------------------------------------------------------------------------------
//Loop defined at line 2286 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     int __ocl_i_bound)
{
	...
	{
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 2288
		//-------------------------------------------
		double4 u_11;
		//-------------------------------------------
		//Declare prefetching buffers (END)
		...
		rhs[m][i][j][k] =
		    rhs[m][i][j][k] - dssp * (u_11.x /*u[m][i][j][k - 2] */  -
					      4.0 *
					      u_11.y /*u[m][i][j][k - 1] */  +
					      6.0 * u_11.z /*u[m][i][j][k] */  -
					      4.0 *
					      u_11.w /*u[m][i][j][k + 1] */ );
	}
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2306 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     int __ocl_i_bound)
{
	...
	{
		//-------------------------------------------
		//Declare prefetching Buffers (BEGIN) : 2308
		//-------------------------------------------
		double2 u_12;
		//-------------------------------------------
		//Declare prefetching buffers (END)
		...
		rhs[m][i][j][k] =
		    rhs[m][i][j][k] - dssp * (u_12.x /*u[m][i][j][k - 2] */  -
					      4.0 *
					      u_12.y /*u[m][i][j][k - 1] */  +
					      5.0 * u[m][i][j][k]);
	}
...
//-------------------------------------------------------------------------------
//Loop defined at line 2330 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2856 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
				 ...
				 int __ocl_j_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	int n;			/* (User-defined privated variables) : Defined at bt.c : 2852 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 2894 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     __global int *tls_validflag)
{
	...
	{
#ifdef BINVCRHS_SPEC
		binvcrhs_g0_g5_g10_spec(lhs, 0, j, k, 1, lhs, 0, j, k, 2, rhs, 0, j,
...
//-------------------------------------------------------------------------------
//Loop defined at line 2915 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     __global int *tls_validflag)
{
	...
	{
#ifdef SPEC_MATVEC
		matvec_sub_g0_g5_g9_spec(lhs, i, j, k, 0, rhs, i - 1, j, k, rhs, i,
				    j, k, rd_log_rhs, wr_log_rhs, tls_validflag,
				    tls_thread_id);
		matmul_sub_g0_g5_g10_spec(lhs, i, j, k, 0, lhs, i - 1, j, k, 2, lhs,
				     i, j, k, 1);
#else
...
#ifdef SPEC_MATMUL
		matmul_sub_g0_g5_g10_spec(lhs, i, j, k, 0, lhs, i - 1, j, k, 2, lhs,
				     i, j, k, 1, rd_log_lhs, wr_log_lhs, tls_validflag,
				    tls_thread_id);
#else
		matmul_sub_g0_g5_g10(lhs, i, j, k, 0, lhs, i - 1, j, k, 2, lhs,
				     i, j, k, 1);
#endif
#ifdef BINVCRHS_SPEC
		binvcrhs_g0_g5_g10_spec(lhs, i, j, k, 1, lhs, i, j, k, 2, rhs, i, j,
				   k, rd_log_lhs, wr_log_lhs, rd_log_lhs,
				   wr_log_lhs, rd_log_rhs, wr_log_rhs,
				   tls_validflag, tls_thread_id);
#else
...
//-------------------------------------------------------------------------------
//Loop defined at line 2948 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     __global int *tls_validflag)
{
	...
	{
#ifdef MATVEC_SPEC
		matvec_sub_g0_g5_g9_spec(lhs, isize, j, k, 0, rhs, isize - 1, j, k,
...
#ifdef MATMUL_SPEC
		matmul_sub_g0_g5_g10_spec(lhs, isize, j, k, 0, lhs, isize - 1, j, k,
		...
		matmul_sub_g0_g5_g10(lhs, isize, j, k, 0, lhs, isize - 1, j, k,
				     2, lhs, isize, j, k, 1);
#endif
		binvrhs_g0_g5_spec(lhs, i, j, k, 1, rhs, i, j, k, rd_log_lhs,
...
//-------------------------------------------------------------------------------
//Loop defined at line 3500 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
				 ...
				 int __ocl_i_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	int n;			/* (User-defined privated variables) : Defined at bt.c : 3495 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 3538 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     __global int *tls_validflag)
{
	...
	{
#ifdef BINVCRHS_SPEC
		binvcrhs_g0_g5_g10_spec(lhs, i, 0, k, 1, lhs, i, 0, k, 2, rhs, i, 0,
				   k, rd_log_lhs, wr_log_lhs, rd_log_lhs,
				   wr_log_lhs, rd_log_rhs, wr_log_rhs,
				   tls_validflag, tls_thread_id);
#else
...
//-------------------------------------------------------------------------------
//Loop defined at line 3559 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     __global int *tls_validflag)
{
	...
	{
#ifdef MATVEC_SPEC
		matvec_sub_g0_g5_g9_spec(lhs, i, j, k, 0, rhs, i, j - 1, k, rhs, i,
				    j, k, rd_log_rhs, wr_log_rhs, tls_validflag,
				    tls_thread_id);
#else
...
#endif
#ifdef MATMUL_SPEC
		matmul_sub_g0_g5_g10_spec(lhs, i, j, k, 0, lhs, i, j - 1, k, 2, lhs,
...
//-------------------------------------------------------------------------------
//Loop defined at line 3592 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     __global int *tls_validflag)
{
	...
	*/
#ifdef MATVEC_SPEC
		matvec_sub_g0_g5_g9_spec(lhs, i, jsize, k, 0, rhs, i, jsize - 1, k,
...
#endif
#ifdef MATMUL_SPEC
		matmul_sub_g0_g5_g10_spec(lhs, i, jsize, k, 0, lhs, i, jsize - 1, k,
		...
		matmul_sub_g0_g5_g10(lhs, i, jsize, k, 0, lhs, i, jsize - 1, k,
				     2, lhs, i, jsize, k, 1);
#endif
		binvrhs_g0_g5_spec(lhs, i, jsize, k, 1, rhs, i, jsize, k, rd_log_lhs,
			      wr_log_lhs, rd_log_rhs, wr_log_rhs, tls_validflag,
			      tls_thread_id);
	}
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 3680 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
				 ...
				 int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Pivate variables (BEGIN)
	//-------------------------------------------
	int k;			/* (User-defined privated variables) : Defined at bt.c : 3676 */
	int m;			/* (User-defined privated variables) : Defined at bt.c : 3676 */
	int n;			/* (User-defined privated variables) : Defined at bt.c : 3676 */
	//-------------------------------------------
	//Pivate variables (END)
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 3733 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     __global int *tls_validflag)
{
	...
	//-------------------------------------------
	{
	//	binvcrhs_g0_g5_g10(lhs, i, 0, j, 1, lhs, i, 0, j, 2, rhs, i, 0,
	//			   j);
	
	
		binvcrhs_g0_g5_g10_spec(lhs, i, 0, j, 1, lhs, i, 0, j, 2, rhs, i, 0,
				   j,
				   rd_log_lhs, wr_log_lhs, rd_log_lhs,
				   wr_log_lhs, rd_log_rhs, wr_log_rhs,
				   tls_validflag, tls_thread_id);
...
//-------------------------------------------------------------------------------
//Loop defined at line 3769 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     __global int *tls_validflag)
{
	...
	//-------------------------------------------
	{
		//matvec_sub_g0_g5_g9(lhs, i, k, j, 0, rhs, i, k - 1, j, rhs, i,
		//		    k, j);
		//matmul_sub_g0_g5_g10(lhs, i, k, j, 0, lhs, i, k - 1, j, 2, lhs,
		//		     i, k, j, 1);
		//binvcrhs_g0_g5_g10(lhs, i, k, j, 1, lhs, i, k, j, 2, rhs, i, k,
		//		   j);
#ifdef MATVEC_SPEC
		matvec_sub_g0_g5_g9_spec(lhs, i, k, j, 0, rhs, i, k - 1, j, rhs, i,
				    k, j, rd_log_rhs, wr_log_rhs, tls_validflag,
				    tls_thread_id);
#else
		matvec_sub_g0_g5_g9(lhs, i, k, j, 0, rhs, i, k - 1, j, rhs, i,
				    k, j);
#endif
#ifdef MATMUL_SPEC
		matmul_sub_g0_g5_g10_spec(lhs, i, k, j, 0, lhs, i, k - 1, j, 2, lhs,
				     i, k, j, 1, rd_log_lhs, wr_log_lhs,
				     tls_validflag, tls_thread_id);
#else
		matmul_sub_g0_g5_g10(lhs, i, k, j, 0, lhs, i, k - 1, j, 2, lhs,
				     i, k, j, 1);
#endif
		binvcrhs_g0_g5_g10_spec(lhs, i, k, j, 1, lhs, i, k, j, 2, rhs, i, k,
				   j, rd_log_lhs, wr_log_lhs, rd_log_lhs,
				   wr_log_lhs, rd_log_rhs, wr_log_rhs,
				   tls_validflag, tls_thread_id);
	}
	//-------------------------------------------
...
//-------------------------------------------------------------------------------
//Loop defined at line 3837 of bt.c
//The nested loops were swaped. 
//-------------------------------------------------------------------------------
			     ...
			     __global int *tls_validflag)
{
	...
	//-------------------------------------------
	{
		//matvec_sub_g0_g5_g9(lhs, i, ksize, j, 0, rhs, i, ksize - 1, j,
		//		    rhs, i, ksize, j);
		//matmul_sub_g0_g5_g10(lhs, i, ksize, j, 0, lhs, i, ksize - 1, j,
		//		     2, lhs, i, ksize, j, 1);
		//binvrhs_g0_g5(lhs, i, ksize, j, 1, rhs, i, ksize, j);

#ifdef MATVEC_SPEC	
		matvec_sub_g0_g5_g9_spec(lhs, i, ksize, j, 0, rhs, i, ksize - 1, j,
				    rhs, i, ksize, j, rd_log_lhs,
			      wr_log_lhs, tls_validflag,
			      tls_thread_id);
#else
		matvec_sub_g0_g5_g9(lhs, i, ksize, j, 0, rhs, i, ksize - 1, j,
				    rhs, i, ksize, j);
...
#ifdef MATMUL_SPEC	
		matmul_sub_g0_g5_g10_spec(lhs, i, ksize, j, 0, lhs, i, ksize - 1, j,
				     2, lhs, i, ksize, j, 1, rd_log_lhs,
			      wr_log_lhs, tls_validflag,
			      tls_thread_id);
#else
		matmul_sub_g0_g5_g10(lhs, i, ksize, j, 0, lhs, i, ksize - 1, j,
		...
		binvrhs_g0_g5_spec(lhs, i, ksize, j, 1, rhs, i, ksize, j, rd_log_lhs,
			      wr_log_lhs, rd_log_rhs, wr_log_rhs, tls_validflag,
			      tls_thread_id);
