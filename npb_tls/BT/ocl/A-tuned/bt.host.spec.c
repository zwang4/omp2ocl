//-------------------------------------------------------------------------------
//Host code 
//Generated at : Mon Sep 23 11:11:24 2013
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
{
	{
		...
		c_print_results("BT", class, grid_points[0], grid_points[1],
				...
				"17 Aug 2013", "gcc -fopenmp", "gcc -fopenmp",
				"-lm", "-I../common", "-O3 ", "(none)",
				"(none)");
	}
}
...
static void exact_rhs()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_exact_rhs_0, 3, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_exact_rhs_0, 4,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_exact_rhs_1, 21, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_exact_rhs_1, 22,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_exact_rhs_2, 21, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_exact_rhs_2, 22,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_exact_rhs_3, 21, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_exact_rhs_3, 22,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_exact_rhs_4, 3, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_exact_rhs_4, 4,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void initialize()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_initialize_0, 1,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_initialize_1, 7, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_initialize_1, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_initialize_2, 7, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_initialize_2, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_initialize_3, 7, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_initialize_3, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_initialize_4, 7, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_initialize_4, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_initialize_5, 7, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_initialize_5, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_initialize_6, 7, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_initialize_6, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_initialize_7, 7, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_initialize_7, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void lhsinit()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsinit_0, 3, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsinit_0, 4,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsinit_1, 3, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsinit_1, 4,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void lhsx()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsx_0, 20,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void lhsy()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsy_0, 11,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsy_1, 14,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void lhsz()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsz_0, 13,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsz_1, 14,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void compute_rhs()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_0, 9, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_0, 10,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void x_backsubstitute()
{
	...
	for (i = grid_points[0] - 2; i >= 0; i--) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArgBuffer(__ocl_x_backsubstitute_0, 5,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
...
static void x_solve_cell()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_x_solve_cell_0, 3, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_x_solve_cell_0, 4, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_x_solve_cell_0, 5, wr_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_x_solve_cell_0, 6, rd_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_x_solve_cell_0, 7, wr_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_x_solve_cell_0, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	for (i = 1; i < isize; i++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_x_solve_cell_1, 4, sizeof(int),
					&__ocl_j_bound);
			oclSetKernelArgBuffer(__ocl_x_solve_cell_1, 5,
					      rd_oclb_lhs);
			oclSetKernelArgBuffer(__ocl_x_solve_cell_1, 6,
					      wr_oclb_lhs);
			oclSetKernelArgBuffer(__ocl_x_solve_cell_1, 7,
					      rd_oclb_rhs);
			oclSetKernelArgBuffer(__ocl_x_solve_cell_1, 8,
					      wr_oclb_rhs);
			oclSetKernelArgBuffer(__ocl_x_solve_cell_1, 9,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_x_solve_cell_2, 5, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_x_solve_cell_2, 6, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_x_solve_cell_2, 7, wr_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_x_solve_cell_2, 8, rd_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_x_solve_cell_2, 9, wr_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_x_solve_cell_2, 10,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void y_backsubstitute()
{
	...
	for (j = grid_points[1] - 2; j >= 0; j--) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArgBuffer(__ocl_y_backsubstitute_0, 5,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
...
static void y_solve_cell()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_y_solve_cell_0, 3, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_y_solve_cell_0, 4, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_y_solve_cell_0, 5, wr_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_y_solve_cell_0, 6, rd_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_y_solve_cell_0, 7, wr_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_y_solve_cell_0, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	for (j = 1; j < jsize; j++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_y_solve_cell_1, 4, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_y_solve_cell_1, 5,
					      rd_oclb_lhs);
			oclSetKernelArgBuffer(__ocl_y_solve_cell_1, 6,
					      wr_oclb_lhs);
			oclSetKernelArgBuffer(__ocl_y_solve_cell_1, 7,
					      rd_oclb_rhs);
			oclSetKernelArgBuffer(__ocl_y_solve_cell_1, 8,
					      wr_oclb_rhs);
			oclSetKernelArgBuffer(__ocl_y_solve_cell_1, 9,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_y_solve_cell_2, 4, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_y_solve_cell_2, 5, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_y_solve_cell_2, 6, wr_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_y_solve_cell_2, 7, rd_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_y_solve_cell_2, 8, wr_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_y_solve_cell_2, 9,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void z_backsubstitute()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_z_backsubstitute_0, 4, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_z_backsubstitute_0, 5,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void z_solve_cell()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_z_solve_cell_0, 3, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_z_solve_cell_0, 4, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_z_solve_cell_0, 5, wr_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_z_solve_cell_0, 6, rd_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_z_solve_cell_0, 7, wr_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_z_solve_cell_0, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	for (k = 1; k < ksize; k++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_z_solve_cell_1, 4, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_z_solve_cell_1, 5,
					      rd_oclb_lhs);
			oclSetKernelArgBuffer(__ocl_z_solve_cell_1, 6,
					      wr_oclb_lhs);
			oclSetKernelArgBuffer(__ocl_z_solve_cell_1, 7,
					      rd_oclb_rhs);
			oclSetKernelArgBuffer(__ocl_z_solve_cell_1, 8,
					      wr_oclb_rhs);
			oclSetKernelArgBuffer(__ocl_z_solve_cell_1, 9,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_z_solve_cell_2, 4, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_z_solve_cell_2, 5, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_z_solve_cell_2, 6, wr_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_z_solve_cell_2, 7, rd_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_z_solve_cell_2, 8, wr_oclb_rhs);
		oclSetKernelArgBuffer(__ocl_z_solve_cell_2, 9,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void create_ocl_buffers()
{
	...
	rd_oclb_forcing =
	    oclCreateBuffer(rd_log_forcing, (6 * 65 * 65 * 65) * sizeof(int));
	wr_oclb_forcing =
	    oclCreateBuffer(wr_log_forcing, (6 * 65 * 65 * 65) * sizeof(int));
	oclHostWrites(rd_oclb_forcing);
	oclHostWrites(wr_oclb_forcing);
	DYN_BUFFER_CHECK(rd_oclb_forcing, -1);
	DYN_BUFFER_CHECK(wr_oclb_forcing, -1);
	...
	rd_oclb_lhs =
	    oclCreateBuffer(rd_log_lhs,
			    (3 * 5 * 5 * 65 * 65 * 65) * sizeof(int));
	wr_oclb_lhs =
	    oclCreateBuffer(wr_log_lhs,
			    (3 * 5 * 5 * 65 * 65 * 65) * sizeof(int));
	...
	rd_oclb_fjac =
	    oclCreateBuffer(rd_log_fjac, (5 * 5 * 65 * 65 * 64) * sizeof(int));
	wr_oclb_fjac =
	    oclCreateBuffer(wr_log_fjac, (5 * 5 * 65 * 65 * 64) * sizeof(int));
	oclHostWrites(rd_oclb_fjac);
	oclHostWrites(wr_oclb_fjac);
	DYN_BUFFER_CHECK(rd_oclb_fjac, -1);
	DYN_BUFFER_CHECK(wr_oclb_fjac, -1);
	rd_oclb_njac =
	    oclCreateBuffer(rd_log_njac, (5 * 5 * 65 * 65 * 64) * sizeof(int));
	wr_oclb_njac =
	    oclCreateBuffer(wr_log_njac, (5 * 5 * 65 * 65 * 64) * sizeof(int));
	oclHostWrites(rd_oclb_njac);
	oclHostWrites(wr_oclb_njac);
	DYN_BUFFER_CHECK(rd_oclb_njac, -1);
	DYN_BUFFER_CHECK(wr_oclb_njac, -1);
	rd_oclb_rhs =
...
//Checking lhs
		{
			size_t __ocl_gws_lhs = (65 * 65 * 65 * 5 * 5 * 3);
