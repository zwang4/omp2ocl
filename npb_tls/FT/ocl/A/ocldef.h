...
#define DECLARE_LOCALVAR_OCL_BUFFER(__variable_name__,__type__,__size__) \
	...
	ocl_buffer * rd##__ocl_buffer_##__variable_name__ = NULL;\
	ocl_buffer * wr##__ocl_buffer_##__variable_name__ = NULL;\
	static __type__ rd##__variable_name__[__size__];\
	static __type__ wr##__variable_name__[__size__];\
	__ocl_buffer_##__variable_name__ = oclCreateBuffer(__variable_name__, sizeof(__type__)*__size__);\
	rd##__ocl_buffer_##__variable_name__ = oclCreateBuffer(rd##__variable_name__, sizeof(__type__)*__size__);\
	wr##__ocl_buffer_##__variable_name__ = oclCreateBuffer(wr##__variable_name__, sizeof(__type__)*__size__);\
	DYN_BUFFER_CHECK(__ocl_buffer_##__variable_name__,-1);\
	DYN_BUFFER_CHECK(rd##__ocl_buffer_##__variable_name__,-1);\
	DYN_BUFFER_CHECK(wr##__ocl_buffer_##__variable_name__,-1);\
	{\
		__oclLVarBufferList_t* p = malloc(sizeof(__oclLVarBufferList_t));\
			DYN_BUFFER_CHECK(p,__LINE__);\
...
#define CREATE_THREAD_PRIVATE_BUF(__buf__,__ocl_buf__,__type__,__size__,__align_size__) \
        static ocl_buffer* rd##__ocl_buf__;\
        static ocl_buffer* wr##__ocl_buf__;\
        static __type__* rd##__buf__;\
        static __type__* wr##__buf__; {\
	...
	if (__buf__##_length < buf_size) {\
	                ...
	                posix_memalign((void **)\
			                ...
			                rd##__ocl_buf__ = __ocl_buf__;\
			                wr##__ocl_buf__ = __ocl_buf__;\
				                DYN_BUFFER_CHECK(__buf__, __LINE__);\
...
//---------------------------------------------------------------------------
static int rd_log_u_real[256];
static int wr_log_u_real[256];
static int tls_clear_u_real = 1;
static int rd_log_u_imag[256];
static int wr_log_u_imag[256];
static int tls_clear_u_imag = 1;
static int gpu_tls_conflict_flag = 0;
static ocl_buffer *rd_oclb_u_real;
static ocl_buffer *wr_oclb_u_real;
static ocl_buffer *rd_oclb_u_imag;
static ocl_buffer *wr_oclb_u_imag;
