			...
			__global int *tls_validflag)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*lhs)[65][65][65] =
	    (__global double (*)[65][65][65])g_lhs;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     __global int *tls_validflag)
{
	...
	__global double (*lhs)[65][65][65] =
	    (__global double (*)[65][65][65])g_lhs;
	__global double (*speed)[65][65] = (__global double (*)[65][65])g_speed;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
			    ...
			    int __ocl_i_bound, __global int *tls_validflag)
{
	...
	__global double (*speed)[65][65] = (__global double (*)[65][65])g_speed;
	__global double (*ainv)[65][65] = (__global double (*)[65][65])g_ainv;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
