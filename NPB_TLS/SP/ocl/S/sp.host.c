//-------------------------------------------------------------------------------
//Host code 
//Generated at : Thu Oct 25 14:32:05 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
{
	__ocl_buffer_u =
	    oclCreateBuffer(u, (5 * 13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_u, -1);
	__ocl_buffer_rhs =
	    oclCreateBuffer(rhs, (5 * 13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_rhs, -1);
	__ocl_buffer_lhs =
	    oclCreateBuffer(lhs, (15 * 13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_lhs, -1);
	__ocl_buffer_speed =
	    oclCreateBuffer(speed, (13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_speed, -1);
	__ocl_buffer_rho_i =
	    oclCreateBuffer(rho_i, (13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_rho_i, -1);
	__ocl_buffer_us = oclCreateBuffer(us, (13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_us, -1);
	__ocl_buffer_vs = oclCreateBuffer(vs, (13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_vs, -1);
	__ocl_buffer_ws = oclCreateBuffer(ws, (13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_ws, -1);
	__ocl_buffer_square =
	    oclCreateBuffer(square, (13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_square, -1);
	__ocl_buffer_qs = oclCreateBuffer(qs, (13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_qs, -1);
	__ocl_buffer_ainv =
	    oclCreateBuffer(ainv, (13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_ainv, -1);
	__ocl_buffer_grid_points =
	    oclCreateBuffer(grid_points, (3) * sizeof(int));
	DYN_BUFFER_CHECK(__ocl_buffer_grid_points, -1);
	__ocl_buffer_forcing =
	    oclCreateBuffer(forcing, (5 * 13 * 13 * 13) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_forcing, -1);

	//------------------------------------------
	// GPU TLS wr/rd buffers (BEGIN)
	//------------------------------------------
	rd_oclb_u = oclCreateBuffer(rd_log_u, (5 * 13 * 13 * 13) * sizeof(int));
	wr_oclb_u = oclCreateBuffer(wr_log_u, (5 * 13 * 13 * 13) * sizeof(int));
	oclHostWrites(rd_oclb_u);
	oclHostWrites(wr_oclb_u);
	DYN_BUFFER_CHECK(rd_oclb_u, -1);
	DYN_BUFFER_CHECK(wr_oclb_u, -1);
	rd_oclb_lhs =
	    oclCreateBuffer(rd_log_lhs, (15 * 13 * 13 * 13) * sizeof(int));
	wr_oclb_lhs =
	    oclCreateBuffer(wr_log_lhs, (15 * 13 * 13 * 13) * sizeof(int));
	oclHostWrites(rd_oclb_lhs);
	oclHostWrites(wr_oclb_lhs);
	DYN_BUFFER_CHECK(rd_oclb_lhs, -1);
	DYN_BUFFER_CHECK(wr_oclb_lhs, -1);
	rd_oclb_rhs =
	    oclCreateBuffer(rd_log_rhs, (5 * 13 * 13 * 13) * sizeof(int));
	wr_oclb_rhs =
	    oclCreateBuffer(wr_log_rhs, (5 * 13 * 13 * 13) * sizeof(int));
