//-------------------------------------------------------------------------------
//Host code 
//Generated at : Thu Oct 25 14:32:12 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
{
	{
		...
		if ((grid_points[0] > 36) || (grid_points[1] > 36)
		    || (grid_points[2] > 36)) {
			printf("%d, %d, %d\n", grid_points[0], grid_points[1],
			       grid_points[2]);
			printf
		...
		if (tmax != 0) {
			mflops =
			    (881.174 * pow((double)36, 3.0) -
			     4683.91 * (((double)36) * ((double)36)) +
			     11484.5 * (double)36 -
		...
		c_print_results("SP", class, grid_points[0], grid_points[1],
				...
				"25 Oct 2012", "gcc -fopenmp", "gcc -fopenmp",
				"-lm", "-I../common", "-O3 ", "(none)",
				"(none)");
	}
}
...
static void add()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_add_0, 5,
	...
	for (n = 0; n < 15; n++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_lhsinit_0, 4, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_lhsinit_0, 5,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
	...
	for (n = 0; n < 3; n++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_lhsinit_1, 4, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_lhsinit_1, 5,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
...
static void lhsx()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsx_0, 0, __ocl_buffer_lhs);
		oclSetKernelArg(__ocl_lhsx_0, 1, sizeof(int), &i);
		oclSetKernelArg(__ocl_lhsx_0, 2, sizeof(double), &comz5);
		oclSetKernelArg(__ocl_lhsx_0, 3, sizeof(double), &comz4);
		oclSetKernelArg(__ocl_lhsx_0, 4, sizeof(double), &comz1);
		oclSetKernelArg(__ocl_lhsx_0, 5, sizeof(double), &comz6);
		int __ocl_k_bound = grid_points[2] - 2;
		oclSetKernelArg(__ocl_lhsx_0, 6, sizeof(int), &__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 2;
		oclSetKernelArg(__ocl_lhsx_0, 7, sizeof(int), &__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_lhsx_0, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsx_1, 1, sizeof(double), &comz1);
		oclSetKernelArg(__ocl_lhsx_1, 2, sizeof(double), &comz4);
		oclSetKernelArg(__ocl_lhsx_1, 3, sizeof(double), &comz6);
		int __ocl_k_bound = grid_points[2] - 2;
		oclSetKernelArg(__ocl_lhsx_1, 4, sizeof(int), &__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 2;
		oclSetKernelArg(__ocl_lhsx_1, 5, sizeof(int), &__ocl_j_bound);
		int __ocl_i_bound = grid_points[0] - 4;
		oclSetKernelArg(__ocl_lhsx_1, 6, sizeof(int), &__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsx_1, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsx_2, 2, sizeof(double), &comz1);
		oclSetKernelArg(__ocl_lhsx_2, 3, sizeof(double), &comz4);
		oclSetKernelArg(__ocl_lhsx_2, 4, sizeof(double), &comz6);
		oclSetKernelArg(__ocl_lhsx_2, 5, sizeof(double), &comz5);
		int __ocl_k_bound = grid_points[2] - 2;
		oclSetKernelArg(__ocl_lhsx_2, 6, sizeof(int), &__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 2;
		oclSetKernelArg(__ocl_lhsx_2, 7, sizeof(int), &__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_lhsx_2, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsx_3, 1, sizeof(double), &dttx2);
		oclSetKernelArgBuffer(__ocl_lhsx_3, 2, __ocl_buffer_speed);
		int __ocl_k_bound = grid_points[2] - 2;
		oclSetKernelArg(__ocl_lhsx_3, 3, sizeof(int), &__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 2;
		oclSetKernelArg(__ocl_lhsx_3, 4, sizeof(int), &__ocl_j_bound);
		int __ocl_i_bound = grid_points[0] - 2;
		oclSetKernelArg(__ocl_lhsx_3, 5, sizeof(int), &__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsx_3, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void lhsy()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclGetWorkSize(2, _ocl_gws, NULL);
		oclSetKernelArgBuffer(__ocl_lhsy_0, 0, __ocl_buffer_lhs);
		oclSetKernelArg(__ocl_lhsy_0, 1, sizeof(int), &j);
		oclSetKernelArg(__ocl_lhsy_0, 2, sizeof(double), &comz5);
		oclSetKernelArg(__ocl_lhsy_0, 3, sizeof(double), &comz4);
		oclSetKernelArg(__ocl_lhsy_0, 4, sizeof(double), &comz1);
		oclSetKernelArg(__ocl_lhsy_0, 5, sizeof(double), &comz6);
		int __ocl_k_bound = grid_points[2] - 2;
		oclSetKernelArg(__ocl_lhsy_0, 6, sizeof(int), &__ocl_k_bound);
		int __ocl_i_bound = grid_points[0] - 2;
		oclSetKernelArg(__ocl_lhsy_0, 7, sizeof(int), &__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsy_0, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
		...
		oclRunKernel(__ocl_lhsy_0, 2, _ocl_gws);
#ifdef __STRICT_SYNC__
		oclSync();
#endif
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsy_1, 1, sizeof(double), &comz1);
		oclSetKernelArg(__ocl_lhsy_1, 2, sizeof(double), &comz4);
		oclSetKernelArg(__ocl_lhsy_1, 3, sizeof(double), &comz6);
		int __ocl_k_bound = grid_points[2] - 2;
		oclSetKernelArg(__ocl_lhsy_1, 4, sizeof(int), &__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 4;
		oclSetKernelArg(__ocl_lhsy_1, 5, sizeof(int), &__ocl_j_bound);
		int __ocl_i_bound = grid_points[0] - 2;
		oclSetKernelArg(__ocl_lhsy_1, 6, sizeof(int), &__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsy_1, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsy_2, 2, sizeof(double), &comz1);
		oclSetKernelArg(__ocl_lhsy_2, 3, sizeof(double), &comz4);
		oclSetKernelArg(__ocl_lhsy_2, 4, sizeof(double), &comz6);
		oclSetKernelArg(__ocl_lhsy_2, 5, sizeof(double), &comz5);
		int __ocl_k_bound = grid_points[2] - 2;
		oclSetKernelArg(__ocl_lhsy_2, 6, sizeof(int), &__ocl_k_bound);
		int __ocl_i_bound = grid_points[0] - 2;
		oclSetKernelArg(__ocl_lhsy_2, 7, sizeof(int), &__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsy_2, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsy_3, 1, sizeof(double), &dtty2);
		oclSetKernelArgBuffer(__ocl_lhsy_3, 2, __ocl_buffer_speed);
		int __ocl_k_bound = grid_points[2] - 2;
		oclSetKernelArg(__ocl_lhsy_3, 3, sizeof(int), &__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 2;
		oclSetKernelArg(__ocl_lhsy_3, 4, sizeof(int), &__ocl_j_bound);
		int __ocl_i_bound = grid_points[0] - 2;
		oclSetKernelArg(__ocl_lhsy_3, 5, sizeof(int), &__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsy_3, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void lhsz()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclGetWorkSize(2, _ocl_gws, NULL);
		oclSetKernelArgBuffer(__ocl_lhsz_0, 0, __ocl_buffer_lhs);
		oclSetKernelArg(__ocl_lhsz_0, 1, sizeof(int), &k);
		oclSetKernelArg(__ocl_lhsz_0, 2, sizeof(double), &comz5);
		oclSetKernelArg(__ocl_lhsz_0, 3, sizeof(double), &comz4);
		oclSetKernelArg(__ocl_lhsz_0, 4, sizeof(double), &comz1);
		oclSetKernelArg(__ocl_lhsz_0, 5, sizeof(double), &comz6);
		int __ocl_j_bound = grid_points[1] - 2;
		oclSetKernelArg(__ocl_lhsz_0, 6, sizeof(int), &__ocl_j_bound);
		int __ocl_i_bound = grid_points[0] - 2;
		oclSetKernelArg(__ocl_lhsz_0, 7, sizeof(int), &__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsz_0, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
		...
		oclRunKernel(__ocl_lhsz_0, 2, _ocl_gws);
#ifdef __STRICT_SYNC__
		oclSync();
#endif
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsz_1, 1, sizeof(double), &comz1);
		oclSetKernelArg(__ocl_lhsz_1, 2, sizeof(double), &comz4);
		oclSetKernelArg(__ocl_lhsz_1, 3, sizeof(double), &comz6);
		int __ocl_k_bound = grid_points[2] - 4;
		oclSetKernelArg(__ocl_lhsz_1, 4, sizeof(int), &__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 2;
		oclSetKernelArg(__ocl_lhsz_1, 5, sizeof(int), &__ocl_j_bound);
		int __ocl_i_bound = grid_points[0] - 2;
		oclSetKernelArg(__ocl_lhsz_1, 6, sizeof(int), &__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsz_1, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsz_2, 2, sizeof(double), &comz1);
		oclSetKernelArg(__ocl_lhsz_2, 3, sizeof(double), &comz4);
		oclSetKernelArg(__ocl_lhsz_2, 4, sizeof(double), &comz6);
		oclSetKernelArg(__ocl_lhsz_2, 5, sizeof(double), &comz5);
		int __ocl_j_bound = grid_points[1] - 2;
		oclSetKernelArg(__ocl_lhsz_2, 6, sizeof(int), &__ocl_j_bound);
		int __ocl_i_bound = grid_points[0] - 2;
		oclSetKernelArg(__ocl_lhsz_2, 7, sizeof(int), &__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsz_2, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_lhsz_3, 1, sizeof(double), &dttz2);
		oclSetKernelArgBuffer(__ocl_lhsz_3, 2, __ocl_buffer_speed);
		int __ocl_k_bound = grid_points[2] - 2;
		oclSetKernelArg(__ocl_lhsz_3, 3, sizeof(int), &__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 2;
		oclSetKernelArg(__ocl_lhsz_3, 4, sizeof(int), &__ocl_j_bound);
		int __ocl_i_bound = grid_points[0] - 2;
		oclSetKernelArg(__ocl_lhsz_3, 5, sizeof(int), &__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_lhsz_3, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void ninvr()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_ninvr_0, 5,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void pinvr()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_pinvr_0, 5,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void compute_rhs()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_0, 12, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_0, 13,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t _ocl_gws[3];
		_ocl_gws[0] = (grid_points[1] - 1) - (0) + 1;
		_ocl_gws[1] = (grid_points[0] - 1) - (0) + 1;
		_ocl_gws[2] = (5) - (0);

		oclGetWorkSize(3, _ocl_gws, NULL);
		oclSetKernelArgBuffer(__ocl_compute_rhs_1, 0,
				      __ocl_buffer_grid_points);
		oclSetKernelArgBuffer(__ocl_compute_rhs_1, 1, __ocl_buffer_rhs);
		oclSetKernelArgBuffer(__ocl_compute_rhs_1, 2,
		...
		oclSetKernelArg(__ocl_compute_rhs_1, 4, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_1, 5,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_2, 23, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_2, 24,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_3, 5, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_3, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_4, 5, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_4, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_5, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_5, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_6, 5, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_6, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_7, 5, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_7, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_8, 23, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_8, 24,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_9, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_9, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_10, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_10, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t _ocl_gws[3];
		_ocl_gws[0] = (grid_points[1] - 3 * 1 - 1) - (3 * 1) + 1;
		_ocl_gws[1] = (grid_points[0] - 2) - (1) + 1;
		_ocl_gws[2] = (5) - (0);
		...
		oclSetKernelArgBuffer(__ocl_compute_rhs_11, 0,
				      __ocl_buffer_grid_points);
		oclSetKernelArgBuffer(__ocl_compute_rhs_11, 1,
				      __ocl_buffer_rhs);
		oclSetKernelArg(__ocl_compute_rhs_11, 2, sizeof(double), &dssp);
		oclSetKernelArgBuffer(__ocl_compute_rhs_11, 3, __ocl_buffer_u);
		...
		oclSetKernelArg(__ocl_compute_rhs_11, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_11, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_12, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_12, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_13, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_13, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_14, 23, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_14, 24,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_15, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_15, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_16, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_16, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_compute_rhs_17, 0,
				      __ocl_buffer_grid_points);
		oclSetKernelArgBuffer(__ocl_compute_rhs_17, 1,
				      __ocl_buffer_rhs);
		oclSetKernelArg(__ocl_compute_rhs_17, 2, sizeof(double), &dssp);
		oclSetKernelArgBuffer(__ocl_compute_rhs_17, 3, __ocl_buffer_u);
		int __ocl_j_bound = grid_points[1] - 2;
		...
		oclSetKernelArg(__ocl_compute_rhs_17, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_17, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_18, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_18, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_compute_rhs_19, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_19, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_compute_rhs_20, 0,
				      __ocl_buffer_grid_points);
		oclSetKernelArgBuffer(__ocl_compute_rhs_20, 1,
				      __ocl_buffer_rhs);
		oclSetKernelArg(__ocl_compute_rhs_20, 2, sizeof(double), &dt);
		int __ocl_j_bound = grid_points[1] - 2;
		...
		oclSetKernelArg(__ocl_compute_rhs_20, 4, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_compute_rhs_20, 5,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void txinvr()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_txinvr_0, 12, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_txinvr_0, 13,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void tzetar()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_tzetar_0, 12, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_tzetar_0, 13,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void x_solve()
{
	...
	for (i = 0; i <= grid_points[0] - 3; i++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_x_solve_0, 7, sizeof(int),
					&__ocl_j_bound);
			oclSetKernelArgBuffer(__ocl_x_solve_0, 8,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_x_solve_1, 6, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_x_solve_1, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	for (m = 3; m < 5; m++) {
		...
		for (i = 0; i <= grid_points[0] - 3; i++) {
			...
			//--------------------------------------------------------------
			{
				...
				oclGetWorkSize(2, _ocl_gws, NULL);
				oclSetKernelArg(__ocl_x_solve_2, 0,
						sizeof(double), &fac1);
				oclSetKernelArgBuffer(__ocl_x_solve_2, 1,
						      __ocl_buffer_lhs);
				oclSetKernelArg(__ocl_x_solve_2, 2, sizeof(int),
						&n);
				oclSetKernelArg(__ocl_x_solve_2, 3, sizeof(int),
						&i);
				oclSetKernelArgBuffer(__ocl_x_solve_2, 4,
						      __ocl_buffer_rhs);
				...
				oclSetKernelArg(__ocl_x_solve_2, 8, sizeof(int),
						&__ocl_k_bound);
				int __ocl_j_bound = grid_points[1] - 2;
				oclSetKernelArg(__ocl_x_solve_2, 9, sizeof(int),
						&__ocl_j_bound);
				oclSetKernelArgBuffer(__ocl_x_solve_2, 10,
						      __oclb_gpu_tls_conflict_flag);
				//------------------------------------------
				//OpenCL kernel arguments (END) 
				//------------------------------------------
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_x_solve_3, 7, sizeof(int),
					&__ocl_j_bound);
			oclSetKernelArgBuffer(__ocl_x_solve_3, 8,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_x_solve_4, 6, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_x_solve_4, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_x_solve_5, 5, sizeof(int),
				&__ocl_j_bound);
		oclSetKernelArgBuffer(__ocl_x_solve_5, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	for (i = grid_points[0] - 3; i >= 0; i--) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_x_solve_6, 7, sizeof(int),
					&__ocl_j_bound);
			oclSetKernelArgBuffer(__ocl_x_solve_6, 8,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
		...
		for (i = grid_points[0] - 3; i >= 0; i--) {
			...
			//--------------------------------------------------------------
			{
				...
				oclSetKernelArg(__ocl_x_solve_7, 8, sizeof(int),
						&__ocl_j_bound);
				oclSetKernelArgBuffer(__ocl_x_solve_7, 9,
						      __oclb_gpu_tls_conflict_flag);
				//------------------------------------------
				//OpenCL kernel arguments (END) 
				//------------------------------------------
...
static void y_solve()
{
	...
	for (j = 0; j <= grid_points[1] - 3; j++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_y_solve_0, 7, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_y_solve_0, 8,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_y_solve_1, 6, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_y_solve_1, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	for (m = 3; m < 5; m++) {
		...
		for (j = 0; j <= grid_points[1] - 3; j++) {
			...
			//--------------------------------------------------------------
			{
				...
				oclSetKernelArg(__ocl_y_solve_2, 8, sizeof(int),
						&__ocl_i_bound);
				oclSetKernelArgBuffer(__ocl_y_solve_2, 9,
						      __oclb_gpu_tls_conflict_flag);
				//------------------------------------------
				//OpenCL kernel arguments (END) 
				//------------------------------------------
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_y_solve_3, 7, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_y_solve_3, 8,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_y_solve_4, 6, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_y_solve_4, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_y_solve_5, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_y_solve_5, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
		...
		for (j = grid_points[1] - 3; j >= 0; j--) {
			...
			//--------------------------------------------------------------
			{
				...
				oclSetKernelArg(__ocl_y_solve_6, 8, sizeof(int),
						&__ocl_i_bound);
				oclSetKernelArgBuffer(__ocl_y_solve_6, 9,
						      __oclb_gpu_tls_conflict_flag);
				//------------------------------------------
				//OpenCL kernel arguments (END) 
				//------------------------------------------
		...
		for (j = grid_points[1] - 3; j >= 0; j--) {
			...
			//--------------------------------------------------------------
			{
				...
				oclSetKernelArg(__ocl_y_solve_7, 8, sizeof(int),
						&__ocl_i_bound);
				oclSetKernelArgBuffer(__ocl_y_solve_7, 9,
						      __oclb_gpu_tls_conflict_flag);
				//------------------------------------------
				//OpenCL kernel arguments (END) 
				//------------------------------------------
...
static void z_solve()
{
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t _ocl_gws[3];
		_ocl_gws[0] = (grid_points[2] - 3) - (0) + 1;
		_ocl_gws[1] = (grid_points[1] - 2) - (1) + 1;
		_ocl_gws[2] = (grid_points[0] - 2) - (1) + 1;

		oclGetWorkSize(3, _ocl_gws, NULL);
		oclSetKernelArgBuffer(__ocl_z_solve_0, 0, __ocl_buffer_lhs);
		oclSetKernelArg(__ocl_z_solve_0, 1, sizeof(int), &n);
		oclSetKernelArgBuffer(__ocl_z_solve_0, 2, __ocl_buffer_rhs);
		int __ocl_k_bound = grid_points[2] - 3;
		oclSetKernelArg(__ocl_z_solve_0, 3, sizeof(int),
				&__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 2;
		...
		oclSetKernelArg(__ocl_z_solve_0, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_z_solve_0, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
		...
		oclRunKernel(__ocl_z_solve_0, 3, _ocl_gws);
#ifdef __STRICT_SYNC__
		oclSync();
#endif
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_z_solve_1, 6, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_z_solve_1, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_z_solve_2, 4,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
		...
		oclRunKernel(__ocl_z_solve_2, 1, _ocl_gws);
#ifdef __STRICT_SYNC__
		oclSync();
#endif
	}
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_z_solve_3, 6, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_z_solve_3, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArg(__ocl_z_solve_4, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_z_solve_4, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t _ocl_gws[3];
//This swaps a decremental loop
		_ocl_gws[0] = (grid_points[2] - 3) - (0) + 1;
		_ocl_gws[1] = (grid_points[1] - 2) - (1) + 1;
		_ocl_gws[2] = (grid_points[0] - 2) - (1) + 1;

		oclGetWorkSize(3, _ocl_gws, NULL);
		oclSetKernelArgBuffer(__ocl_z_solve_5, 0, __ocl_buffer_rhs);
		oclSetKernelArgBuffer(__ocl_z_solve_5, 1, __ocl_buffer_lhs);
		oclSetKernelArg(__ocl_z_solve_5, 2, sizeof(int), &n);
		int __ocl_k_bound = grid_points[2] - 3;
		oclSetKernelArg(__ocl_z_solve_5, 3, sizeof(int),
				&__ocl_k_bound);
		int __ocl_j_bound = grid_points[1] - 2;
		...
		oclSetKernelArg(__ocl_z_solve_5, 5, sizeof(int),
				&__ocl_i_bound);
		oclSetKernelArgBuffer(__ocl_z_solve_5, 6,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
		...
		oclRunKernel(__ocl_z_solve_5, 3, _ocl_gws);
#ifdef __STRICT_SYNC__
		oclSync();
#endif
	}
	...
	//--------------------------------------------------------------
	{
		...
		//------------------------------------------
		size_t _ocl_gws[3];
		_ocl_gws[0] = (grid_points[0] - 2) - (1) + 1;
		_ocl_gws[1] = (grid_points[1] - 2) - (1) + 1;
//This swaps a decremental loop
		_ocl_gws[2] = (grid_points[2] - 3) - (0) + 1;

		oclGetWorkSize(3, _ocl_gws, NULL);
		oclSetKernelArgBuffer(__ocl_z_solve_6, 0, __ocl_buffer_rhs);
		oclSetKernelArgBuffer(__ocl_z_solve_6, 1, __ocl_buffer_lhs);
		int __ocl_i_bound = grid_points[0] - 2;
		oclSetKernelArg(__ocl_z_solve_6, 2, sizeof(int),
				&__ocl_i_bound);
		int __ocl_j_bound = grid_points[1] - 2;
		...
		oclSetKernelArg(__ocl_z_solve_6, 4, sizeof(int),
				&__ocl_k_bound);
		oclSetKernelArgBuffer(__ocl_z_solve_6, 5,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
		...
		oclRunKernel(__ocl_z_solve_6, 3, _ocl_gws);
#ifdef __STRICT_SYNC__
		oclSync();
#endif
	}
...
static void init_ocl_runtime()
{
	...
	__ocl_program = oclBuildProgram("sp.cl");
...
{
	__ocl_buffer_u =
	    oclCreateBuffer(u, (5 * 37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_u, -1);
	__ocl_buffer_rhs =
	    oclCreateBuffer(rhs, (5 * 37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_rhs, -1);
	__ocl_buffer_lhs =
	    oclCreateBuffer(lhs, (15 * 37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_lhs, -1);
	__ocl_buffer_speed =
	    oclCreateBuffer(speed, (37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_speed, -1);
	__ocl_buffer_rho_i =
	    oclCreateBuffer(rho_i, (37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_rho_i, -1);
	__ocl_buffer_us = oclCreateBuffer(us, (37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_us, -1);
	__ocl_buffer_vs = oclCreateBuffer(vs, (37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_vs, -1);
	__ocl_buffer_ws = oclCreateBuffer(ws, (37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_ws, -1);
	__ocl_buffer_square =
	    oclCreateBuffer(square, (37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_square, -1);
	__ocl_buffer_qs = oclCreateBuffer(qs, (37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_qs, -1);
	__ocl_buffer_ainv =
	    oclCreateBuffer(ainv, (37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_ainv, -1);
	__ocl_buffer_grid_points =
	    oclCreateBuffer(grid_points, (3) * sizeof(int));
	DYN_BUFFER_CHECK(__ocl_buffer_grid_points, -1);
	__ocl_buffer_forcing =
	    oclCreateBuffer(forcing, (5 * 37 * 37 * 37) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_forcing, -1);

	//------------------------------------------
	// GPU TLS wr/rd buffers (BEGIN)
	//------------------------------------------
	rd_oclb_u = oclCreateBuffer(rd_log_u, (5 * 37 * 37 * 37) * sizeof(int));
	wr_oclb_u = oclCreateBuffer(wr_log_u, (5 * 37 * 37 * 37) * sizeof(int));
	oclHostWrites(rd_oclb_u);
	oclHostWrites(wr_oclb_u);
	DYN_BUFFER_CHECK(rd_oclb_u, -1);
	DYN_BUFFER_CHECK(wr_oclb_u, -1);
	rd_oclb_lhs =
	    oclCreateBuffer(rd_log_lhs, (15 * 37 * 37 * 37) * sizeof(int));
	wr_oclb_lhs =
	    oclCreateBuffer(wr_log_lhs, (15 * 37 * 37 * 37) * sizeof(int));
	oclHostWrites(rd_oclb_lhs);
	oclHostWrites(wr_oclb_lhs);
	DYN_BUFFER_CHECK(rd_oclb_lhs, -1);
	DYN_BUFFER_CHECK(wr_oclb_lhs, -1);
	rd_oclb_rhs =
	    oclCreateBuffer(rd_log_rhs, (5 * 37 * 37 * 37) * sizeof(int));
	wr_oclb_rhs =
	    oclCreateBuffer(wr_log_rhs, (5 * 37 * 37 * 37) * sizeof(int));
	oclHostWrites(rd_oclb_rhs);
	oclHostWrites(wr_oclb_rhs);
	DYN_BUFFER_CHECK(rd_oclb_rhs, -1);
	DYN_BUFFER_CHECK(wr_oclb_rhs, -1);
	__oclb_gpu_tls_conflict_flag =
...
{
	FILE *prof = fopen("profiling-sp", "w");
	...
	kernel += oclDumpKernelProfiling(__ocl_lhsx_1, prof);
	kernel += oclDumpKernelProfiling(__ocl_lhsx_2, prof);
	kernel += oclDumpKernelProfiling(__ocl_lhsx_3, prof);
	kernel += oclDumpKernelProfiling(__ocl_lhsy_0, prof);
	kernel += oclDumpKernelProfiling(__ocl_lhsy_1, prof);
	kernel += oclDumpKernelProfiling(__ocl_lhsy_2, prof);
	kernel += oclDumpKernelProfiling(__ocl_lhsy_3, prof);
	kernel += oclDumpKernelProfiling(__ocl_lhsz_0, prof);
	kernel += oclDumpKernelProfiling(__ocl_lhsz_1, prof);
	kernel += oclDumpKernelProfiling(__ocl_lhsz_2, prof);
	kernel += oclDumpKernelProfiling(__ocl_lhsz_3, prof);
	kernel += oclDumpKernelProfiling(__ocl_ninvr_0, prof);
	kernel += oclDumpKernelProfiling(__ocl_pinvr_0, prof);
	...
	kernel += oclDumpKernelProfiling(__ocl_txinvr_0, prof);
	kernel += oclDumpKernelProfiling(__ocl_tzetar_0, prof);
	kernel += oclDumpKernelProfiling(__ocl_x_solve_0, prof);
	kernel += oclDumpKernelProfiling(__ocl_x_solve_1, prof);
	kernel += oclDumpKernelProfiling(__ocl_x_solve_2, prof);
	kernel += oclDumpKernelProfiling(__ocl_x_solve_3, prof);
	kernel += oclDumpKernelProfiling(__ocl_x_solve_4, prof);
	kernel += oclDumpKernelProfiling(__ocl_x_solve_5, prof);
	kernel += oclDumpKernelProfiling(__ocl_x_solve_6, prof);
	kernel += oclDumpKernelProfiling(__ocl_x_solve_7, prof);
	kernel += oclDumpKernelProfiling(__ocl_y_solve_0, prof);
	kernel += oclDumpKernelProfiling(__ocl_y_solve_1, prof);
	kernel += oclDumpKernelProfiling(__ocl_y_solve_2, prof);
	kernel += oclDumpKernelProfiling(__ocl_y_solve_3, prof);
	kernel += oclDumpKernelProfiling(__ocl_y_solve_4, prof);
	kernel += oclDumpKernelProfiling(__ocl_y_solve_5, prof);
	kernel += oclDumpKernelProfiling(__ocl_y_solve_6, prof);
	kernel += oclDumpKernelProfiling(__ocl_y_solve_7, prof);
	kernel += oclDumpKernelProfiling(__ocl_z_solve_0, prof);
	kernel += oclDumpKernelProfiling(__ocl_z_solve_1, prof);
	kernel += oclDumpKernelProfiling(__ocl_z_solve_2, prof);
	kernel += oclDumpKernelProfiling(__ocl_z_solve_3, prof);
	kernel += oclDumpKernelProfiling(__ocl_z_solve_4, prof);
	kernel += oclDumpKernelProfiling(__ocl_z_solve_5, prof);
	kernel += oclDumpKernelProfiling(__ocl_z_solve_6, prof);
	...
	buffer += oclDumpBufferProfiling(__ocl_buffer_speed, prof);
	...
	buffer += oclDumpBufferProfiling(__ocl_buffer_ainv, prof);
