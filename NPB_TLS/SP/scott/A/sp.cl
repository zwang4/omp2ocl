		    ...
		    __global int *g_rd_log_u, __global int *g_wr_log_u)
{
	...
	__global int (*rd_log_u)[65][65][65] =
	    (__global int (*)[65][65][65])g_rd_log_u;
	__global int (*wr_log_u)[65][65][65] =
	    (__global int (*)[65][65][65])g_wr_log_u;
			...
			__global int *g_rd_log_lhs, __global int *g_wr_log_lhs)
{
	...
	//TLS Checking Buffers (BEGIN)
	__global int (*rd_log_lhs)[65][65][65] =
	    (__global int (*)[65][65][65])g_rd_log_lhs;
	__global int (*wr_log_lhs)[65][65][65] =
	    (__global int (*)[65][65][65])g_wr_log_lhs;
	//TLS Checking Buffers (END)
