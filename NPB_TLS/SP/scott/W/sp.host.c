...
static void add()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_add_0, 5, rd_oclb_u);
		oclSetKernelArgBuffer(__ocl_add_0, 6, wr_oclb_u);
		//------------------------------------------
...
//Checking lhs
				{
					...
					oclSetKernelArgBuffer
					    (__ocl_tls_1D_checking, 3,
					     __oclb_gpu_tls_conflict_flag);
					oclDevWrites(wr_oclb_lhs);
					oclDevWrites(rd_oclb_lhs);
					oclDevWrites
					    (__oclb_gpu_tls_conflict_flag);
					oclRunKernel(__ocl_tls_1D_checking, 1,
						     &__ocl_gws_lhs);
	...
	for (n = 0; n < 3; n++) {
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_lhsinit_1, 4, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_lhsinit_1, 5, rd_oclb_lhs);
			oclSetKernelArgBuffer(__ocl_lhsinit_1, 6, wr_oclb_lhs);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
...
static void lhsx()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsx_0, 8, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsx_0, 9, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
//Checking lhs
			{
				size_t __ocl_gws_lhs = (37 * 37 * 37 * 15);
				oclSetKernelArg(__ocl_tls_1D_checking, 0,
						sizeof(unsigned),
						&__ocl_gws_lhs);
				oclSetKernelArgBuffer(__ocl_tls_1D_checking, 1,
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsx_1, 7, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsx_1, 8, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
//Checking lhs
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsx_2, 8, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsx_2, 9, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
//Checking lhs
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsx_3, 6, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsx_3, 7, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void lhsy()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsy_0, 8, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsy_0, 9, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
//Checking lhs
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsy_1, 7, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsy_1, 8, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
//Checking lhs
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsy_2, 8, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsy_2, 9, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
//Checking lhs
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsy_3, 6, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsy_3, 7, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void lhsz()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsz_0, 8, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsz_0, 9, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
//Checking lhs
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsz_1, 7, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsz_1, 8, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
//Checking lhs
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsz_2, 8, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsz_2, 9, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
//Checking lhs
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_lhsz_3, 6, rd_oclb_lhs);
		oclSetKernelArgBuffer(__ocl_lhsz_3, 7, wr_oclb_lhs);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
//Checking rhs
			{
				size_t __ocl_gws_rhs = (37 * 37 * 37 * 5);
				oclSetKernelArg(__ocl_tls_1D_checking, 0,
						sizeof(unsigned),
						&__ocl_gws_rhs);
				oclSetKernelArgBuffer(__ocl_tls_1D_checking, 1,
				...
				oclSetKernelArgBuffer(__ocl_tls_1D_checking, 3,
						      __oclb_gpu_tls_conflict_flag);
				oclDevWrites(wr_oclb_rhs);
				oclDevWrites(rd_oclb_rhs);
				oclDevWrites(__oclb_gpu_tls_conflict_flag);
				oclRunKernel(__ocl_tls_1D_checking, 1,
					     &__ocl_gws_rhs);
			}
		...
		for (j = grid_points[1] - 3; j >= 0; j--) {
			...
			//--------------------------------------------------------------
			{
				...
				oclSetKernelArgBuffer(__ocl_y_solve_6, 9,
						      rd_oclb_rhs);
				oclSetKernelArgBuffer(__ocl_y_solve_6, 10,
						      wr_oclb_rhs);
				//------------------------------------------
				//OpenCL kernel arguments (END) 
				//------------------------------------------
...
//Checking rhs
					{
						size_t __ocl_gws_rhs =
						    (37 * 37 * 37 * 5);
						oclSetKernelArg
						    (__ocl_tls_1D_checking, 0,
						     sizeof(unsigned),
						     &__ocl_gws_rhs);
						oclSetKernelArgBuffer
						    (__ocl_tls_1D_checking, 1,
		...
		for (j = grid_points[1] - 3; j >= 0; j--) {
			...
			//--------------------------------------------------------------
			{
				...
				oclSetKernelArgBuffer(__ocl_y_solve_7, 9,
						      rd_oclb_rhs);
				oclSetKernelArgBuffer(__ocl_y_solve_7, 10,
						      wr_oclb_rhs);
				//------------------------------------------
				//OpenCL kernel arguments (END) 
				//------------------------------------------
...
//Checking lhs
		{
			...
			oclDevWrites(rd_oclb_lhs);
			oclDevWrites(__oclb_gpu_tls_conflict_flag);
			oclRunKernel(__ocl_tls_1D_checking, 1, &__ocl_gws_lhs);
		}
#endif
#ifdef __RUN_CHECKING_KERNEL__
//Checking rhs
		{
			...
			oclDevWrites(rd_oclb_rhs);
			oclDevWrites(__oclb_gpu_tls_conflict_flag);
			oclRunKernel(__ocl_tls_1D_checking, 1, &__ocl_gws_rhs);
		}
#endif
