		    ...
		    __global int *g_rd_log_u, __global int *g_wr_log_u)
{
	...
	__global int (*rd_log_u)[13][13][13] =
	    (__global int (*)[13][13][13])g_rd_log_u;
	__global int (*wr_log_u)[13][13][13] =
	    (__global int (*)[13][13][13])g_wr_log_u;
			...
			__global int *g_rd_log_lhs, __global int *g_wr_log_lhs)
{
	...
	//TLS Checking Buffers (BEGIN)
	__global int (*rd_log_lhs)[13][13][13] =
	    (__global int (*)[13][13][13])g_rd_log_lhs;
	__global int (*wr_log_lhs)[13][13][13] =
	    (__global int (*)[13][13][13])g_wr_log_lhs;
	//TLS Checking Buffers (END)
			...
			__global int *g_rd_log_rhs, __global int *g_wr_log_rhs)
{
	...
	//TLS Checking Buffers (BEGIN)
	__global int (*rd_log_rhs)[13][13][13] =
	    (__global int (*)[13][13][13])g_rd_log_rhs;
	__global int (*wr_log_rhs)[13][13][13] =
	    (__global int (*)[13][13][13])g_wr_log_rhs;
	//TLS Checking Buffers (END)
