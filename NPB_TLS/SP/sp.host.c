//-------------------------------------------------------------------------------
//Host code 
//Generated at : Thu Oct 25 14:32:25 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
static void create_ocl_buffers()
{
	...
	//------------------------------------------
	rd_oclb_u =
	    oclCreateBuffer(rd_log_u, (5 * 103 * 103 * 103) * sizeof(int));
	wr_oclb_u =
	    oclCreateBuffer(wr_log_u, (5 * 103 * 103 * 103) * sizeof(int));
	oclHostWrites(rd_oclb_u);
	oclHostWrites(wr_oclb_u);
	DYN_BUFFER_CHECK(rd_oclb_u, -1);
	DYN_BUFFER_CHECK(wr_oclb_u, -1);
	rd_oclb_lhs =
	    oclCreateBuffer(rd_log_lhs, (15 * 103 * 103 * 103) * sizeof(int));
	wr_oclb_lhs =
	    oclCreateBuffer(wr_log_lhs, (15 * 103 * 103 * 103) * sizeof(int));
	oclHostWrites(rd_oclb_lhs);
	oclHostWrites(wr_oclb_lhs);
	DYN_BUFFER_CHECK(rd_oclb_lhs, -1);
	DYN_BUFFER_CHECK(wr_oclb_lhs, -1);
	rd_oclb_rhs =
	    oclCreateBuffer(rd_log_rhs, (5 * 103 * 103 * 103) * sizeof(int));
	wr_oclb_rhs =
	    oclCreateBuffer(wr_log_rhs, (5 * 103 * 103 * 103) * sizeof(int));
