//-------------------------------------------------------------------------------
//OpenCL Kernels 
//Generated at : Thu Oct 25 14:33:13 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
		     ...
		     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	__global double (*v)[103][103][5] =
	    (__global double (*)[103][103][5])g_v;
	__global double (*ldz)[102][5][5] =
	    (__global double (*)[102][5][5])g_ldz;
	//-------------------------------------------
	...
	//-------------------------------------------
	{
		...
		//      ldz[i][j][m][3]
		//-------------------------------------------
		__global double *p_ldz_0_0 =
		    (__global double *)&ldz[i][j][m][0];
		if ((unsigned long)p_ldz_0_0 % 64 == 0) {
			ldz_0 = vload4(0, p_ldz_0_0);
		} else {
			ldz_0.x = p_ldz_0_0[0];
			p_ldz_0_0++;
			ldz_0.y = p_ldz_0_0[0];
		...
		v[i][j][k][m] =
		    v[i][j][k][m] -
		    omega * (ldz_0.x /*ldz[i][j][m][0] */  * v[i][j][k - 1][0] +
			     ldz_0.y /*ldz[i][j][m][1] */  * v[i][j][k - 1][1] +
			     ldz_0.z /*ldz[i][j][m][2] */  * v[i][j][k - 1][2] +
			     ldz_0.w /*ldz[i][j][m][3] */  * v[i][j][k - 1][3] +
		     ...
		     int __ocl_i_bound)
{
	...
	__global double (*v)[103][103][5] =
	    (__global double (*)[103][103][5])g_v;
	__global double (*ldy)[102][5][5] =
	    (__global double (*)[102][5][5])g_ldy;
	__global double (*ldx)[102][5][5] =
	    (__global double (*)[102][5][5])g_ldx;
	__global double (*d)[102][5][5] = (__global double (*)[102][5][5])g_d;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
	...
	//-------------------------------------------
	{
		for (m = 0; m < 5; m++) {
			...
			//      ldx[i][j][m][3]
			//-------------------------------------------
			__global double *p_ldy_0_0 =
			    (__global double *)&ldy[i][j][m][0];
			if ((unsigned long)p_ldy_0_0 % 64 == 0) {
				ldy_0 = vload4(0, p_ldy_0_0);
			} else {
				ldy_0.x = p_ldy_0_0[0];
				p_ldy_0_0++;
				ldy_0.y = p_ldy_0_0[0];
			...
			__global double *p_ldx_0_0 =
			    (__global double *)&ldx[i][j][m][0];
			if ((unsigned long)p_ldx_0_0 % 64 == 0) {
				ldx_0 = vload4(0, p_ldx_0_0);
			} else {
				ldx_0.x = p_ldx_0_0[0];
				p_ldx_0_0++;
				ldx_0.y = p_ldx_0_0[0];
			...
			v[i][j][k][m] =
			    v[i][j][k][m] -
			    omega * (ldy_0.x /*ldy[i][j][m][0] */  *
				     v[i][j - 1][k][0] +
				     ldx_0.x /*ldx[i][j][m][0] */  * v[i -
								       1][j][k]
				     [0] +
				     ldy_0.y /*ldy[i][j][m][1] */  * v[i][j -
									  1][k]
				     [1] + ldx_0.y /*ldx[i][j][m][1] */  * v[i -
									     1]
				     [j][k][1] +
				     ldy_0.z /*ldy[i][j][m][2] */  * v[i][j -
									  1][k]
				     [2] + ldx_0.z /*ldx[i][j][m][2] */  * v[i -
									     1]
				     [j][k][2] +
				     ldy_0.w /*ldy[i][j][m][3] */  * v[i][j -
									  1][k]
				     [3] + ldx_0.w /*ldx[i][j][m][3] */  * v[i -
									     1]
		...
		for (m = 0; m < 5; m++) {
			...
			//      d[i][j][m][3]
			//-------------------------------------------
			__global double *p_d_0_0 =
			    (__global double *)&d[i][j][m][0];
			if ((unsigned long)p_d_0_0 % 64 == 0) {
				d_0 = vload4(0, p_d_0_0);
			} else {
				d_0.x = p_d_0_0[0];
				p_d_0_0++;
				d_0.y = p_d_0_0[0];
			...
			tmat[m][0] = d_0.x /*d[i][j][m][0] */ ;
			tmat[m][1] = d_0.y /*d[i][j][m][1] */ ;
			tmat[m][2] = d_0.z /*d[i][j][m][2] */ ;
			tmat[m][3] = d_0.w /*d[i][j][m][3] */ ;
			tmat[m][4] = d[i][j][m][4];
		}
		tmp1 = 1.0 / tmat[0][0];
		tmp = tmp1 * tmat[1][0];
		     ...
		     int jst, int ist, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*tv)[102][5] = (__global double (*)[102][5])g_tv;
	__global double (*udz)[102][5][5] =
	    (__global double (*)[102][5][5])g_udz;
	__global double (*v)[103][103][5] =
	    (__global double (*)[103][103][5])g_v;
	//-------------------------------------------
	//Convert global memory objects (END)
	...
	//-------------------------------------------
	{
		...
		//      v[i][j][k + 1][3]
		//-------------------------------------------
		__global double *p_udz_0_0 =
		    (__global double *)&udz[i][j][m][0];
		if ((unsigned long)p_udz_0_0 % 64 == 0) {
			udz_0 = vload4(0, p_udz_0_0);
		} else {
			udz_0.x = p_udz_0_0[0];
			p_udz_0_0++;
			udz_0.y = p_udz_0_0[0];
		...
		__global double *p_v_0_0 =
		    (__global double *)&v[i][j][k + 1][0];
		if ((unsigned long)p_v_0_0 % 64 == 0) {
			v_0 = vload4(0, p_v_0_0);
		} else {
			v_0.x = p_v_0_0[0];
			p_v_0_0++;
			v_0.y = p_v_0_0[0];
		     ...
		     int ist, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	__global double (*tv)[102][5] = (__global double (*)[102][5])g_tv;
	__global double (*udy)[102][5][5] =
	    (__global double (*)[102][5][5])g_udy;
	__global double (*v)[103][103][5] =
	    (__global double (*)[103][103][5])g_v;
	__global double (*udx)[102][5][5] =
	    (__global double (*)[102][5][5])g_udx;
	__global double (*d)[102][5][5] = (__global double (*)[102][5][5])g_d;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
	...
	//-------------------------------------------
	{
		for (m = 0; m < 5; m++) {
			...
			//      udx[i][j][m][3]
			//-------------------------------------------
			__global double *p_udy_0_0 =
			    (__global double *)&udy[i][j][m][0];
			if ((unsigned long)p_udy_0_0 % 64 == 0) {
				udy_0 = vload4(0, p_udy_0_0);
			} else {
				udy_0.x = p_udy_0_0[0];
				p_udy_0_0++;
				udy_0.y = p_udy_0_0[0];
			...
			__global double *p_udx_0_0 =
			    (__global double *)&udx[i][j][m][0];
			if ((unsigned long)p_udx_0_0 % 64 == 0) {
				udx_0 = vload4(0, p_udx_0_0);
			} else {
				udx_0.x = p_udx_0_0[0];
				p_udx_0_0++;
				udx_0.y = p_udx_0_0[0];
			...
			tv[i][j][m] =
			    tv[i][j][m] +
			    omega * (udy_0.x /*udy[i][j][m][0] */  *
				     v[i][j + 1][k][0] +
				     udx_0.x /*udx[i][j][m][0] */  * v[i +
								       1][j][k]
				     [0] +
				     udy_0.y /*udy[i][j][m][1] */  * v[i][j +
									  1][k]
				     [1] + udx_0.y /*udx[i][j][m][1] */  * v[i +
									     1]
				     [j][k][1] +
				     udy_0.z /*udy[i][j][m][2] */  * v[i][j +
									  1][k]
				     [2] + udx_0.z /*udx[i][j][m][2] */  * v[i +
									     1]
				     [j][k][2] +
				     udy_0.w /*udy[i][j][m][3] */  * v[i][j +
									  1][k]
				     [3] + udx_0.w /*udx[i][j][m][3] */  * v[i +
									     1]
		     ...
		     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*frct)[103][103][5] =
	    (__global double (*)[103][103][5])g_frct;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     __global double *g_ce, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*rsd)[103][103][5] =
	    (__global double (*)[103][103][5])g_rsd;
		     ...
		     int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*flux)[103][103][5] =
	    (__global double (*)[103][103][5])g_flux;
	__global double (*rsd)[103][103][5] =
	    (__global double (*)[103][103][5])g_rsd;
	//-------------------------------------------
	//Convert global memory objects (END)
	...
	//-------------------------------------------
	{
		...
		//      rsd[i][j][k][3]
		//-------------------------------------------
		__global double *p_rsd_0_0 =
		    (__global double *)&rsd[i][j][k][0];
		if ((unsigned long)p_rsd_0_0 % 64 == 0) {
			rsd_0 = vload4(0, p_rsd_0_0);
		} else {
			rsd_0.x = p_rsd_0_0[0];
			p_rsd_0_0++;
			rsd_0.y = p_rsd_0_0[0];
		...
		flux[i][j][k][0] = rsd_0.y /*rsd[i][j][k][1] */ ;
		u21 =
		    rsd_0.y /*rsd[i][j][k][1] */  /
		    rsd_0.x /*rsd[i][j][k][0] */ ;
		q = 0.50 * (rsd_0.y /*rsd[i][j][k][1] */  *
			    rsd_0.y /*rsd[i][j][k][1] */  +
			    rsd_0.z /*rsd[i][j][k][2] */  *
			    rsd_0.z /*rsd[i][j][k][2] */  +
			    rsd_0.w /*rsd[i][j][k][3] */  *
		    ...
		    rsd_0.x /*rsd[i][j][k][0] */ ;
		flux[i][j][k][1] =
		    rsd_0.y /*rsd[i][j][k][1] */  * u21 +
		    0.40e+00 * (rsd[i][j][k][4] - q);
		flux[i][j][k][2] = rsd_0.z /*rsd[i][j][k][2] */  * u21;
		flux[i][j][k][3] = rsd_0.w /*rsd[i][j][k][3] */  * u21;
		flux[i][j][k][4] =
		     ...
		     int __ocl_k_bound, int __ocl_j_bound)
{
	...
	//-------------------------------------------
	{
		...
		for (m = 0; m < 5; m++) {
			...
			frct[1][j][k][m] =
			    frct[1][j][k][m] -
			    dsspm * (+5.0 * rsd_1[0] /*rsd[1][j][k][m] */ -4.0 *
				     rsd_1[1] /*rsd[2][j][k][m] */ +rsd_1[2]
				     /*rsd[3][j][k][m] */ );
			frct[2][j][k][m] =
			    frct[2][j][k][m] -
			    dsspm * (-4.0 * rsd_1[0] /*rsd[1][j][k][m] */ +6.0 *
				     rsd_1[1] /*rsd[2][j][k][m] */ -4.0 *
				     rsd_1[2] /*rsd[3][j][k][m] */
				     +rsd[4][j][k][m]);
		}
		ist1 = 3;
		...
		for (m = 0; m < 5; m++) {
			...
			//      rsd[nx - 3][j][k][m]
			//-------------------------------------------
			rsd_2[0] = rsd[nx - 4][j][k][m];
			rsd_2[1] = rsd[nx - 3][j][k][m];
			//-------------------------------------------
			//Prefetching (END)
			//-------------------------------------------
			...
			frct[nx - 3][j][k][m] =
			    ...
			    dsspm * (rsd[nx - 5][j][k][m] -
				     4.0 *
				     rsd_2[0] /*rsd[nx - 4][j][k][m] */ +6.0 *
				     rsd_2[1] /*rsd[nx - 3][j][k][m] */ -4.0 *
				     rsd[nx - 2][j][k][m]);
			frct[nx - 2][j][k][m] =
			    frct[nx - 2][j][k][m] -
			    dsspm * (rsd_2[0] /*rsd[nx - 4][j][k][m] */ -4.0 *
				     rsd_2[1] /*rsd[nx - 3][j][k][m] */ +5.0 *
				     rsd[nx - 2][j][k][m]);
		}
	}
	//-------------------------------------------
		     ...
		     int __ocl_i_bound)
{
	...
	//-------------------------------------------
	{
		...
		//      rsd[i][j][k][3]
		//-------------------------------------------
		__global double *p_rsd_3_0 =
		    (__global double *)&rsd[i][j][k][0];
		if ((unsigned long)p_rsd_3_0 % 64 == 0) {
			rsd_3 = vload4(0, p_rsd_3_0);
		} else {
			rsd_3.x = p_rsd_3_0[0];
			p_rsd_3_0++;
			rsd_3.y = p_rsd_3_0[0];
		...
		flux[i][j][k][0] = rsd_3.z /*rsd[i][j][k][2] */ ;
		u31 =
		    rsd_3.z /*rsd[i][j][k][2] */  /
		    rsd_3.x /*rsd[i][j][k][0] */ ;
		q = 0.50 * (rsd_3.y /*rsd[i][j][k][1] */  *
			    rsd_3.y /*rsd[i][j][k][1] */  +
			    rsd_3.z /*rsd[i][j][k][2] */  *
			    rsd_3.z /*rsd[i][j][k][2] */  +
			    rsd_3.w /*rsd[i][j][k][3] */  *
			    rsd_3.w /*rsd[i][j][k][3] */ ) /
		    rsd_3.x /*rsd[i][j][k][0] */ ;
		flux[i][j][k][1] = rsd_3.y /*rsd[i][j][k][1] */  * u31;
		flux[i][j][k][2] =
		    rsd_3.z /*rsd[i][j][k][2] */  * u31 +
		    0.40e+00 * (rsd[i][j][k][4] - q);
		flux[i][j][k][3] = rsd_3.w /*rsd[i][j][k][3] */  * u31;
		flux[i][j][k][4] =
		     ...
		     int __ocl_k_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	{
		...
		for (m = 0; m < 5; m++) {
			...
			frct[i][1][k][m] =
			    frct[i][1][k][m] -
			    dsspm * (+5.0 * rsd_4[0] /*rsd[i][1][k][m] */ -4.0 *
				     rsd_4[1] /*rsd[i][2][k][m] */ +rsd_4[2]
				     /*rsd[i][3][k][m] */ );
			frct[i][2][k][m] =
			    frct[i][2][k][m] -
			    dsspm * (-4.0 * rsd_4[0] /*rsd[i][1][k][m] */ +6.0 *
				     rsd_4[1] /*rsd[i][2][k][m] */ -4.0 *
				     rsd_4[2] /*rsd[i][3][k][m] */
				     +rsd[i][4][k][m]);
		}
		jst1 = 3;
		...
		for (m = 0; m < 5; m++) {
			...
			//      rsd[i][ny - 3][k][m]
			//-------------------------------------------
			rsd_5[0] = rsd[i][ny - 4][k][m];
			rsd_5[1] = rsd[i][ny - 3][k][m];
			//-------------------------------------------
			//Prefetching (END)
			//-------------------------------------------
			...
			frct[i][ny - 3][k][m] =
			    ...
			    dsspm * (rsd[i][ny - 5][k][m] -
				     4.0 *
				     rsd_5[0] /*rsd[i][ny - 4][k][m] */ +6.0 *
				     rsd_5[1] /*rsd[i][ny - 3][k][m] */ -4.0 *
				     rsd[i][ny - 2][k][m]);
			frct[i][ny - 2][k][m] =
			    frct[i][ny - 2][k][m] -
			    dsspm * (rsd_5[0] /*rsd[i][ny - 4][k][m] */ -4.0 *
				     rsd_5[1] /*rsd[i][ny - 3][k][m] */ +5.0 *
				     rsd[i][ny - 2][k][m]);
		}
	}
	//-------------------------------------------
		     ...
		     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	{
		for (k = 0; k <= nz - 1; k++) {
			...
			//      rsd[i][j][k][3]
			//-------------------------------------------
			__global double *p_rsd_6_0 =
			    (__global double *)&rsd[i][j][k][0];
			if ((unsigned long)p_rsd_6_0 % 64 == 0) {
				rsd_6 = vload4(0, p_rsd_6_0);
			} else {
				rsd_6.x = p_rsd_6_0[0];
				p_rsd_6_0++;
				rsd_6.y = p_rsd_6_0[0];
			...
			flux[i][j][k][0] = rsd_6.w /*rsd[i][j][k][3] */ ;
			u41 =
			    rsd_6.w /*rsd[i][j][k][3] */  /
			    rsd_6.x /*rsd[i][j][k][0] */ ;
			q = 0.50 * (rsd_6.y /*rsd[i][j][k][1] */  *
				    rsd_6.y /*rsd[i][j][k][1] */  +
				    rsd_6.z /*rsd[i][j][k][2] */  *
				    rsd_6.z /*rsd[i][j][k][2] */  +
				    rsd_6.w /*rsd[i][j][k][3] */  *
				    rsd_6.w /*rsd[i][j][k][3] */ ) /
			    rsd_6.x /*rsd[i][j][k][0] */ ;
			flux[i][j][k][1] = rsd_6.y /*rsd[i][j][k][1] */  * u41;
			flux[i][j][k][2] = rsd_6.z /*rsd[i][j][k][2] */  * u41;
			flux[i][j][k][3] =
			    rsd_6.w /*rsd[i][j][k][3] */  * u41 +
			    0.40e+00 * (rsd[i][j][k][4] - q);
			flux[i][j][k][4] =
		...
		for (m = 0; m < 5; m++) {
			...
			frct[i][j][1][m] =
			    frct[i][j][1][m] -
			    dsspm * (+5.0 * rsd_7[0] /*rsd[i][j][1][m] */ -4.0 *
				     rsd_7[1] /*rsd[i][j][2][m] */ +rsd_7[2]
				     /*rsd[i][j][3][m] */ );
			frct[i][j][2][m] =
			    frct[i][j][2][m] -
			    dsspm * (-4.0 * rsd_7[0] /*rsd[i][j][1][m] */ +6.0 *
				     rsd_7[1] /*rsd[i][j][2][m] */ -4.0 *
				     rsd_7[2] /*rsd[i][j][3][m] */
				     +rsd[i][j][4][m]);
		}
		for (k = 3; k <= nz - 4; k++) {
		...
		for (m = 0; m < 5; m++) {
			...
			//      rsd[i][j][nz - 3][m]
			//-------------------------------------------
			rsd_8[0] = rsd[i][j][nz - 4][m];
			rsd_8[1] = rsd[i][j][nz - 3][m];
			//-------------------------------------------
			//Prefetching (END)
			//-------------------------------------------
			...
			frct[i][j][nz - 3][m] =
			    ...
			    dsspm * (rsd[i][j][nz - 5][m] -
				     4.0 *
				     rsd_8[0] /*rsd[i][j][nz - 4][m] */ +6.0 *
				     rsd_8[1] /*rsd[i][j][nz - 3][m] */ -4.0 *
				     rsd[i][j][nz - 2][m]);
			frct[i][j][nz - 2][m] =
			    frct[i][j][nz - 2][m] -
			    dsspm * (rsd_8[0] /*rsd[i][j][nz - 4][m] */ -4.0 *
				     rsd_8[1] /*rsd[i][j][nz - 3][m] */ +5.0 *
				     rsd[i][j][nz - 2][m]);
		}
	}
	//-------------------------------------------
		      ...
		      int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*u)[103][103][5] =
	    (__global double (*)[103][103][5])g_u;
	__global double (*d)[102][5][5] = (__global double (*)[102][5][5])g_d;
	__global double (*a)[102][5][5] = (__global double (*)[102][5][5])g_a;
	__global double (*b)[102][5][5] = (__global double (*)[102][5][5])g_b;
	__global double (*c)[102][5][5] = (__global double (*)[102][5][5])g_c;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
	...
	//-------------------------------------------
	{
		...
		__global double *p_u_0_1 =
		    (__global double *)&u[i][j][k - 1][1];
		if ((unsigned long)p_u_0_1 % 64 == 0) {
			u_0[1] = vload4(0, p_u_0_1);
		} else {
			u_0[1].x = p_u_0_1[0];
			p_u_0_1++;
			u_0[1].y = p_u_0_1[0];
		...
		__global double *p_u_0_2 = (__global double *)&u[i][j][k][1];
		if ((unsigned long)p_u_0_2 % 64 == 0) {
			u_0[2] = vload4(0, p_u_0_2);
		} else {
			u_0[2].x = p_u_0_2[0];
			p_u_0_2++;
			u_0[2].y = p_u_0_2[0];
		...
		d[i][j][4][0] =
		    dt * 2.0 * (tx1 *
				(-(r43 * c34 - c1345) * tmp3 *
				 (((u_0[2].x /*u[i][j][k][1] */ ) *
				   (u_0[2].x /*u[i][j][k][1] */ ))) - (c34 -
								       c1345) *
				 tmp3 *
				 (((u_0[2].y /*u[i][j][k][2] */ ) *
				   (u_0[2].y /*u[i][j][k][2] */ ))) - (c34 -
								       c1345) *
				 tmp3 *
				 (((u_0[2].z /*u[i][j][k][3] */ ) *
				   (u_0[2].z /*u[i][j][k][3] */ ))) -
				 (c1345) * tmp2 *
				 u_0[2].w /*u[i][j][k][4] */ ) + ty1 * (-(c34 -
									  c1345)
									* tmp3 *
									(((u_0
									   [2].
		...
		d[i][j][4][1] =
		    dt * 2.0 * (tx1 * (r43 * c34 - c1345) * tmp2 *
				u_0[2].x /*u[i][j][k][1] */  + ty1 * (c34 -
								      c1345) *
				tmp2 * u_0[2].x /*u[i][j][k][1] */  +
				tz1 * (c34 -
				       c1345) * tmp2 *
				u_0[2].x /*u[i][j][k][1] */ );
		d[i][j][4][2] =
		    dt * 2.0 * (tx1 * (c34 - c1345) * tmp2 *
				...
				ty1 * (r43 * c34 -
				       c1345) * tmp2 *
				u_0[2].y /*u[i][j][k][2] */  + tz1 * (c34 -
								      c1345) *
				tmp2 * u_0[2].y /*u[i][j][k][2] */ );
		d[i][j][4][3] =
		    dt * 2.0 * (tx1 * (c34 - c1345) * tmp2 *
				u_0[2].z /*u[i][j][k][3] */  + ty1 * (c34 -
								      c1345) *
				tmp2 * u_0[2].z /*u[i][j][k][3] */  +
				tz1 * (r43 * c34 -
				       c1345) * tmp2 *
				u_0[2].z /*u[i][j][k][3] */ );
		d[i][j][4][4] =
		...
		a[i][j][1][0] =
		    ...
		    (-
		     (u_0[1].x /*u[i][j][k - 1][1] */  *
		      u_0[1].z /*u[i][j][k - 1][3] */ ) * tmp2) -
		    dt * tz1 * (-c34 * tmp2 * u_0[1].x /*u[i][j][k - 1][1] */ );
		a[i][j][1][1] =
		    -dt * tz2 * (u_0[1].z /*u[i][j][k - 1][3] */  * tmp1) -
		    dt * tz1 * c34 * tmp1 - dt * tz1 * dz2;
		a[i][j][1][2] = 0.0;
		a[i][j][1][3] =
		    -dt * tz2 * (u_0[1].x /*u[i][j][k - 1][1] */  * tmp1);
		a[i][j][1][4] = 0.0;
		a[i][j][2][0] =
		    -dt * tz2 *
		    (-
		     (u_0[1].y /*u[i][j][k - 1][2] */  *
		      u_0[1].z /*u[i][j][k - 1][3] */ ) * tmp2) -
		    dt * tz1 * (-c34 * tmp2 * u_0[1].y /*u[i][j][k - 1][2] */ );
		a[i][j][2][1] = 0.0;
		a[i][j][2][2] =
		    -dt * tz2 * (u_0[1].z /*u[i][j][k - 1][3] */  * tmp1) -
		    dt * tz1 * (c34 * tmp1) - dt * tz1 * dz3;
		a[i][j][2][3] =
		    -dt * tz2 * (u_0[1].y /*u[i][j][k - 1][2] */  * tmp1);
		a[i][j][2][4] = 0.0;
		a[i][j][3][0] =
		    -dt * tz2 * (-(u_0[1].z /*u[i][j][k - 1][3] */  * tmp1) *
				 (u_0[1].z /*u[i][j][k - 1][3] */  * tmp1) +
				 0.50 * 0.40e+00 *
				 ((u_0[1].x /*u[i][j][k - 1][1] */  *
				   u_0[1].x /*u[i][j][k - 1][1] */  +
				   u_0[1].y /*u[i][j][k - 1][2] */  *
		...
		a[i][j][3][1] =
		    -dt * tz2 * (-0.40e+00 *
				 (u_0[1].x /*u[i][j][k - 1][1] */  * tmp1));
		a[i][j][3][2] =
		    -dt * tz2 * (-0.40e+00 *
				 (u_0[1].y /*u[i][j][k - 1][2] */  * tmp1));
		a[i][j][3][3] =
		    -dt * tz2 * (2.0 -
				 0.40e+00) * (u_0[1].z /*u[i][j][k - 1][3] */  *
					      tmp1) -
		...
		a[i][j][4][0] =
		    ...
		    ((0.40e+00 *
		      (u_0[1].x /*u[i][j][k - 1][1] */  *
		       ...
		       u_0[1].z /*u[i][j][k - 1][3] */  *
		       u_0[1].z /*u[i][j][k - 1][3] */ ) * tmp2 -
		      1.40e+00 * (u_0[1].w /*u[i][j][k - 1][4] */  * tmp1)) *
		     (u_0[1].z /*u[i][j][k - 1][3] */  * tmp1)) -
		    dt * tz1 * (-(c34 - c1345) * tmp3 *
				(u_0[1].x /*u[i][j][k - 1][1] */  *
				 u_0[1].x /*u[i][j][k - 1][1] */ ) - (c34 -
								      c1345) *
				tmp3 * (u_0[1].y /*u[i][j][k - 1][2] */  *
					u_0[1].y /*u[i][j][k - 1][2] */ ) -
				(r43 * c34 -
				 c1345) * tmp3 *
				(u_0[1].z /*u[i][j][k - 1][3] */  *
		...
		a[i][j][4][3] =
		    -dt * tz2 * (1.40e+00 *
				 (u_0[1].w /*u[i][j][k - 1][4] */  * tmp1) -
				 0.50 * 0.40e+00 *
				 ((u_0[1].x /*u[i][j][k - 1][1] */  *
				   u_0[1].x /*u[i][j][k - 1][1] */  +
				   u_0[1].y /*u[i][j][k - 1][2] */  *
				   u_0[1].y /*u[i][j][k - 1][2] */  +
				   3.0 * u_0[1].z /*u[i][j][k - 1][3] */  *
				   u_0[1].z /*u[i][j][k - 1][3] */ ) * tmp2)) -
		    dt * tz1 * (r43 * c34 -
				c1345) * tmp2 *
		    u_0[1].z /*u[i][j][k - 1][3] */ ;
		...
		b[i][j][1][0] =
		    ...
		    (-
		     (u_2.x /*u[i][j - 1][k][1] */  *
		      u_2.y /*u[i][j - 1][k][2] */ ) * tmp2) -
		    dt * ty1 * (-c34 * tmp2 * u_2.x /*u[i][j - 1][k][1] */ );
		b[i][j][1][1] =
		    -dt * ty2 * (u_2.y /*u[i][j - 1][k][2] */  * tmp1) -
		    dt * ty1 * (c34 * tmp1) - dt * ty1 * dy2;
		b[i][j][1][2] =
		    -dt * ty2 * (u_2.x /*u[i][j - 1][k][1] */  * tmp1);
		b[i][j][1][3] = 0.0;
		b[i][j][1][4] = 0.0;
		b[i][j][2][0] =
		    -dt * ty2 * (-(u_2.y /*u[i][j - 1][k][2] */  * tmp1) *
				 (u_2.y /*u[i][j - 1][k][2] */  * tmp1) +
				 0.50 * 0.40e+00 *
				 ((u_2.x /*u[i][j - 1][k][1] */  *
				   u_2.x /*u[i][j - 1][k][1] */  +
				   u_2.y /*u[i][j - 1][k][2] */  *
				   u_2.y /*u[i][j - 1][k][2] */  +
				   u_1[1] /*u[i][j - 1][k][3] */ *u_1[1]
				   /*u[i][j - 1][k][3] */ ) * tmp2)) -
		    dt * ty1 * (-r43 * c34 * tmp2 *
				u_2.y /*u[i][j - 1][k][2] */ );
		b[i][j][2][1] =
		    -dt * ty2 * (-0.40e+00 *
				 (u_2.x /*u[i][j - 1][k][1] */  * tmp1));
		b[i][j][2][2] =
		    -dt * ty2 * ((2.0 - 0.40e+00) *
				 (u_2.y /*u[i][j - 1][k][2] */  * tmp1)) -
		...
		b[i][j][2][3] =
		    -dt * ty2 * (-0.40e+00 *
				 (u_1[1] /*u[i][j - 1][k][3] */ *tmp1));
		b[i][j][2][4] = -dt * ty2 * 0.40e+00;
		b[i][j][3][0] =
		    -dt * ty2 *
		    (-
		     (u_2.y /*u[i][j - 1][k][2] */  *
		      u_1[1] /*u[i][j - 1][k][3] */ ) * tmp2) -
		    dt * ty1 * (-c34 * tmp2 * u_1[1] /*u[i][j - 1][k][3] */ );
		b[i][j][3][1] = 0.0;
		b[i][j][3][2] =
		    -dt * ty2 * (u_1[1] /*u[i][j - 1][k][3] */ *tmp1);
		b[i][j][3][3] =
		    -dt * ty2 * (u_2.y /*u[i][j - 1][k][2] */  * tmp1) -
		...
		b[i][j][4][1] =
		    -dt * ty2 * (-0.40e+00 *
				 (u_2.x /*u[i][j - 1][k][1] */  *
				  u_2.y /*u[i][j - 1][k][2] */ ) * tmp2) -
		    dt * ty1 * (c34 -
				c1345) * tmp2 * u_2.x /*u[i][j - 1][k][1] */ ;
		b[i][j][4][2] =
		    -dt * ty2 * (1.40e+00 * (u[i][j - 1][k][4] * tmp1) -
				 0.50 * 0.40e+00 *
				 ((u_2.x /*u[i][j - 1][k][1] */  *
				   u_2.x /*u[i][j - 1][k][1] */  +
				   3.0 * u_2.y /*u[i][j - 1][k][2] */  *
				   u_2.y /*u[i][j - 1][k][2] */  +
				   u_1[1] /*u[i][j - 1][k][3] */ *u_1[1]
				   /*u[i][j - 1][k][3] */ ) * tmp2)) -
		    dt * ty1 * (r43 * c34 -
				c1345) * tmp2 * u_2.y /*u[i][j - 1][k][2] */ ;
		b[i][j][4][3] =
		    -dt * ty2 * (-0.40e+00 *
				 (u_2.y /*u[i][j - 1][k][2] */  *
				  u_1[1] /*u[i][j - 1][k][3] */ ) * tmp2) -
		    dt * ty1 * (c34 -
				c1345) * tmp2 * u_1[1] /*u[i][j - 1][k][3] */ ;
		b[i][j][4][4] =
		    -dt * ty2 * (1.40e+00 *
				 (u_2.y /*u[i][j - 1][k][2] */  * tmp1)) -
		    dt * ty1 * c1345 * tmp1 - dt * ty1 * dy5;
		tmp1 = 1.0 / u_0[0].x /*u[i - 1][j][k][0] */ ;
		tmp2 = tmp1 * tmp1;
		tmp3 = tmp1 * tmp2;
		...
		c[i][j][0][4] = 0.0;
		c[i][j][1][0] =
		    -dt * tx2 * (-(u_0[0].y /*u[i - 1][j][k][1] */  * tmp1) *
				 (u_0[0].y /*u[i - 1][j][k][1] */  * tmp1) +
				 0.40e+00 * 0.50 *
				 (u_0[0].y /*u[i - 1][j][k][1] */  *
				  u_0[0].y /*u[i - 1][j][k][1] */  +
				  u_0[0].z /*u[i - 1][j][k][2] */  *
		...
		c[i][j][1][2] =
		    -dt * tx2 * (-0.40e+00 *
				 (u_0[0].z /*u[i - 1][j][k][2] */  * tmp1));
		c[i][j][1][3] =
		    -dt * tx2 * (-0.40e+00 *
				 (u_0[0].w /*u[i - 1][j][k][3] */  * tmp1));
		c[i][j][1][4] = -dt * tx2 * 0.40e+00;
		c[i][j][2][0] =
		    -dt * tx2 *
		    (-
		     (u_0[0].y /*u[i - 1][j][k][1] */  *
		      u_0[0].z /*u[i - 1][j][k][2] */ ) * tmp2) -
		    dt * tx1 * (-c34 * tmp2 * u_0[0].z /*u[i - 1][j][k][2] */ );
		c[i][j][2][1] =
		    -dt * tx2 * (u_0[0].z /*u[i - 1][j][k][2] */  * tmp1);
		c[i][j][2][2] =
		    -dt * tx2 * (u_0[0].y /*u[i - 1][j][k][1] */  * tmp1) -
		...
		c[i][j][3][0] =
		    ...
		    (-
		     (u_0[0].y /*u[i - 1][j][k][1] */  *
		      u_0[0].w /*u[i - 1][j][k][3] */ ) * tmp2) -
		    dt * tx1 * (-c34 * tmp2 * u_0[0].w /*u[i - 1][j][k][3] */ );
		c[i][j][3][1] =
		    -dt * tx2 * (u_0[0].w /*u[i - 1][j][k][3] */  * tmp1);
		c[i][j][3][2] = 0.0;
		c[i][j][3][3] =
		    -dt * tx2 * (u_0[0].y /*u[i - 1][j][k][1] */  * tmp1) -
		...
		c[i][j][4][0] =
		    ...
		    ((0.40e+00 *
		      (u_0[0].y /*u[i - 1][j][k][1] */  *
		       ...
		       u_0[0].w /*u[i - 1][j][k][3] */  *
		       u_0[0].w /*u[i - 1][j][k][3] */ ) * tmp2 -
		      1.40e+00 * (u_1[0] /*u[i - 1][j][k][4] */ *tmp1)) *
		     (u_0[0].y /*u[i - 1][j][k][1] */  * tmp1)) -
		    dt * tx1 * (-(r43 * c34 - c1345) * tmp3 *
				(((u_0[0].y /*u[i - 1][j][k][1] */ ) *
				  (u_0[0].y /*u[i - 1][j][k][1] */ ))) - (c34 -
									  c1345)
				* tmp3 *
				(((u_0[0].z /*u[i - 1][j][k][2] */ ) *
				  (u_0[0].z /*u[i - 1][j][k][2] */ ))) - (c34 -
									  c1345)
				* tmp3 *
				(((u_0[0].w /*u[i - 1][j][k][3] */ ) *
				  (u_0[0].w /*u[i - 1][j][k][3] */ ))) -
				c1345 * tmp2 * u_1[0] /*u[i - 1][j][k][4] */ );
		c[i][j][4][1] =
		    -dt * tx2 * (1.40e+00 *
				 (u_1[0] /*u[i - 1][j][k][4] */ *tmp1) -
				 0.50 * 0.40e+00 *
				 ((3.0 * u_0[0].y /*u[i - 1][j][k][1] */  *
				   u_0[0].y /*u[i - 1][j][k][1] */  +
				   u_0[0].z /*u[i - 1][j][k][2] */  *
				   u_0[0].z /*u[i - 1][j][k][2] */  +
				   u_0[0].w /*u[i - 1][j][k][3] */  *
		     ...
		     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	{
		...
		//      u[i + 1][j][k][4]
		//-------------------------------------------
		__global double *p_u_3_0 = (__global double *)&u[i][j][k][0];
		...
		d[i][j][4][0] =
		    dt * 2.0 * (tx1 *
				(-(r43 * c34 - c1345) * tmp3 *
				 (((u_3[0].y /*u[i][j][k][1] */ ) *
				   (u_3[0].y /*u[i][j][k][1] */ ))) - (c34 -
								       c1345) *
				 tmp3 *
				 (((u_3[0].z /*u[i][j][k][2] */ ) *
				   (u_3[0].z /*u[i][j][k][2] */ ))) - (c34 -
								       c1345) *
				 tmp3 *
				 (((u_3[0].w /*u[i][j][k][3] */ ) *
				   (u_3[0].w /*u[i][j][k][3] */ ))) -
		...
		d[i][j][4][1] =
		    dt * 2.0 * (tx1 * (r43 * c34 - c1345) * tmp2 *
				u_3[0].y /*u[i][j][k][1] */  + ty1 * (c34 -
								      c1345) *
				tmp2 * u_3[0].y /*u[i][j][k][1] */  +
				tz1 * (c34 -
				       c1345) * tmp2 *
				u_3[0].y /*u[i][j][k][1] */ );
		d[i][j][4][2] =
		    dt * 2.0 * (tx1 * (c34 - c1345) * tmp2 *
				...
				ty1 * (r43 * c34 -
				       c1345) * tmp2 *
				u_3[0].z /*u[i][j][k][2] */  + tz1 * (c34 -
								      c1345) *
				tmp2 * u_3[0].z /*u[i][j][k][2] */ );
		d[i][j][4][3] =
		    dt * 2.0 * (tx1 * (c34 - c1345) * tmp2 *
				u_3[0].w /*u[i][j][k][3] */  + ty1 * (c34 -
								      c1345) *
				tmp2 * u_3[0].w /*u[i][j][k][3] */  +
				tz1 * (r43 * c34 -
				       c1345) * tmp2 *
				u_3[0].w /*u[i][j][k][3] */ );
		d[i][j][4][4] =
		...
		a[i][j][0][4] = 0.0;
		a[i][j][1][0] =
		    dt * tx2 * (-(u_3[3].y /*u[i + 1][j][k][1] */  * tmp1) *
				(u_3[3].y /*u[i + 1][j][k][1] */  * tmp1) +
				0.40e+00 * 0.50 *
				(u_3[3].y /*u[i + 1][j][k][1] */  *
				 u_3[3].y /*u[i + 1][j][k][1] */  +
				 u_3[3].z /*u[i + 1][j][k][2] */  *
		...
		a[i][j][1][2] =
		    dt * tx2 * (-0.40e+00 *
				(u_3[3].z /*u[i + 1][j][k][2] */  * tmp1));
		a[i][j][1][3] =
		    dt * tx2 * (-0.40e+00 *
				(u_3[3].w /*u[i + 1][j][k][3] */  * tmp1));
		a[i][j][1][4] = dt * tx2 * 0.40e+00;
		a[i][j][2][0] =
		    dt * tx2 *
		    (-
		     (u_3[3].y /*u[i + 1][j][k][1] */  *
		      u_3[3].z /*u[i + 1][j][k][2] */ ) * tmp2) -
		    dt * tx1 * (-c34 * tmp2 * u_3[3].z /*u[i + 1][j][k][2] */ );
		a[i][j][2][1] =
		    dt * tx2 * (u_3[3].z /*u[i + 1][j][k][2] */  * tmp1);
		a[i][j][2][2] =
		    dt * tx2 * (u_3[3].y /*u[i + 1][j][k][1] */  * tmp1) -
		    dt * tx1 * (c34 * tmp1) - dt * tx1 * dx3;
		a[i][j][2][3] = 0.0;
		...
		a[i][j][3][0] =
		    ...
		    (-
		     (u_3[3].y /*u[i + 1][j][k][1] */  *
		      u_3[3].w /*u[i + 1][j][k][3] */ ) * tmp2) -
		    dt * tx1 * (-c34 * tmp2 * u_3[3].w /*u[i + 1][j][k][3] */ );
		a[i][j][3][1] =
		    dt * tx2 * (u_3[3].w /*u[i + 1][j][k][3] */  * tmp1);
		a[i][j][3][2] = 0.0;
		a[i][j][3][3] =
		    dt * tx2 * (u_3[3].y /*u[i + 1][j][k][1] */  * tmp1) -
		    dt * tx1 * (c34 * tmp1) - dt * tx1 * dx4;
		...
		a[i][j][4][0] =
		    ...
		    ((0.40e+00 *
		      (u_3[3].y /*u[i + 1][j][k][1] */  *
		       ...
		       u_3[3].w /*u[i + 1][j][k][3] */  *
		       u_3[3].w /*u[i + 1][j][k][3] */ ) * tmp2 -
		      1.40e+00 * (u_4[1] /*u[i + 1][j][k][4] */ *tmp1)) *
		     (u_3[3].y /*u[i + 1][j][k][1] */  * tmp1)) -
		    dt * tx1 * (-(r43 * c34 - c1345) * tmp3 *
				(((u_3[3].y /*u[i + 1][j][k][1] */ ) *
				  (u_3[3].y /*u[i + 1][j][k][1] */ ))) - (c34 -
									  c1345)
				* tmp3 *
				(((u_3[3].z /*u[i + 1][j][k][2] */ ) *
				  (u_3[3].z /*u[i + 1][j][k][2] */ ))) - (c34 -
									  c1345)
				* tmp3 *
				(((u_3[3].w /*u[i + 1][j][k][3] */ ) *
				  (u_3[3].w /*u[i + 1][j][k][3] */ ))) -
				c1345 * tmp2 * u_4[1] /*u[i + 1][j][k][4] */ );
		a[i][j][4][1] =
		    dt * tx2 * (1.40e+00 *
				(u_4[1] /*u[i + 1][j][k][4] */ *tmp1) -
				0.50 * 0.40e+00 *
				((3.0 * u_3[3].y /*u[i + 1][j][k][1] */  *
				  u_3[3].y /*u[i + 1][j][k][1] */  +
				  u_3[3].z /*u[i + 1][j][k][2] */  *
				  u_3[3].z /*u[i + 1][j][k][2] */  +
				  u_3[3].w /*u[i + 1][j][k][3] */  *
		...
		b[i][j][1][0] =
		    ...
		    (-
		     (u_3[2].y /*u[i][j + 1][k][1] */  *
		      u_3[2].z /*u[i][j + 1][k][2] */ ) * tmp2) -
		    dt * ty1 * (-c34 * tmp2 * u_3[2].y /*u[i][j + 1][k][1] */ );
		b[i][j][1][1] =
		    dt * ty2 * (u_3[2].z /*u[i][j + 1][k][2] */  * tmp1) -
		    dt * ty1 * (c34 * tmp1) - dt * ty1 * dy2;
		b[i][j][1][2] =
		    dt * ty2 * (u_3[2].y /*u[i][j + 1][k][1] */  * tmp1);
		b[i][j][1][3] = 0.0;
		b[i][j][1][4] = 0.0;
		b[i][j][2][0] =
		    dt * ty2 * (-(u_3[2].z /*u[i][j + 1][k][2] */  * tmp1) *
				(u_3[2].z /*u[i][j + 1][k][2] */  * tmp1) +
				0.50 * 0.40e+00 *
				((u_3[2].y /*u[i][j + 1][k][1] */  *
				  u_3[2].y /*u[i][j + 1][k][1] */  +
				  u_3[2].z /*u[i][j + 1][k][2] */  *
				  u_3[2].z /*u[i][j + 1][k][2] */  +
				  u_3[2].w /*u[i][j + 1][k][3] */  *
				  u_3[2].w /*u[i][j + 1][k][3] */ ) * tmp2)) -
		    dt * ty1 * (-r43 * c34 * tmp2 *
				u_3[2].z /*u[i][j + 1][k][2] */ );
		b[i][j][2][1] =
		    dt * ty2 * (-0.40e+00 *
				(u_3[2].y /*u[i][j + 1][k][1] */  * tmp1));
		b[i][j][2][2] =
		    dt * ty2 * ((2.0 - 0.40e+00) *
				(u_3[2].z /*u[i][j + 1][k][2] */  * tmp1)) -
		    dt * ty1 * (r43 * c34 * tmp1) - dt * ty1 * dy3;
		...
		b[i][j][3][0] =
		    ...
		    (-
		     (u_3[2].z /*u[i][j + 1][k][2] */  *
		      u_3[2].w /*u[i][j + 1][k][3] */ ) * tmp2) -
		    dt * ty1 * (-c34 * tmp2 * u_3[2].w /*u[i][j + 1][k][3] */ );
		b[i][j][3][1] = 0.0;
		b[i][j][3][2] =
		    dt * ty2 * (u_3[2].w /*u[i][j + 1][k][3] */  * tmp1);
		b[i][j][3][3] =
		    dt * ty2 * (u_3[2].z /*u[i][j + 1][k][2] */  * tmp1) -
		    dt * ty1 * (c34 * tmp1) - dt * ty1 * dy4;
		b[i][j][3][4] = 0.0;
		...
		c[i][j][1][0] =
		    ...
		    (-
		     (u_3[1].y /*u[i][j][k + 1][1] */  *
		      u_3[1].w /*u[i][j][k + 1][3] */ ) * tmp2) -
		    dt * tz1 * (-c34 * tmp2 * u_3[1].y /*u[i][j][k + 1][1] */ );
		c[i][j][1][1] =
		    dt * tz2 * (u_3[1].w /*u[i][j][k + 1][3] */  * tmp1) -
		    dt * tz1 * c34 * tmp1 - dt * tz1 * dz2;
		c[i][j][1][2] = 0.0;
		c[i][j][1][3] =
		    dt * tz2 * (u_3[1].y /*u[i][j][k + 1][1] */  * tmp1);
		c[i][j][1][4] = 0.0;
		c[i][j][2][0] =
		    dt * tz2 *
		    (-
		     (u_3[1].z /*u[i][j][k + 1][2] */  *
		      u_3[1].w /*u[i][j][k + 1][3] */ ) * tmp2) -
		    dt * tz1 * (-c34 * tmp2 * u_3[1].z /*u[i][j][k + 1][2] */ );
		c[i][j][2][1] = 0.0;
		c[i][j][2][2] =
		    dt * tz2 * (u_3[1].w /*u[i][j][k + 1][3] */  * tmp1) -
		    dt * tz1 * (c34 * tmp1) - dt * tz1 * dz3;
		c[i][j][2][3] =
		    dt * tz2 * (u_3[1].z /*u[i][j][k + 1][2] */  * tmp1);
		c[i][j][2][4] = 0.0;
		c[i][j][3][0] =
		    dt * tz2 * (-(u_3[1].w /*u[i][j][k + 1][3] */  * tmp1) *
				(u_3[1].w /*u[i][j][k + 1][3] */  * tmp1) +
				0.50 * 0.40e+00 *
				((u_3[1].y /*u[i][j][k + 1][1] */  *
				  u_3[1].y /*u[i][j][k + 1][1] */  +
				  u_3[1].z /*u[i][j][k + 1][2] */  *
		...
		c[i][j][3][1] =
		    dt * tz2 * (-0.40e+00 *
				(u_3[1].y /*u[i][j][k + 1][1] */  * tmp1));
		c[i][j][3][2] =
		    dt * tz2 * (-0.40e+00 *
				(u_3[1].z /*u[i][j][k + 1][2] */  * tmp1));
		c[i][j][3][3] =
		    dt * tz2 * (2.0 -
				0.40e+00) * (u_3[1].w /*u[i][j][k + 1][3] */  *
					     tmp1) -
		    dt * tz1 * (r43 * c34 * tmp1) - dt * tz1 * dz4;
		...
		c[i][j][4][0] =
		    ...
		    ((0.40e+00 *
		      (u_3[1].y /*u[i][j][k + 1][1] */  *
		       ...
		       u_3[1].w /*u[i][j][k + 1][3] */  *
		       u_3[1].w /*u[i][j][k + 1][3] */ ) * tmp2 -
		      1.40e+00 * (u_4[0] /*u[i][j][k + 1][4] */ *tmp1)) *
		     (u_3[1].w /*u[i][j][k + 1][3] */  * tmp1)) -
		    dt * tz1 * (-(c34 - c1345) * tmp3 *
				(((u_3[1].y /*u[i][j][k + 1][1] */ ) *
				  (u_3[1].y /*u[i][j][k + 1][1] */ ))) - (c34 -
									  c1345)
				* tmp3 *
				(((u_3[1].z /*u[i][j][k + 1][2] */ ) *
				  (u_3[1].z /*u[i][j][k + 1][2] */ ))) -
		...
		c[i][j][4][3] =
		    dt * tz2 * (1.40e+00 *
				(u_4[0] /*u[i][j][k + 1][4] */ *tmp1) -
				0.50 * 0.40e+00 *
				((u_3[1].y /*u[i][j][k + 1][1] */  *
				  u_3[1].y /*u[i][j][k + 1][1] */  +
				  u_3[1].z /*u[i][j][k + 1][2] */  *
				  u_3[1].z /*u[i][j][k + 1][2] */  +
				  3.0 * u_3[1].w /*u[i][j][k + 1][3] */  *
				  u_3[1].w /*u[i][j][k + 1][3] */ ) * tmp2)) -
		    dt * tz1 * (r43 * c34 -
				c1345) * tmp2 *
		    u_3[1].w /*u[i][j][k + 1][3] */ ;
				       ...
				       __global double *__ocl_part_sum4)
{
	...
	//-------------------------------------------
	{
		...
		//      v[i][j][k][3]
		//-------------------------------------------
		__global double *p_v_1_0 = (__global double *)&v[i][j][k][0];
		...
		sum0 =
		    sum0 +
		    v_1.x /*v[i][j][k][0] */  * v_1.x /*v[i][j][k][0] */ ;
		sum1 =
		    sum1 +
		    v_1.y /*v[i][j][k][1] */  * v_1.y /*v[i][j][k][1] */ ;
		sum2 =
		    sum2 +
		    v_1.z /*v[i][j][k][2] */  * v_1.z /*v[i][j][k][2] */ ;
		sum3 =
		    sum3 +
		    v_1.w /*v[i][j][k][3] */  * v_1.w /*v[i][j][k][3] */ ;
		    ...
		    int __ocl_i_bound)
{
	...
	//-------------------------------------------
	{
		...
		//      u[i][j][k][3]
		//-------------------------------------------
		__global double *p_u_5_0 = (__global double *)&u[i][j][k][0];
		if ((unsigned long)p_u_5_0 % 64 == 0) {
			u_5 = vload4(0, p_u_5_0);
		} else {
			u_5.x = p_u_5_0[0];
			p_u_5_0++;
			u_5.y = p_u_5_0[0];
		...
		flux[i][j][k][0] = u_5.y /*u[i][j][k][1] */ ;
		u21 = u_5.y /*u[i][j][k][1] */  / u_5.x /*u[i][j][k][0] */ ;
		q = 0.50 * (u_5.y /*u[i][j][k][1] */  *
			    u_5.y /*u[i][j][k][1] */  +
			    u_5.z /*u[i][j][k][2] */  *
			    u_5.z /*u[i][j][k][2] */  +
			    u_5.w /*u[i][j][k][3] */  *
		...
		flux[i][j][k][2] = u_5.z /*u[i][j][k][2] */  * u21;
		flux[i][j][k][3] = u_5.w /*u[i][j][k][3] */  * u21;
		flux[i][j][k][4] =
		    ...
		    int __ocl_k_bound, int __ocl_j_bound)
{
	...
	//-------------------------------------------
	{
		...
		for (m = 0; m < 5; m++) {
			...
			rsd[1][j][k][m] =
			    rsd[1][j][k][m] -
			    dssp * (+5.0 * u_6[0] /*u[1][j][k][m] */ -4.0 *
				    u_6[1] /*u[2][j][k][m] */ +u_6[2]
				    /*u[3][j][k][m] */ );
			rsd[2][j][k][m] =
			    rsd[2][j][k][m] -
			    dssp * (-4.0 * u_6[0] /*u[1][j][k][m] */ +6.0 *
				    u_6[1] /*u[2][j][k][m] */ -4.0 *
				    u_6[2] /*u[3][j][k][m] */ +u[4][j][k][m]);
		}
		ist1 = 3;
		iend1 = nx - 4;
		for (i = ist1; i <= iend1; i++) {
		...
		for (m = 0; m < 5; m++) {
			...
			rsd[nx - 2][j][k][m] =
			    rsd[nx - 2][j][k][m] -
			    dssp * (u_7[0] /*u[nx - 4][j][k][m] */ -4.0 *
				    u_7[1] /*u[nx - 3][j][k][m] */ +5.0 * u[nx -
									    2]
				    [j][k][m]);
		}
	}
		    ...
		    int __ocl_i_bound)
{
	...
	//-------------------------------------------
	{
		...
		flux[i][j][k][0] = u_8.z /*u[i][j][k][2] */ ;
		u31 = u_8.z /*u[i][j][k][2] */  / u_8.x /*u[i][j][k][0] */ ;
		q = 0.50 * (u_8.y /*u[i][j][k][1] */  *
			    u_8.y /*u[i][j][k][1] */  +
			    u_8.z /*u[i][j][k][2] */  *
			    u_8.z /*u[i][j][k][2] */  +
			    u_8.w /*u[i][j][k][3] */  *
			    u_8.w /*u[i][j][k][3] */ ) /
		    u_8.x /*u[i][j][k][0] */ ;
		flux[i][j][k][1] = u_8.y /*u[i][j][k][1] */  * u31;
		flux[i][j][k][2] =
		    u_8.z /*u[i][j][k][2] */  * u31 +
		    0.40e+00 * (u[i][j][k][4] - q);
		flux[i][j][k][3] = u_8.w /*u[i][j][k][3] */  * u31;
		flux[i][j][k][4] =
		    ...
		    int __ocl_k_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	{
		...
		for (m = 0; m < 5; m++) {
			...
			rsd[i][1][k][m] =
			    rsd[i][1][k][m] -
			    dssp * (+5.0 * u_9[0] /*u[i][1][k][m] */ -4.0 *
				    u_9[1] /*u[i][2][k][m] */ +u_9[2]
				    /*u[i][3][k][m] */ );
			rsd[i][2][k][m] =
			    rsd[i][2][k][m] -
			    dssp * (-4.0 * u_9[0] /*u[i][1][k][m] */ +6.0 *
				    u_9[1] /*u[i][2][k][m] */ -4.0 *
				    u_9[2] /*u[i][3][k][m] */ +u[i][4][k][m]);
		}
		jst1 = 3;
		jend1 = ny - 4;
		for (j = jst1; j <= jend1; j++) {
		...
		for (m = 0; m < 5; m++) {
			...
			rsd[i][ny - 2][k][m] =
			    rsd[i][ny - 2][k][m] -
			    dssp * (u_10[0] /*u[i][ny - 4][k][m] */ -4.0 *
				    u_10[1] /*u[i][ny - 3][k][m] */ +5.0 *
				    u[i][ny - 2][k][m]);
		}
	}
	//-------------------------------------------
	...
	//-------------------------------------------
	{
		for (k = 0; k <= nz - 1; k++) {
			...
			q = 0.50 * (u_11.y /*u[i][j][k][1] */  *
				    ...
				    u_11.w /*u[i][j][k][3] */ ) /
			    u_11.x /*u[i][j][k][0] */ ;
			flux[i][j][k][1] = u_11.y /*u[i][j][k][1] */  * u41;
			flux[i][j][k][2] = u_11.z /*u[i][j][k][2] */  * u41;
			flux[i][j][k][3] =
			    u_11.w /*u[i][j][k][3] */  * u41 +
			    0.40e+00 * (u[i][j][k][4] - q);
			flux[i][j][k][4] =
		...
		for (m = 0; m < 5; m++) {
			...
			rsd[i][j][1][m] =
			    rsd[i][j][1][m] -
			    dssp * (+5.0 * u_12[0] /*u[i][j][1][m] */ -4.0 *
				    u_12[1] /*u[i][j][2][m] */ +u_12[2]
				    /*u[i][j][3][m] */ );
			rsd[i][j][2][m] =
			    rsd[i][j][2][m] -
			    dssp * (-4.0 * u_12[0] /*u[i][j][1][m] */ +6.0 *
				    u_12[1] /*u[i][j][2][m] */ -4.0 *
				    u_12[2] /*u[i][j][3][m] */ +u[i][j][4][m]);
		}
		for (k = 3; k <= nz - 4; k++) {
			for (m = 0; m < 5; m++) {
				rsd[i][j][k][m] =
		...
		for (m = 0; m < 5; m++) {
			...
			rsd[i][j][nz - 2][m] =
			    rsd[i][j][nz - 2][m] -
			    dssp * (u_13[0] /*u[i][j][nz - 4][m] */ -4.0 *
				    u_13[1] /*u[i][j][nz - 3][m] */ +5.0 *
				    u[i][j][nz - 2][m]);
		}
	}
	//-------------------------------------------
		      ...
		      __global int *g_rd_log_u, __global int *g_wr_log_u)
{
	...
	__global int (*rd_log_u)[103][103][5] =
	    (__global int (*)[103][103][5])g_rd_log_u;
	__global int (*wr_log_u)[103][103][5] =
	    (__global int (*)[103][103][5])g_wr_log_u;
	...
	//-------------------------------------------
	{
		...
		// GPU TLS logs (BEGIN) 
		//-------------------------------------------
		atom_inc(&wr_log_u[i][j][0][0]);
		atom_inc(&wr_log_u[i][j][0][1]);
		atom_inc(&wr_log_u[i][j][0][2]);
		atom_inc(&wr_log_u[i][j][0][3]);
		atom_inc(&wr_log_u[i][j][0][4]);
		atom_inc(&wr_log_u[i][j][nz - 1][0]);
		atom_inc(&wr_log_u[i][j][nz - 1][1]);
		atom_inc(&wr_log_u[i][j][nz - 1][2]);
		atom_inc(&wr_log_u[i][j][nz - 1][3]);
		atom_inc(&wr_log_u[i][j][nz - 1][4]);
		//-------------------------------------------
		// GPU TLS logs (END)
		//-------------------------------------------
	}
		      ...
		      int ny0, int nz, int __ocl_k_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	{
		exact_g7_e4_e5_e6_no_spec(i, 0, k, tmp, nx0, ny0, nz,
					  ce) /*ARGEXP: nx0,ny0,nz,ce */ ;
		u[i][0][k][0] = tmp[0];
		u[i][0][k][1] = tmp[1];
		u[i][0][k][2] = tmp[2];
...
__kernel void setbv_2(int ny0, __global double *g_u, int ny,
		      ...
		      int __ocl_i_bound, __global int *g_rd_log_u,
		      __global int *g_wr_log_u)
{
	...
	//-------------------------------------------
	{
		...
		// GPU TLS logs (BEGIN) 
		//-------------------------------------------
		atom_inc(&wr_log_u[i][ny - 1][k][0]);
		atom_inc(&wr_log_u[i][ny - 1][k][1]);
		atom_inc(&wr_log_u[i][ny - 1][k][2]);
		atom_inc(&wr_log_u[i][ny - 1][k][3]);
		atom_inc(&wr_log_u[i][ny - 1][k][4]);
		//-------------------------------------------
		// GPU TLS logs (END)
		//-------------------------------------------
	}
		      ...
		      int ny0, int nz, int __ocl_k_bound, int __ocl_j_bound)
{
	...
	//-------------------------------------------
	{
		exact_g7_e4_e5_e6_no_spec(0, j, k, tmp, nx0, ny0, nz,
					  ce) /*ARGEXP: nx0,ny0,nz,ce */ ;
		u[0][j][k][0] = tmp[0];
		u[0][j][k][1] = tmp[1];
		u[0][j][k][2] = tmp[2];
...
__kernel void setbv_4(int nx0, __global double *g_u, int nx,
		      ...
		      int __ocl_j_bound, __global int *g_rd_log_u,
		      __global int *g_wr_log_u)
{
	//-------------------------------------------
	//OpenCL global indexes (BEGIN)
	...
	//-------------------------------------------
	{
		...
		// GPU TLS logs (BEGIN) 
		//-------------------------------------------
		atom_inc(&wr_log_u[nx - 1][j][k][0]);
		atom_inc(&wr_log_u[nx - 1][j][k][1]);
		atom_inc(&wr_log_u[nx - 1][j][k][2]);
		atom_inc(&wr_log_u[nx - 1][j][k][3]);
		atom_inc(&wr_log_u[nx - 1][j][k][4]);
		//-------------------------------------------
		// GPU TLS logs (END)
		//-------------------------------------------
	}
