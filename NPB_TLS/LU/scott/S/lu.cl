//-------------------------------------------------------------------------------
//OpenCL Kernels 
//Generated at : Thu Oct 25 14:32:31 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
		     ...
		     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	__global double (*v)[13][13][5] = (__global double (*)[13][13][5])g_v;
	__global double (*ldz)[12][5][5] = (__global double (*)[12][5][5])g_ldz;
	//-------------------------------------------
		     ...
		     int __ocl_i_bound)
{
	...
	//-------------------------------------------
	__global double (*v)[13][13][5] = (__global double (*)[13][13][5])g_v;
	__global double (*ldy)[12][5][5] = (__global double (*)[12][5][5])g_ldy;
	__global double (*ldx)[12][5][5] = (__global double (*)[12][5][5])g_ldx;
	__global double (*d)[12][5][5] = (__global double (*)[12][5][5])g_d;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int jst, int ist, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*tv)[12][5] = (__global double (*)[12][5])g_tv;
	__global double (*udz)[12][5][5] = (__global double (*)[12][5][5])g_udz;
	__global double (*v)[13][13][5] = (__global double (*)[13][13][5])g_v;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int ist, int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//-------------------------------------------
	__global double (*tv)[12][5] = (__global double (*)[12][5])g_tv;
	__global double (*udy)[12][5][5] = (__global double (*)[12][5][5])g_udy;
	__global double (*v)[13][13][5] = (__global double (*)[13][13][5])g_v;
	__global double (*udx)[12][5][5] = (__global double (*)[12][5][5])g_udx;
	__global double (*d)[12][5][5] = (__global double (*)[12][5][5])g_d;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     int __ocl_j_bound, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*frct)[13][13][5] =
	    (__global double (*)[13][13][5])g_frct;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		     ...
		     __global double *g_ce, int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*rsd)[13][13][5] =
	    (__global double (*)[13][13][5])g_rsd;
		     ...
		     int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*flux)[13][13][5] =
	    (__global double (*)[13][13][5])g_flux;
	__global double (*rsd)[13][13][5] =
	    (__global double (*)[13][13][5])g_rsd;
	//-------------------------------------------
	//Convert global memory objects (END)
		      ...
		      int __ocl_i_bound)
{
	...
	//Convert global memory objects (BEGIN)
	//-------------------------------------------
	__global double (*u)[13][13][5] = (__global double (*)[13][13][5])g_u;
	__global double (*d)[12][5][5] = (__global double (*)[12][5][5])g_d;
	__global double (*a)[12][5][5] = (__global double (*)[12][5][5])g_a;
	__global double (*b)[12][5][5] = (__global double (*)[12][5][5])g_b;
	__global double (*c)[12][5][5] = (__global double (*)[12][5][5])g_c;
	//-------------------------------------------
	//Convert global memory objects (END)
	//-------------------------------------------
		      ...
		      __global int *g_rd_log_u, __global int *g_wr_log_u)
{
	...
	__global int (*rd_log_u)[13][13][5] =
	    (__global int (*)[13][13][5])g_rd_log_u;
	__global int (*wr_log_u)[13][13][5] =
	    (__global int (*)[13][13][5])g_wr_log_u;
