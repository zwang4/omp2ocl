//-------------------------------------------------------------------------------
//Host code 
//Generated at : Thu Oct 25 14:33:19 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
static void blts(int nx, int ny, int nz, int k, double omega,
		 double v[102][103][103][5], ocl_buffer * __ocl_buffer_v,
		 double ldz[102][102][5][5], ocl_buffer * __ocl_buffer_ldz,
		 double ldy[102][102][5][5], ocl_buffer * __ocl_buffer_ldy,
		 double ldx[102][102][5][5], ocl_buffer * __ocl_buffer_ldx,
		 double d[102][102][5][5], ocl_buffer * __ocl_buffer_d, int ist,
		 int iend, int jst, int jend, int nx0, int ny0);
static void buts(int nx, int ny, int nz, int k, double omega,
		 double v[102][103][103][5], ocl_buffer * __ocl_buffer_v,
		 double tv[102][102][5], ocl_buffer * __ocl_buffer_tv,
		 double d[102][102][5][5], ocl_buffer * __ocl_buffer_d,
		 double udx[102][102][5][5], ocl_buffer * __ocl_buffer_udx,
		 double udy[102][102][5][5], ocl_buffer * __ocl_buffer_udy,
		 double udz[102][102][5][5], ocl_buffer * __ocl_buffer_udz,
...
static void l2norm(int nx0, int ny0, int nz0, int ist, int iend, int jst,
		   int jend, double v[102][103][103][5],
...
static void ssor()
{
	...
	DECLARE_LOCALVAR_OCL_BUFFER(tv, double, (102 * 102 * 5));
...
{
	__ocl_buffer_frct =
	    oclCreateBuffer(frct, (102 * 103 * 103 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_frct, -1);
	__ocl_buffer_rsd =
	    oclCreateBuffer(rsd, (102 * 103 * 103 * 5) * sizeof(double));
	...
	__ocl_buffer_flux =
	    oclCreateBuffer(flux, (102 * 103 * 103 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_flux, -1);
	__ocl_buffer_u =
	    oclCreateBuffer(u, (102 * 103 * 103 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_u, -1);
	__ocl_buffer_d =
	    oclCreateBuffer(d, (102 * 102 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_d, -1);
	__ocl_buffer_a =
	    oclCreateBuffer(a, (102 * 102 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_a, -1);
	__ocl_buffer_b =
	    oclCreateBuffer(b, (102 * 102 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_b, -1);
	__ocl_buffer_c =
	    oclCreateBuffer(c, (102 * 102 * 5 * 5) * sizeof(double));
	...
	//------------------------------------------
	rd_oclb_u =
	    oclCreateBuffer(rd_log_u, (102 * 103 * 103 * 5) * sizeof(int));
	wr_oclb_u =
	    oclCreateBuffer(wr_log_u, (102 * 103 * 103 * 5) * sizeof(int));
