...
static void blts(int nx, int ny, int nz, int k, double omega,
		 double v[64][65][65][5], ocl_buffer * __ocl_buffer_v,
		 double ldz[64][64][5][5], ocl_buffer * __ocl_buffer_ldz,
		 double ldy[64][64][5][5], ocl_buffer * __ocl_buffer_ldy,
		 double ldx[64][64][5][5], ocl_buffer * __ocl_buffer_ldx,
		 double d[64][64][5][5], ocl_buffer * __ocl_buffer_d, int ist,
		 int iend, int jst, int jend, int nx0, int ny0);
static void buts(int nx, int ny, int nz, int k, double omega,
		 double v[64][65][65][5], ocl_buffer * __ocl_buffer_v,
		 double tv[64][64][5], ocl_buffer * __ocl_buffer_tv,
		 double d[64][64][5][5], ocl_buffer * __ocl_buffer_d,
		 double udx[64][64][5][5], ocl_buffer * __ocl_buffer_udx,
		 double udy[64][64][5][5], ocl_buffer * __ocl_buffer_udy,
		 double udz[64][64][5][5], ocl_buffer * __ocl_buffer_udz,
...
static void ssor()
{
	...
	DECLARE_LOCALVAR_OCL_BUFFER(tv, double, (64 * 64 * 5));
...
{
	__ocl_buffer_frct =
	    oclCreateBuffer(frct, (64 * 65 * 65 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_frct, -1);
	__ocl_buffer_rsd =
	    oclCreateBuffer(rsd, (64 * 65 * 65 * 5) * sizeof(double));
	...
	__ocl_buffer_flux =
	    oclCreateBuffer(flux, (64 * 65 * 65 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_flux, -1);
	__ocl_buffer_u =
	    oclCreateBuffer(u, (64 * 65 * 65 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_u, -1);
	__ocl_buffer_d = oclCreateBuffer(d, (64 * 64 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_d, -1);
	__ocl_buffer_a = oclCreateBuffer(a, (64 * 64 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_a, -1);
	__ocl_buffer_b = oclCreateBuffer(b, (64 * 64 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_b, -1);
	__ocl_buffer_c = oclCreateBuffer(c, (64 * 64 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_c, -1);

	//------------------------------------------
	// GPU TLS wr/rd buffers (BEGIN)
	//------------------------------------------
	rd_oclb_u = oclCreateBuffer(rd_log_u, (64 * 65 * 65 * 5) * sizeof(int));
	wr_oclb_u = oclCreateBuffer(wr_log_u, (64 * 65 * 65 * 5) * sizeof(int));
