//-------------------------------------------------------------------------------
//Host code 
//Generated at : Thu Oct 25 14:32:36 2012
//Compiler options: 
//      Software Cache  true
//      Local Memory    true
...
static void blts(int nx, int ny, int nz, int k, double omega,
		 double v[12][13][13][5], ocl_buffer * __ocl_buffer_v,
		 double ldz[12][12][5][5], ocl_buffer * __ocl_buffer_ldz,
		 double ldy[12][12][5][5], ocl_buffer * __ocl_buffer_ldy,
		 double ldx[12][12][5][5], ocl_buffer * __ocl_buffer_ldx,
		 double d[12][12][5][5], ocl_buffer * __ocl_buffer_d, int ist,
		 int iend, int jst, int jend, int nx0, int ny0);
static void buts(int nx, int ny, int nz, int k, double omega,
		 double v[12][13][13][5], ocl_buffer * __ocl_buffer_v,
		 double tv[12][12][5], ocl_buffer * __ocl_buffer_tv,
		 double d[12][12][5][5], ocl_buffer * __ocl_buffer_d,
		 double udx[12][12][5][5], ocl_buffer * __ocl_buffer_udx,
		 double udy[12][12][5][5], ocl_buffer * __ocl_buffer_udy,
		 double udz[12][12][5][5], ocl_buffer * __ocl_buffer_udz,
				 ...
				 (12 * 12 * 5 * 5), double);
	{
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_blts_0, 7, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_blts_0, 8,
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_blts_1, 10, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_blts_1, 11,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
				 ...
				 (12 * 12 * 5 * 5), double);
	{
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_buts_0, 8, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_buts_0, 9,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArg(__ocl_buts_1, 11, sizeof(int),
					&__ocl_i_bound);
			oclSetKernelArgBuffer(__ocl_buts_1, 12,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
...
static void erhs()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_erhs_0, 4,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_erhs_1, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_erhs_2, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_erhs_3, 19,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_erhs_4, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_erhs_5, 19,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_erhs_6, 17,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void jacld(int k)
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_jacld_0, 35,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void jacu(int k)
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_jacu_0, 35,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void rhs()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_rhs_0, 5,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_rhs_1, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_rhs_2, 18,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_rhs_3, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_rhs_4, 18,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_rhs_5, 17,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void setbv()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_setbv_0, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_setbv_1, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_setbv_2, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_setbv_3, 7,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_setbv_4, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void setiv()
{
	...
	//--------------------------------------------------------------
	{
		...
		oclSetKernelArgBuffer(__ocl_setiv_0, 8,
				      __oclb_gpu_tls_conflict_flag);
		//------------------------------------------
		//OpenCL kernel arguments (END) 
		//------------------------------------------
...
static void ssor()
{
	...
	DECLARE_LOCALVAR_OCL_BUFFER(tv, double, (12 * 12 * 5));
	tmp = 1.0 / (omega * (2.0 - omega));
	{
		...
		//--------------------------------------------------------------
		{
			...
			oclSetKernelArgBuffer(__ocl_ssor_0, 4,
					      __oclb_gpu_tls_conflict_flag);
			//------------------------------------------
			//OpenCL kernel arguments (END) 
			//------------------------------------------
		...
		for (istep = 1; istep <= itmax; istep++) {
			...
			//--------------------------------------------------------------
			{
				...
				oclSetKernelArg(__ocl_ssor_1, 6, sizeof(int),
						&__ocl_i_bound);
				oclSetKernelArgBuffer(__ocl_ssor_1, 7,
						      __oclb_gpu_tls_conflict_flag);
				//------------------------------------------
				//OpenCL kernel arguments (END) 
				//------------------------------------------
			...
			//--------------------------------------------------------------
			{
				...
				oclSetKernelArg(__ocl_ssor_2, 7, sizeof(int),
						&__ocl_i_bound);
				oclSetKernelArgBuffer(__ocl_ssor_2, 8,
						      __oclb_gpu_tls_conflict_flag);
				//------------------------------------------
				//OpenCL kernel arguments (END) 
				//------------------------------------------
...
{
	__ocl_buffer_frct =
	    oclCreateBuffer(frct, (12 * 13 * 13 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_frct, -1);
	__ocl_buffer_rsd =
	    oclCreateBuffer(rsd, (12 * 13 * 13 * 5) * sizeof(double));
	...
	__ocl_buffer_flux =
	    oclCreateBuffer(flux, (12 * 13 * 13 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_flux, -1);
	__ocl_buffer_u =
	    oclCreateBuffer(u, (12 * 13 * 13 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_u, -1);
	__ocl_buffer_d = oclCreateBuffer(d, (12 * 12 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_d, -1);
	__ocl_buffer_a = oclCreateBuffer(a, (12 * 12 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_a, -1);
	__ocl_buffer_b = oclCreateBuffer(b, (12 * 12 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_b, -1);
	__ocl_buffer_c = oclCreateBuffer(c, (12 * 12 * 5 * 5) * sizeof(double));
	DYN_BUFFER_CHECK(__ocl_buffer_c, -1);

	//------------------------------------------
	// GPU TLS wr/rd buffers (BEGIN)
	//------------------------------------------
	rd_oclb_u = oclCreateBuffer(rd_log_u, (12 * 13 * 13 * 5) * sizeof(int));
	wr_oclb_u = oclCreateBuffer(wr_log_u, (12 * 13 * 13 * 5) * sizeof(int));
